...
const (
	...
	//  Oid: T_jsonpath
	JsonpathFamily Family = 34
	// LTreeFamily is a type family for the ltree type, which is the type
	// representing ltree expressions.
	//  Canonical: types.LTree
	//  Oid: T_ltree
	LTreeFamily Family = 35
...
var fileDescriptor_bc7f16796a7f6725 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.ArrayDimensions == nil {
						m.ArrayDimensions = make([]int32, 0, elementCount)
					} else {
						m.ArrayDimensions = slices.Grow(m.ArrayDimensions, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v int32
