...
type KVStats struct {
	...
	// LocalKVCPUTime is the SQL goroutine CPU time spent inside KV calls,
	...
	// servers (see KVCPUTime in data.proto Metrics for the KV-server side). It
	// is subtracted from total measured CPU time to isolate SQL-only CPU in
	// per-operator stats.
	LocalKVCPUTime  optional.Duration `protobuf:"bytes,11,opt,name=local_kv_cpu_time,json=localKvCpuTime" json:"local_kv_cpu_time"`
...
var fileDescriptor_11ea9e8b662a649a = []byte{
	...
	0x15, 0xc7, 0xad, 0x1f, 0xd6, 0x8f, 0xc7, 0x95, 0x64, 0x8f, 0x77, 0x13, 0xd6, 0xdd, 0xc8, 0x8e,
	...
	,
}
...
func (m *KVStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x62
	{
		size, err := m.LocalKVCPUTime.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *KVStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if err := m.LocalKVCPUTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
