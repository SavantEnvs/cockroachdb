...
import (
	...
	github_com_cockroachdb_cockroach_pkg_sql_execversion "github.com/cockroachdb/cockroach/pkg/sql/execversion"
...
type SetupFlowRequest struct {
	...
	JobTag github_com_cockroachdb_redact.SafeString `protobuf:"bytes,13,opt,name=job_tag,json=jobTag,casttype=github.com/cockroachdb/redact.SafeString" json:"job_tag"`
	...
	LeafTxnAdmissionHeader kvpb.AdmissionHeader `protobuf:"bytes,12,opt,name=leaf_txn_admission_header,json=leafTxnAdmissionHeader" json:"leaf_txn_admission_header"`
	...
	Version github_com_cockroachdb_cockroach_pkg_sql_execversion.V `protobuf:"varint,5,opt,name=version,casttype=github.com/cockroachdb/cockroach/pkg/sql/execversion.V" json:"version"`
...
type EvalContext struct {
	...
	TestingKnobsForceProductionValues bool                      `protobuf:"varint,16,opt,name=testing_knobs_force_production_values,json=testingKnobsForceProductionValues" json:"testing_knobs_force_production_values"`
	// WorkloadID for ASH sampling.
	WorkloadID uint64 `protobuf:"varint,17,opt,name=workload_id,json=workloadId" json:"workload_id"`
	...
	AppNameID uint64 `protobuf:"varint,18,opt,name=app_name_id,json=appNameId" json:"app_name_id"`
	...
	WorkloadType uint32 `protobuf:"varint,19,opt,name=workload_type,json=workloadType" json:"workload_type"`
}
...
var fileDescriptor_0204a3f70d678e66 = []byte{
	...
	,
}
...
func (m *SetupFlowRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x6a
	{
		size, err := m.LeafTxnAdmissionHeader.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EvalContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintApi(dAtA, i, uint64(m.WorkloadType))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x98
	i = encodeVarintApi(dAtA, i, uint64(m.AppNameID))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x90
	i = encodeVarintApi(dAtA, i, uint64(m.WorkloadID))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x88
	i--
	if m.TestingKnobsForceProductionValues {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *ConsumerHandshake) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ConsumerScheduleDeadline != nil {
		n10, err10 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ConsumerScheduleDeadline, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ConsumerScheduleDeadline):])
		if err10 != nil {
			return 0, err10
		}
		i -= n10
		i = encodeVarintApi(dAtA, i, uint64(n10))
		i--
		dAtA[i] = 0x12
	}
	i--
...
func (m *SetupFlowRequest) Size() (n int) {
	...
	l = m.LeafTxnAdmissionHeader.Size()
	n += 1 + l + sovApi(uint64(l))
	l = len(m.JobTag)
	n += 1 + l + sovApi(uint64(l))
	return n
...
func (m *EvalContext) Size() (n int) {
	...
	n += 1 + l + sovApi(uint64(l))
	n += 3
	n += 2 + sovApi(uint64(m.WorkloadID))
	n += 2 + sovApi(uint64(m.AppNameID))
	n += 2 + sovApi(uint64(m.WorkloadType))
	return n
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Version |= github_com_cockroachdb_cockroach_pkg_sql_execversion.V(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeafTxnAdmissionHeader", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LeafTxnAdmissionHeader.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			...
			m.JobTag = github_com_cockroachdb_redact.SafeString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *EvalContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TestingKnobsForceProductionValues", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TestingKnobsForceProductionValues = bool(v != 0)
		case 17:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkloadID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppNameID", wireType)
			}
			m.AppNameID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AppNameID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 19:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkloadType |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
