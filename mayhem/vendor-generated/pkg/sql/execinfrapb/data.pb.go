...
type OutputRouterSpec struct {
	...
	// hashing. Can be empty in which case the routing can be done arbitrarily.
...
type ProducerHeader struct {
	...
	Producer github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID `protobuf:"varint,3,opt,name=producer,casttype=github.com/cockroachdb/cockroach/pkg/base.SQLInstanceID" json:"producer"`
}
...
type RemoteProducerMetadata_BulkProcessorProgress struct {
	...
	Drained bool   `protobuf:"varint,9,opt,name=drained" json:"drained"`
	// ProcessorID is the ID of the processor that published the metadata.
	ProcessorID int32 `protobuf:"varint,10,opt,name=processor_id,json=processorId" json:"processor_id"`
	...
	ProgressMessage []byte `protobuf:"bytes,11,opt,name=progress_message,json=progressMessage" json:"progress_message,omitempty"`
}
...
type RemoteProducerMetadata_Metrics struct {
	...
	IndexRowsWritten int64 `protobuf:"varint,5,opt,name=index_rows_written,json=indexRowsWritten" json:"index_rows_written"`
	// IndexBytesWritten is the number of primary and secondary index bytes
	// modified while executing a statement.
	IndexBytesWritten int64 `protobuf:"varint,6,opt,name=index_bytes_written,json=indexBytesWritten" json:"index_bytes_written"`
	...
	StageID int32 `protobuf:"varint,4,opt,name=stage_id,json=stageId" json:"stage_id"`
	...
	KVCPUTime int64 `protobuf:"varint,7,opt,name=kv_cpu_time,json=kvCpuTime" json:"kv_cpu_time"`
	...
	// subtracts it from total goroutine CPU to derive SQL-only CPU.
	LocalKVCPUTime int64 `protobuf:"varint,8,opt,name=local_kv_cpu_time,json=localKvCpuTime" json:"local_kv_cpu_time"`
	// RawSQLCPUTime carries raw goroutine CPU time (in nanoseconds) for this
	// flow, before any correction. Remote flows send their accumulated
	// grunning time here; the gateway subtracts total LocalKVCPUTime to
	// derive SQL-only CPU.
	RawSQLCPUTime int64 `protobuf:"varint,9,opt,name=raw_sql_cpu_time,json=rawSqlCpuTime" json:"raw_sql_cpu_time"`
}
...
type MergeIterationProgress struct {
	// Task ID that was completed.
	CompletedTaskID int64 `protobuf:"varint,1,opt,name=completed_task_id,json=completedTaskId" json:"completed_task_id"`
	// Total number of tasks in the current merge iteration.
	TasksTotal int64 `protobuf:"varint,2,opt,name=tasks_total,json=tasksTotal" json:"tasks_total"`
}

func (m *MergeIterationProgress) Reset()         { *m = MergeIterationProgress{} }
func (m *MergeIterationProgress) String() string { return proto.CompactTextString(m) }
func (*MergeIterationProgress) ProtoMessage()    {}
func (*MergeIterationProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11}
}
func (m *MergeIterationProgress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeIterationProgress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MergeIterationProgress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeIterationProgress.Merge(m, src)
}
func (m *MergeIterationProgress) XXX_Size() int {
	return m.Size()
}
func (m *MergeIterationProgress) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeIterationProgress.DiscardUnknown(m)
}

var xxx_messageInfo_MergeIterationProgress proto.InternalMessageInfo
...
type TracingAggregatorEvents struct {
	...
	SpanTotals map[string]tracingpb.OperationMetadata `protobuf:"bytes,4,rep,name=span_totals,json=spanTotals" json:"span_totals" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func init() {
	...
	proto.RegisterType((*MergeIterationProgress)(nil), "cockroach.sql.distsqlrun.MergeIterationProgress")
	...
	proto.RegisterMapType((map[string]tracingpb.OperationMetadata)(nil), "cockroach.sql.distsqlrun.TracingAggregatorEvents.SpanTotalsEntry")
}
...
var fileDescriptor_88f01b948ed44512 = []byte{
	...
	,
}
...
func (m *ProducerHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintData(dAtA, i, uint64(m.Producer))
	i--
	dAtA[i] = 0x18
	i = encodeVarintData(dAtA, i, uint64(m.StreamID))
	i--
...
func (m *RemoteProducerMetadata_BulkProcessorProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ProgressMessage != nil {
		i -= len(m.ProgressMessage)
		copy(dAtA[i:], m.ProgressMessage)
		i = encodeVarintData(dAtA, i, uint64(len(m.ProgressMessage)))
		i--
		dAtA[i] = 0x5a
	}
	i = encodeVarintData(dAtA, i, uint64(m.ProcessorID))
	i--
	dAtA[i] = 0x50
	i--
	if m.Drained {
...
func (m *RemoteProducerMetadata_Metrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintData(dAtA, i, uint64(m.RawSQLCPUTime))
	i--
	dAtA[i] = 0x48
	i = encodeVarintData(dAtA, i, uint64(m.LocalKVCPUTime))
	i--
	dAtA[i] = 0x40
	i = encodeVarintData(dAtA, i, uint64(m.KVCPUTime))
	i--
	dAtA[i] = 0x38
	i = encodeVarintData(dAtA, i, uint64(m.IndexBytesWritten))
	i--
	dAtA[i] = 0x30
	i = encodeVarintData(dAtA, i, uint64(m.IndexRowsWritten))
	i--
	dAtA[i] = 0x28
	i = encodeVarintData(dAtA, i, uint64(m.StageID))
	i--
	dAtA[i] = 0x20
...
func (m *MergeIterationProgress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergeIterationProgress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergeIterationProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintData(dAtA, i, uint64(m.TasksTotal))
	i--
	dAtA[i] = 0x10
	i = encodeVarintData(dAtA, i, uint64(m.CompletedTaskID))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *TracingAggregatorEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SpanTotals) > 0 {
		keysForSpanTotals := make([]string, 0, len(m.SpanTotals))
		for k := range m.SpanTotals {
			keysForSpanTotals = append(keysForSpanTotals, string(k))
		}
		github_com_gogo_protobuf_sortkeys.Strings(keysForSpanTotals)
		for iNdEx := len(keysForSpanTotals) - 1; iNdEx >= 0; iNdEx-- {
			v := m.SpanTotals[string(keysForSpanTotals[iNdEx])]
			baseI := i
			{
			...
			i--
			dAtA[i] = 0x12
			i -= len(keysForSpanTotals[iNdEx])
			copy(dAtA[i:], keysForSpanTotals[iNdEx])
			i = encodeVarintData(dAtA, i, uint64(len(keysForSpanTotals[iNdEx])))
			i--
			dAtA[i] = 0xa
			i = encodeVarintData(dAtA, i, uint64(baseI-i))
			i--
...
func (m *RemoteProducerMetadata_BulkProcessorProgress) Size() (n int) {
	...
	n += 1 + l + sovData(uint64(l))
	n += 2
	n += 1 + sovData(uint64(m.ProcessorID))
	if m.ProgressMessage != nil {
		l = len(m.ProgressMessage)
		n += 1 + l + sovData(uint64(l))
	}
	return n
}
...
func (m *RemoteProducerMetadata_Metrics) Size() (n int) {
	...
	n += 1 + sovData(uint64(m.StageID))
	n += 1 + sovData(uint64(m.IndexRowsWritten))
	n += 1 + sovData(uint64(m.IndexBytesWritten))
	n += 1 + sovData(uint64(m.KVCPUTime))
	n += 1 + sovData(uint64(m.LocalKVCPUTime))
	n += 1 + sovData(uint64(m.RawSQLCPUTime))
	return n
}

func (m *MergeIterationProgress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovData(uint64(m.CompletedTaskID))
	n += 1 + sovData(uint64(m.TasksTotal))
	return n
}
...
func (m *TracingAggregatorEvents) Size() (n int) {
	...
	if len(m.SpanTotals) > 0 {
		for k, v := range m.SpanTotals {
			_ = k
			_ = v
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovData(uint64(len(k))) + 1 + l + sovData(uint64(l))
			n += mapEntrySize + 1 + sovData(uint64(mapEntrySize))
		}
	}
	return n
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.HashColumns == nil {
						m.HashColumns = make([]uint32, 0, elementCount)
					} else {
						m.HashColumns = slices.Grow(m.HashColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Producer |= github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
			...
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.Encoding == nil {
						...
						m.Encoding = slices.Grow(m.Encoding, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v catenumpb.DatumEncoding
...
func (m *RemoteProducerMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			alloc := new(struct {
				value RemoteProducerMetadata_RangeInfo
				field RemoteProducerMetadata_RangeInfos
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.RangeInfo = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_Error
				field Error
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.Error = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_TraceData_
				field RemoteProducerMetadata_TraceData
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.TraceData = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_LeafTxnFinalState
				field roachpb.LeafTxnFinalState
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.LeafTxnFinalState = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_RowNum_
				field RemoteProducerMetadata_RowNum
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.RowNum = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_SamplerProgress_
				field RemoteProducerMetadata_SamplerProgress
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.SamplerProgress = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_Metrics_
				field RemoteProducerMetadata_Metrics
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.Metrics = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_BulkProcessorProgress_
				field RemoteProducerMetadata_BulkProcessorProgress
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.BulkProcessorProgress = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
			...
			alloc := new(struct {
				value RemoteProducerMetadata_TracingAggregatorEvents
				field TracingAggregatorEvents
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.TracingAggregatorEvents = &alloc.field
			m.Value = &alloc.value
			iNdEx = postIndex
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 6:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.CompletedSpanIdx == nil {
						m.CompletedSpanIdx = make([]int32, 0, elementCount)
					} else {
						m.CompletedSpanIdx = slices.Grow(m.CompletedSpanIdx, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v int32
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProgressMessage", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProgressMessage = append(m.ProgressMessage[:0], dAtA[iNdEx:postIndex]...)
			if m.ProgressMessage == nil {
				m.ProgressMessage = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RemoteProducerMetadata_Metrics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexRowsWritten", wireType)
			}
			m.IndexRowsWritten = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IndexRowsWritten |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexBytesWritten", wireType)
			}
			m.IndexBytesWritten = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IndexBytesWritten |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KVCPUTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalKVCPUTime", wireType)
			}
			m.LocalKVCPUTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LocalKVCPUTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawSQLCPUTime", wireType)
			}
			m.RawSQLCPUTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RawSQLCPUTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MergeIterationProgress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeIterationProgress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeIterationProgress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompletedTaskID", wireType)
			}
			m.CompletedTaskID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CompletedTaskID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TasksTotal", wireType)
			}
			m.TasksTotal = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TasksTotal |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TracingAggregatorEvents) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpanTotals", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SpanTotals == nil {
				m.SpanTotals = make(map[string]tracingpb.OperationMetadata)
			}
			var mapkey string
			mapvalue := &tracingpb.OperationMetadata{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
