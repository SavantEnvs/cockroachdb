...
type SampleAggregatorSpec struct {
	...
	// If true, meaning we will delay the deletion of existing stats.
	CanaryStatsEnabled bool `protobuf:"varint,14,opt,name=canary_stats_enabled,json=canaryStatsEnabled" json:"canary_stats_enabled"`
}
...
var fileDescriptor_d08bfa18785ff29a = []byte{
	...
	,
}
...
func (m *SampleAggregatorSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CanaryStatsEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
