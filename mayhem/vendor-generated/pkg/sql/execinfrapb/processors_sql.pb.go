...
import (
	...
	vecstorepb "github.com/cockroachdb/cockroach/pkg/sql/vecindex/vecstore/vecstorepb"
...
const (
	...
	AggregatorSpec_ST_ASMVT                        AggregatorSpec_Func = 66
)
...
type JoinReaderSpec struct {
	...
	// row.
	ReverseScans bool `protobuf:"varint,25,opt,name=reverse_scans,json=reverseScans" json:"reverse_scans"`
	...
	Parallelize bool `protobuf:"varint,26,opt,name=parallelize" json:"parallelize"`
}
...
type VectorSearchSpec struct {
	...
	PrefixKeys []github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,2,rep,name=prefix_keys,json=prefixKeys,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.Key" json:"prefix_keys,omitempty"`
	// QueryVector is the vector to search for.
	QueryVector []float32 `protobuf:"fixed32,3,rep,name=query_vector,json=queryVector" json:"query_vector,omitempty"`
	// TargetNeighborCount is the number of nearest neighbors to search for.
	TargetNeighborCount     uint64                             `protobuf:"varint,4,opt,name=target_neighbor_count,json=targetNeighborCount" json:"target_neighbor_count"`
	GetFullVectorsFetchSpec vecstorepb.GetFullVectorsFetchSpec `protobuf:"bytes,5,opt,name=get_full_vectors_fetch_spec,json=getFullVectorsFetchSpec" json:"get_full_vectors_fetch_spec"`
}

func (m *VectorSearchSpec) Reset()         { *m = VectorSearchSpec{} }
func (m *VectorSearchSpec) String() string { return proto.CompactTextString(m) }
func (*VectorSearchSpec) ProtoMessage()    {}
func (*VectorSearchSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{17}
}
func (m *VectorSearchSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VectorSearchSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *VectorSearchSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VectorSearchSpec.Merge(m, src)
}
func (m *VectorSearchSpec) XXX_Size() int {
	return m.Size()
}
func (m *VectorSearchSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_VectorSearchSpec.DiscardUnknown(m)
}

var xxx_messageInfo_VectorSearchSpec proto.InternalMessageInfo
...
type VectorMutationSearchSpec struct {
	FetchSpec fetchpb.IndexFetchSpec `protobuf:"bytes,1,opt,name=fetch_spec,json=fetchSpec" json:"fetch_spec"`
	...
	PrefixKeyColumnOrdinals []uint32                           `protobuf:"varint,2,rep,name=prefix_key_column_ordinals,json=prefixKeyColumnOrdinals" json:"prefix_key_column_ordinals,omitempty"`
	PrefixKeyColumns        []fetchpb.IndexFetchSpec_KeyColumn `protobuf:"bytes,3,rep,name=prefix_key_columns,json=prefixKeyColumns" json:"prefix_key_columns"`
	// QueryVectorColumnOrdinal identifies the vectors that will be inserted into
	// or removed from the vector index.
	QueryVectorColumnOrdinal uint32 `protobuf:"varint,4,opt,name=query_vector_column_ordinal,json=queryVectorColumnOrdinal" json:"query_vector_column_ordinal"`
	...
	SuffixKeyColumnOrdinals []uint32                           `protobuf:"varint,5,rep,name=suffix_key_column_ordinals,json=suffixKeyColumnOrdinals" json:"suffix_key_column_ordinals,omitempty"`
	SuffixKeyColumns        []fetchpb.IndexFetchSpec_KeyColumn `protobuf:"bytes,6,rep,name=suffix_key_columns,json=suffixKeyColumns" json:"suffix_key_columns"`
	// IsIndexPut is true if the search is being conducted for an index put,
	// instead of an index del.
	IsIndexPut              bool                               `protobuf:"varint,7,opt,name=is_index_put,json=isIndexPut" json:"is_index_put"`
	GetFullVectorsFetchSpec vecstorepb.GetFullVectorsFetchSpec `protobuf:"bytes,8,opt,name=get_full_vectors_fetch_spec,json=getFullVectorsFetchSpec" json:"get_full_vectors_fetch_spec"`
}

func (m *VectorMutationSearchSpec) Reset()         { *m = VectorMutationSearchSpec{} }
func (m *VectorMutationSearchSpec) String() string { return proto.CompactTextString(m) }
func (*VectorMutationSearchSpec) ProtoMessage()    {}
func (*VectorMutationSearchSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{18}
}
func (m *VectorMutationSearchSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VectorMutationSearchSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *VectorMutationSearchSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VectorMutationSearchSpec.Merge(m, src)
}
func (m *VectorMutationSearchSpec) XXX_Size() int {
	return m.Size()
}
func (m *VectorMutationSearchSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_VectorMutationSearchSpec.DiscardUnknown(m)
}

var xxx_messageInfo_VectorMutationSearchSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*VectorSearchSpec)(nil), "cockroach.sql.distsqlrun.VectorSearchSpec")
	proto.RegisterType((*VectorMutationSearchSpec)(nil), "cockroach.sql.distsqlrun.VectorMutationSearchSpec")
}
...
var fileDescriptor_90493aed97b6d28f = []byte{
	...
	,
}
...
func (m *JoinReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		...
		i -= l
		if l == len(m.LookupColumns) {
			dest := dAtA[i : i+len(m.LookupColumns)]
			for k, num := range m.LookupColumns {
				dest[k] = uint8(num)
			}
		} else {
			j8 := i
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(uint64(l)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *HashJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RightEqColumns) > 0 {
		...
		i -= l
		if l == len(m.RightEqColumns) {
			dest := dAtA[i : i+len(m.RightEqColumns)]
			for k, num := range m.RightEqColumns {
				dest[k] = uint8(num)
			}
		} else {
			j19 := i
	...
	if len(m.LeftEqColumns) > 0 {
		...
		i -= l
		if l == len(m.LeftEqColumns) {
			dest := dAtA[i : i+len(m.LeftEqColumns)]
			for k, num := range m.LeftEqColumns {
				dest[k] = uint8(num)
			}
		} else {
			j20 := i
			for _, num := range m.LeftEqColumns {
				for num >= 1<<7 {
					dAtA[j20] = uint8(uint64(num)&0x7f | 0x80)
					num >>= 7
					j20++
				}
				dAtA[j20] = uint8(num)
...
func (m *InvertedJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrefixEqualityColumns) > 0 {
		...
		i -= l
		if l == len(m.PrefixEqualityColumns) {
			dest := dAtA[i : i+len(m.PrefixEqualityColumns)]
			for k, num := range m.PrefixEqualityColumns {
				dest[k] = uint8(num)
			}
		} else {
			j23 := i
...
func (m *AggregatorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderedGroupCols) > 0 {
		...
		i -= l
		if l == len(m.OrderedGroupCols) {
			dest := dAtA[i : i+len(m.OrderedGroupCols)]
			for k, num := range m.OrderedGroupCols {
				dest[k] = uint8(num)
			}
		} else {
			j31 := i
	...
	if len(m.GroupCols) > 0 {
		...
		i -= l
		if l == len(m.GroupCols) {
			dest := dAtA[i : i+len(m.GroupCols)]
			for k, num := range m.GroupCols {
				dest[k] = uint8(num)
			}
		} else {
			j32 := i
			for _, num := range m.GroupCols {
				for num >= 1<<7 {
					dAtA[j32] = uint8(uint64(num)&0x7f | 0x80)
					num >>= 7
					j32++
				}
				dAtA[j32] = uint8(num)
...
func (m *HashGroupJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.JoinOutputColumns) > 0 {
		...
		i -= l
		if l == len(m.JoinOutputColumns) {
			dest := dAtA[i : i+len(m.JoinOutputColumns)]
			for k, num := range m.JoinOutputColumns {
				dest[k] = uint8(num)
			}
		} else {
			j41 := i
...
func (m *VectorSearchSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VectorSearchSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VectorSearchSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.GetFullVectorsFetchSpec.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x2a
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.TargetNeighborCount))
	i--
	dAtA[i] = 0x20
	if len(m.QueryVector) > 0 {
		for iNdEx := len(m.QueryVector) - 1; iNdEx >= 0; iNdEx-- {
			f45 := math.Float32bits(float32(m.QueryVector[iNdEx]))
			i -= 4
	...
	if len(m.PrefixKeys) > 0 {
		for iNdEx := len(m.PrefixKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.PrefixKeys[iNdEx])
			copy(dAtA[i:], m.PrefixKeys[iNdEx])
			i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.PrefixKeys[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *VectorMutationSearchSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VectorMutationSearchSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VectorMutationSearchSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i--
	dAtA[i] = 0x38
	if len(m.SuffixKeyColumns) > 0 {
		for iNdEx := len(m.SuffixKeyColumns) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SuffixKeyColumns[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.SuffixKeyColumnOrdinals) > 0 {
		for iNdEx := len(m.SuffixKeyColumnOrdinals) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintProcessorsSql(dAtA, i, uint64(m.SuffixKeyColumnOrdinals[iNdEx]))
			i--
			dAtA[i] = 0x28
		}
	}
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.QueryVectorColumnOrdinal))
	i--
	dAtA[i] = 0x20
	if len(m.PrefixKeyColumns) > 0 {
		for iNdEx := len(m.PrefixKeyColumns) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PrefixKeyColumns[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.PrefixKeyColumnOrdinals) > 0 {
		for iNdEx := len(m.PrefixKeyColumnOrdinals) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintProcessorsSql(dAtA, i, uint64(m.PrefixKeyColumnOrdinals[iNdEx]))
			i--
			dAtA[i] = 0x10
		}
	}
...
func (m *VectorSearchSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovProcessorsSql(uint64(l))
	if len(m.PrefixKeys) > 0 {
		for _, b := range m.PrefixKeys {
			l = len(b)
			n += 1 + l + sovProcessorsSql(uint64(l))
		}
	}
	if len(m.QueryVector) > 0 {
		n += 5 * len(m.QueryVector)
	}
	n += 1 + sovProcessorsSql(uint64(m.TargetNeighborCount))
	l = m.GetFullVectorsFetchSpec.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	return n
}

func (m *VectorMutationSearchSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovProcessorsSql(uint64(l))
	if len(m.PrefixKeyColumnOrdinals) > 0 {
		for _, e := range m.PrefixKeyColumnOrdinals {
			n += 1 + sovProcessorsSql(uint64(e))
		}
	}
	if len(m.PrefixKeyColumns) > 0 {
		for _, e := range m.PrefixKeyColumns {
			l = e.Size()
			n += 1 + l + sovProcessorsSql(uint64(l))
		}
	}
	n += 1 + sovProcessorsSql(uint64(m.QueryVectorColumnOrdinal))
	if len(m.SuffixKeyColumnOrdinals) > 0 {
		for _, e := range m.SuffixKeyColumnOrdinals {
			n += 1 + sovProcessorsSql(uint64(e))
		}
	}
	if len(m.SuffixKeyColumns) > 0 {
		for _, e := range m.SuffixKeyColumns {
			l = e.Size()
			n += 1 + l + sovProcessorsSql(uint64(l))
		}
	}
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.LookupColumns == nil {
						m.LookupColumns = make([]uint32, 0, elementCount)
					} else {
						m.LookupColumns = slices.Grow(m.LookupColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
		...
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReverseScans", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.OrderedColumns == nil {
						m.OrderedColumns = make([]uint32, 0, elementCount)
					} else {
						m.OrderedColumns = slices.Grow(m.OrderedColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
		...
		case 2:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.DistinctColumns == nil {
						m.DistinctColumns = make([]uint32, 0, elementCount)
					} else {
						m.DistinctColumns = slices.Grow(m.DistinctColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.LeftEqColumns == nil {
						m.LeftEqColumns = make([]uint32, 0, elementCount)
					} else {
						m.LeftEqColumns = slices.Grow(m.LeftEqColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
		...
		case 2:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.RightEqColumns == nil {
						m.RightEqColumns = make([]uint32, 0, elementCount)
					} else {
						m.RightEqColumns = slices.Grow(m.RightEqColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 9:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.PrefixEqualityColumns == nil {
						m.PrefixEqualityColumns = make([]uint32, 0, elementCount)
					} else {
						m.PrefixEqualityColumns = slices.Grow(m.PrefixEqualityColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
			...
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.GroupCols == nil {
						...
						m.GroupCols = slices.Grow(m.GroupCols, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
		...
		case 4:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.OrderedGroupCols == nil {
						m.OrderedGroupCols = make([]uint32, 0, elementCount)
					} else {
						m.OrderedGroupCols = slices.Grow(m.OrderedGroupCols, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
			...
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.ColIdx == nil {
						...
						m.ColIdx = slices.Grow(m.ColIdx, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.NumColsPerGen == nil {
						m.NumColsPerGen = make([]uint32, 0, elementCount)
					} else {
						m.NumColsPerGen = slices.Grow(m.NumColsPerGen, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.PartitionBy == nil {
						m.PartitionBy = make([]uint32, 0, elementCount)
					} else {
						m.PartitionBy = slices.Grow(m.PartitionBy, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
			...
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.ArgsIdxs == nil {
						...
						m.ArgsIdxs = slices.Grow(m.ArgsIdxs, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.JoinOutputColumns == nil {
						m.JoinOutputColumns = make([]uint32, 0, elementCount)
					} else {
						m.JoinOutputColumns = slices.Grow(m.JoinOutputColumns, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
...
func (m *VectorSearchSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VectorSearchSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VectorSearchSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixKeys", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrefixKeys = append(m.PrefixKeys, make([]byte, postIndex-iNdEx))
			copy(m.PrefixKeys[len(m.PrefixKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType == 5 {
				var v uint32
				...
				m.QueryVector = append(m.QueryVector, v2)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 {
					if m.QueryVector == nil {
						m.QueryVector = make([]float32, 0, elementCount)
					} else {
						m.QueryVector = slices.Grow(m.QueryVector, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetNeighborCount", wireType)
			}
			m.TargetNeighborCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsSql
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetNeighborCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GetFullVectorsFetchSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GetFullVectorsFetchSpec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VectorMutationSearchSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VectorMutationSearchSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VectorMutationSearchSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType == 0 {
				...
				m.PrefixKeyColumnOrdinals = append(m.PrefixKeyColumnOrdinals, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.PrefixKeyColumnOrdinals == nil {
						m.PrefixKeyColumnOrdinals = make([]uint32, 0, elementCount)
					} else {
						m.PrefixKeyColumnOrdinals = slices.Grow(m.PrefixKeyColumnOrdinals, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
				...
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixKeyColumnOrdinals", wireType)
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixKeyColumns", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrefixKeyColumns = append(m.PrefixKeyColumns, fetchpb.IndexFetchSpec_KeyColumn{})
			if err := m.PrefixKeyColumns[len(m.PrefixKeyColumns)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryVectorColumnOrdinal", wireType)
			}
			m.QueryVectorColumnOrdinal = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsSql
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QueryVectorColumnOrdinal |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType == 0 {
				...
				m.SuffixKeyColumnOrdinals = append(m.SuffixKeyColumnOrdinals, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.SuffixKeyColumnOrdinals == nil {
						m.SuffixKeyColumnOrdinals = make([]uint32, 0, elementCount)
					} else {
						m.SuffixKeyColumnOrdinals = slices.Grow(m.SuffixKeyColumnOrdinals, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v uint32
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SuffixKeyColumnOrdinals", wireType)
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuffixKeyColumns", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuffixKeyColumns = append(m.SuffixKeyColumns, fetchpb.IndexFetchSpec_KeyColumn{})
			if err := m.SuffixKeyColumns[len(m.SuffixKeyColumns)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsIndexPut", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
