...
import (
	...
	revlogpb "github.com/cockroachdb/cockroach/pkg/revlog/revlogpb"
...
type BulkMergeSpec_MemoryMonitor int32

const (
	// BULK_MONITOR uses the bulk (parent) memory monitor (default).
	BulkMergeSpec_BULK_MONITOR BulkMergeSpec_MemoryMonitor = 0
	// BACKFILL_MONITOR uses the backfiller memory monitor.
	BulkMergeSpec_BACKFILL_MONITOR BulkMergeSpec_MemoryMonitor = 1
)

var BulkMergeSpec_MemoryMonitor_name = map[int32]string{
	0: "BULK_MONITOR",
	1: "BACKFILL_MONITOR",
}

var BulkMergeSpec_MemoryMonitor_value = map[string]int32{
	"BULK_MONITOR":     0,
	"BACKFILL_MONITOR": 1,
}

func (x BulkMergeSpec_MemoryMonitor) Enum() *BulkMergeSpec_MemoryMonitor {
	p := new(BulkMergeSpec_MemoryMonitor)
	*p = x
	return p
}

func (x BulkMergeSpec_MemoryMonitor) String() string {
	return proto.EnumName(BulkMergeSpec_MemoryMonitor_name, int32(x))
}

func (x *BulkMergeSpec_MemoryMonitor) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(BulkMergeSpec_MemoryMonitor_value, data, "BulkMergeSpec_MemoryMonitor")
	if err != nil {
		return err
	}
	*x = BulkMergeSpec_MemoryMonitor(value)
	return nil
}

func (BulkMergeSpec_MemoryMonitor) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{28, 0}
}
...
type BackfillerSpec struct {
	...
	UseDistributedMergeSink bool                                                            `protobuf:"varint,17,opt,name=use_distributed_merge_sink,json=useDistributedMergeSink" json:"use_distributed_merge_sink"`
	...
	DistributedMergeFilePrefix string `protobuf:"bytes,18,opt,name=distributed_merge_file_prefix,json=distributedMergeFilePrefix" json:"distributed_merge_file_prefix"`
}
...
type ReadImportDataSpec struct {
	...
	Table      *ReadImportDataSpec_ImportTable `protobuf:"bytes,20,opt,name=table" json:"table,omitempty"`
	...
	Tables map[string]*ReadImportDataSpec_ImportTable `protobuf:"bytes,9,rep,name=tables" json:"tables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Deprecated: Do not use.
	...
	// use_distributed_merge indicates whether this import should use the
	// distributed merge pipeline. Determined at planning time.
	UseDistributedMerge bool `protobuf:"varint,21,opt,name=use_distributed_merge,json=useDistributedMerge" json:"use_distributed_merge"`
	// distributed_merge_file_prefix is the ExternalStorage URI path (without
	// nodelocal://nodeID prefix) to use when writing map outputs for the
	// distributed merge pipeline. Each processor constructs its full nodelocal
	// URI using its own node ID at runtime.
	DistributedMergeFilePrefix string `protobuf:"bytes,22,opt,name=distributed_merge_file_prefix,json=distributedMergeFilePrefix" json:"distributed_merge_file_prefix"`
}
...
type MergeCoordinatorSpec struct {
	TaskCount            int64    `protobuf:"varint,1,opt,name=task_count,json=taskCount" json:"task_count"`
	WorkerSqlInstanceIds [][]byte `protobuf:"bytes,2,rep,name=worker_sql_instance_ids,json=workerSqlInstanceIds" json:"worker_sql_instance_ids,omitempty"`
}

func (m *MergeCoordinatorSpec) Reset()         { *m = MergeCoordinatorSpec{} }
func (m *MergeCoordinatorSpec) String() string { return proto.CompactTextString(m) }
func (*MergeCoordinatorSpec) ProtoMessage()    {}
func (*MergeCoordinatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{3}
}
func (m *MergeCoordinatorSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeCoordinatorSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MergeCoordinatorSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeCoordinatorSpec.Merge(m, src)
}
func (m *MergeCoordinatorSpec) XXX_Size() int {
	return m.Size()
}
func (m *MergeCoordinatorSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeCoordinatorSpec.DiscardUnknown(m)
}

var xxx_messageInfo_MergeCoordinatorSpec proto.InternalMessageInfo

// MergeLoopback is scheduled on the same node as the MergeCoordinator.
// MergeCoordinator is the final processor in the flow and MergeLoopback is the
// first processor in the flow. Scheduling them on the same node allows the
// MergeCoordinator to inject task rows into the process.
type MergeLoopbackSpec struct {
}

func (m *MergeLoopbackSpec) Reset()         { *m = MergeLoopbackSpec{} }
func (m *MergeLoopbackSpec) String() string { return proto.CompactTextString(m) }
func (*MergeLoopbackSpec) ProtoMessage()    {}
func (*MergeLoopbackSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{4}
}
func (m *MergeLoopbackSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeLoopbackSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MergeLoopbackSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeLoopbackSpec.Merge(m, src)
}
func (m *MergeLoopbackSpec) XXX_Size() int {
	return m.Size()
}
func (m *MergeLoopbackSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeLoopbackSpec.DiscardUnknown(m)
}

var xxx_messageInfo_MergeLoopbackSpec proto.InternalMessageInfo
...
type RevlogSpec struct {
	JobID github_com_cockroachdb_cockroach_pkg_jobs_jobspb.JobID `protobuf:"varint,1,opt,name=job_id,json=jobId,casttype=github.com/cockroachdb/cockroach/pkg/jobs/jobspb.JobID" json:"job_id"`
	// spans this producer processor covers.
	Spans []roachpb.Span `protobuf:"bytes,2,rep,name=spans" json:"spans"`
	// start_hlc is the lower bound of the log: the rangefeed
	// subscription is started after this HLC, and tick_start of the
	// first manifest equals start_hlc.
	StartHLC hlc.Timestamp `protobuf:"bytes,3,opt,name=start_hlc,json=startHlc" json:"start_hlc"`
	// dest is the cloud storage URI where data files and manifests
	// are written.
	Dest string `protobuf:"bytes,4,opt,name=dest" json:"dest"`
	// tick_width_nanos is the wall-clock-aligned tick width, in
	// nanoseconds.
	TickWidthNanos int64 `protobuf:"varint,5,opt,name=tick_width_nanos,json=tickWidthNanos" json:"tick_width_nanos"`
	// resume_starts gives per-span rangefeed start times for the
	// producer to subscribe at. On first run this is empty and the
	// producer uses start_hlc for every span. On resume it carries
	// the prior incarnation's persisted frontier, sliced to this
	// producer's assigned spans, so the rangefeed only redelivers
	// events the manager hasn't already accounted for. Spans
	// assigned to this producer but absent from resume_starts fall
	// back to start_hlc (e.g. a span newly added by a coverage
	// change since the last checkpoint).
	ResumeStarts []RevlogResumeSpan `protobuf:"bytes,6,rep,name=resume_starts,json=resumeStarts" json:"resume_starts"`
	// tick_starting_flush_orders gives the per-tick starting
	// flushorder counter for ticks the prior incarnation already
	// contributed files to. The producer's first new file for each
	// listed tick lands at this flushorder (== max(prior) + 1
	// computed at the gateway from the persisted open-tick file
	// lists), so per-key ordering survives the resume boundary
	// even if span partitioning has changed.
	TickStartingFlushOrders []RevlogTickResume `protobuf:"bytes,7,rep,name=tick_starting_flush_orders,json=tickStartingFlushOrders" json:"tick_starting_flush_orders"`
}

func (m *RevlogSpec) Reset()         { *m = RevlogSpec{} }
func (m *RevlogSpec) String() string { return proto.CompactTextString(m) }
func (*RevlogSpec) ProtoMessage()    {}
func (*RevlogSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{6}
}
func (m *RevlogSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevlogSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RevlogSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevlogSpec.Merge(m, src)
}
func (m *RevlogSpec) XXX_Size() int {
	return m.Size()
}
func (m *RevlogSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_RevlogSpec.DiscardUnknown(m)
}

var xxx_messageInfo_RevlogSpec proto.InternalMessageInfo

// RevlogResumeSpan pairs a span with the resolved timestamp the
// producer should resume the rangefeed subscription at.
type RevlogResumeSpan struct {
	Span     roachpb.Span  `protobuf:"bytes,1,opt,name=span" json:"span"`
	Resolved hlc.Timestamp `protobuf:"bytes,2,opt,name=resolved" json:"resolved"`
}

func (m *RevlogResumeSpan) Reset()         { *m = RevlogResumeSpan{} }
func (m *RevlogResumeSpan) String() string { return proto.CompactTextString(m) }
func (*RevlogResumeSpan) ProtoMessage()    {}
func (*RevlogResumeSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{7}
}
func (m *RevlogResumeSpan) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevlogResumeSpan) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RevlogResumeSpan) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevlogResumeSpan.Merge(m, src)
}
func (m *RevlogResumeSpan) XXX_Size() int {
	return m.Size()
}
func (m *RevlogResumeSpan) XXX_DiscardUnknown() {
	xxx_messageInfo_RevlogResumeSpan.DiscardUnknown(m)
}

var xxx_messageInfo_RevlogResumeSpan proto.InternalMessageInfo

// RevlogTickResume pairs a tick end with the producer's starting
// flushorder for that tick.
type RevlogTickResume struct {
	TickEnd            hlc.Timestamp `protobuf:"bytes,1,opt,name=tick_end,json=tickEnd" json:"tick_end"`
	StartingFlushOrder int32         `protobuf:"varint,2,opt,name=starting_flush_order,json=startingFlushOrder" json:"starting_flush_order"`
}

func (m *RevlogTickResume) Reset()         { *m = RevlogTickResume{} }
func (m *RevlogTickResume) String() string { return proto.CompactTextString(m) }
func (*RevlogTickResume) ProtoMessage()    {}
func (*RevlogTickResume) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{8}
}
func (m *RevlogTickResume) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevlogTickResume) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RevlogTickResume) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevlogTickResume.Merge(m, src)
}
func (m *RevlogTickResume) XXX_Size() int {
	return m.Size()
}
func (m *RevlogTickResume) XXX_DiscardUnknown() {
	xxx_messageInfo_RevlogTickResume.DiscardUnknown(m)
}

var xxx_messageInfo_RevlogTickResume proto.InternalMessageInfo
...
type StreamIngestionFrontierSpec struct {
	...
	NumIngestionProcessors int32 `protobuf:"varint,10,opt,name=num_ingestion_processors,json=numIngestionProcessors" json:"num_ingestion_processors"`
}
...
type BackupDataSpec struct {
	...
	StrictLocality         bool `protobuf:"varint,14,opt,name=strict_locality,json=strictLocality" json:"strict_locality"`
}
...
type RestoreFileSpec struct {
	...
	UseLink bool `protobuf:"varint,11,opt,name=use_link,json=useLink" json:"use_link"`
}
...
type GenerativeSplitAndScatterSpec struct {
	...
	UseLink bool `protobuf:"varint,25,opt,name=use_link,json=useLink" json:"use_link"`
}
...
func (*CloudStorageTestSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{23}
}
...
func (*CloudStorageTestSpec_Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{23, 0}
}
...
func (*TableReplicationMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{24}
}
...
func (*LogicalReplicationWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{25}
}
...
func (*LogicalReplicationOfflineScanSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{26}
}
...
type CompactBackupsSpec struct {
	...
	URIsByLocalityKV map[string]string `protobuf:"bytes,13,rep,name=uris_by_locality_kv,json=urisByLocalityKv" json:"uris_by_locality_kv,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	StrictLocality   bool              `protobuf:"varint,14,opt,name=strict_locality,json=strictLocality" json:"strict_locality"`
}
...
func (*CompactBackupsSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{27}
}
...
type BulkMergeSpec struct {
	// ssts is the list of input SSTs to merge.
	SSTs []BulkMergeSpec_SST `protobuf:"bytes,1,rep,name=ssts" json:"ssts"`
	...
	Spans []roachpb.Span `protobuf:"bytes,2,rep,name=spans" json:"spans"`
	// output_storage is the external storage connection where the merged output should be stored.
	OutputStorage cloudpb.ExternalStorage `protobuf:"bytes,3,opt,name=output_storage,json=outputStorage" json:"output_storage"`
	// iteration identifies which merge iteration this processor is executing.
	Iteration int32 `protobuf:"varint,4,opt,name=iteration" json:"iteration"`
	// max_iterations captures the total number of merge iterations. When
	// iteration == max_iterations, the processor should write directly to KV
	// instead of producing SSTs in external storage.
	MaxIterations int32 `protobuf:"varint,5,opt,name=max_iterations,json=maxIterations" json:"max_iterations"`
	// write_timestamp is the MVCC timestamp to use when the final iteration writes
	// directly into KV.
	WriteTimestamp hlc.Timestamp `protobuf:"bytes,6,opt,name=write_timestamp,json=writeTimestamp" json:"write_timestamp"`
	// enforce_uniqueness indicates whether to check for duplicate keys during the
	// final merge iteration. Should be true when building unique indexes. Duplicate
	// key errors will propagate as DuplicateKeyError or KeyCollisionError.
	EnforceUniqueness bool `protobuf:"varint,7,opt,name=enforce_uniqueness,json=enforceUniqueness" json:"enforce_uniqueness"`
	// memory_monitor selects which parent memory monitor the merge processor
	// uses for SSTBatcher memory accounting during the final iteration.
	MemoryMonitor BulkMergeSpec_MemoryMonitor `protobuf:"varint,8,opt,name=memory_monitor,json=memoryMonitor,enum=cockroach.sql.distsqlrun.BulkMergeSpec_MemoryMonitor" json:"memory_monitor"`
}

func (m *BulkMergeSpec) Reset()         { *m = BulkMergeSpec{} }
func (m *BulkMergeSpec) String() string { return proto.CompactTextString(m) }
func (*BulkMergeSpec) ProtoMessage()    {}
func (*BulkMergeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{28}
}
func (m *BulkMergeSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BulkMergeSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BulkMergeSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BulkMergeSpec.Merge(m, src)
}
func (m *BulkMergeSpec) XXX_Size() int {
	return m.Size()
}
func (m *BulkMergeSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_BulkMergeSpec.DiscardUnknown(m)
}

var xxx_messageInfo_BulkMergeSpec proto.InternalMessageInfo

// SST represents metadata about a single SST file to be merged.
type BulkMergeSpec_SST struct {
	// uri is a fully qualifed URI to the SST file. It will look something like
	// 'nodelocal://2/<job_id>/input/0.sst'
	URI string `protobuf:"bytes,1,opt,name=uri" json:"uri"`
	// start_key is the first key in the SST.
	StartKey github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=start_key,json=startKey,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.Key" json:"start_key,omitempty"`
	// end_key is the last key in the SST.
	EndKey github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,3,opt,name=end_key,json=endKey,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.Key" json:"end_key,omitempty"`
	// key_count is the number of keys in this SST file.
	KeyCount uint64 `protobuf:"varint,4,opt,name=key_count,json=keyCount" json:"key_count"`
}

func (m *BulkMergeSpec_SST) Reset()         { *m = BulkMergeSpec_SST{} }
func (m *BulkMergeSpec_SST) String() string { return proto.CompactTextString(m) }
func (*BulkMergeSpec_SST) ProtoMessage()    {}
func (*BulkMergeSpec_SST) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{28, 0}
}
func (m *BulkMergeSpec_SST) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BulkMergeSpec_SST) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BulkMergeSpec_SST) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BulkMergeSpec_SST.Merge(m, src)
}
func (m *BulkMergeSpec_SST) XXX_Size() int {
	return m.Size()
}
func (m *BulkMergeSpec_SST) XXX_DiscardUnknown() {
	xxx_messageInfo_BulkMergeSpec_SST.DiscardUnknown(m)
}

var xxx_messageInfo_BulkMergeSpec_SST proto.InternalMessageInfo

type BulkMergeSpec_Output struct {
	// output_ssts is the list of output SSTs.
	SSTs []BulkMergeSpec_SST `protobuf:"bytes,1,rep,name=ssts" json:"ssts"`
}

func (m *BulkMergeSpec_Output) Reset()         { *m = BulkMergeSpec_Output{} }
func (m *BulkMergeSpec_Output) String() string { return proto.CompactTextString(m) }
func (*BulkMergeSpec_Output) ProtoMessage()    {}
func (*BulkMergeSpec_Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{28, 1}
}
func (m *BulkMergeSpec_Output) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BulkMergeSpec_Output) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BulkMergeSpec_Output) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BulkMergeSpec_Output.Merge(m, src)
}
func (m *BulkMergeSpec_Output) XXX_Size() int {
	return m.Size()
}
func (m *BulkMergeSpec_Output) XXX_DiscardUnknown() {
	xxx_messageInfo_BulkMergeSpec_Output.DiscardUnknown(m)
}

var xxx_messageInfo_BulkMergeSpec_Output proto.InternalMessageInfo

// BulkMapProgress is emitted by map-stage processors (index backfill, import)
// to describe newly produced SST manifests.
type BulkMapProgress struct {
	SSTManifests []jobspb.BulkSSTManifest `protobuf:"bytes,1,rep,name=sst_manifests,json=sstManifests" json:"sst_manifests"`
}

func (m *BulkMapProgress) Reset()         { *m = BulkMapProgress{} }
func (m *BulkMapProgress) String() string { return proto.CompactTextString(m) }
func (*BulkMapProgress) ProtoMessage()    {}
func (*BulkMapProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{29}
}
func (m *BulkMapProgress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BulkMapProgress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BulkMapProgress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BulkMapProgress.Merge(m, src)
}
func (m *BulkMapProgress) XXX_Size() int {
	return m.Size()
}
func (m *BulkMapProgress) XXX_DiscardUnknown() {
	xxx_messageInfo_BulkMapProgress.DiscardUnknown(m)
}

var xxx_messageInfo_BulkMapProgress proto.InternalMessageInfo

// IngestFileSpec describes the set of SSTs to be ingested by an ingest
// processor. Each SST is expected to be range-aligned and non-overlapping.
type IngestFileSpec struct {
	SSTs []BulkMergeSpec_SST `protobuf:"bytes,1,rep,name=ssts" json:"ssts"`
}

func (m *IngestFileSpec) Reset()         { *m = IngestFileSpec{} }
func (m *IngestFileSpec) String() string { return proto.CompactTextString(m) }
func (*IngestFileSpec) ProtoMessage()    {}
func (*IngestFileSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{30}
}
func (m *IngestFileSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IngestFileSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *IngestFileSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IngestFileSpec.Merge(m, src)
}
func (m *IngestFileSpec) XXX_Size() int {
	return m.Size()
}
func (m *IngestFileSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_IngestFileSpec.DiscardUnknown(m)
}

var xxx_messageInfo_IngestFileSpec proto.InternalMessageInfo

// RevlogLocalMergeSpec describes a set of revision log ticks assigned to
// one SQL instance for local merge. Each tick's manifest identifies the
// data files to replay. The processor reads the assigned ticks, performs
// a k-way merge, deduplicates to the latest revision per key ≤ the
// restore timestamp, rewrites key prefixes to the target keyspace, and
// writes MVCC-encoded SSTs to nodelocal storage.
type RevlogLocalMergeSpec struct {
	// collection_uri is the collection root URI where the revision log lives.
	CollectionURI string `protobuf:"bytes,1,opt,name=collection_uri,json=collectionUri" json:"collection_uri"`
	// ticks is the set of tick manifests assigned to this processor,
	// shuffled by the coordinator to avoid hot-spot skew.
	Ticks []revlogpb.Manifest `protobuf:"bytes,2,rep,name=ticks" json:"ticks"`
	// job_id is the restore job ID for progress reporting.
	JobID int64 `protobuf:"varint,3,opt,name=job_id,json=jobId" json:"job_id"`
	// user_proto is the user who initiated the restore, needed to open
	// external storage on the processor node.
	...
	// restore_timestamp is the AOST target. During deduplication, only
	// events with timestamps ≤ this value are kept.
	RestoreTimestamp hlc.Timestamp `protobuf:"bytes,5,opt,name=restore_timestamp,json=restoreTimestamp" json:"restore_timestamp"`
	// table_rekeys maps old table IDs to new table descriptors for
	// source→target key prefix rewriting.
	TableRekeys []TableRekey `protobuf:"bytes,6,rep,name=table_rekeys,json=tableRekeys" json:"table_rekeys"`
	// tenant_rekeys maps old tenant IDs to new tenant IDs.
	TenantRekeys []TenantRekey `protobuf:"bytes,7,rep,name=tenant_rekeys,json=tenantRekeys" json:"tenant_rekeys"`
}

func (m *RevlogLocalMergeSpec) Reset()         { *m = RevlogLocalMergeSpec{} }
func (m *RevlogLocalMergeSpec) String() string { return proto.CompactTextString(m) }
func (*RevlogLocalMergeSpec) ProtoMessage()    {}
func (*RevlogLocalMergeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{31}
}
func (m *RevlogLocalMergeSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevlogLocalMergeSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RevlogLocalMergeSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevlogLocalMergeSpec.Merge(m, src)
}
func (m *RevlogLocalMergeSpec) XXX_Size() int {
	return m.Size()
}
func (m *RevlogLocalMergeSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_RevlogLocalMergeSpec.DiscardUnknown(m)
}

var xxx_messageInfo_RevlogLocalMergeSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.BulkMergeSpec_MemoryMonitor", BulkMergeSpec_MemoryMonitor_name, BulkMergeSpec_MemoryMonitor_value)
	...
	proto.RegisterType((*MergeCoordinatorSpec)(nil), "cockroach.sql.distsqlrun.MergeCoordinatorSpec")
	proto.RegisterType((*MergeLoopbackSpec)(nil), "cockroach.sql.distsqlrun.MergeLoopbackSpec")
	proto.RegisterType((*IngestStoppedSpec)(nil), "cockroach.sql.distsqlrun.IngestStoppedSpec")
	proto.RegisterType((*RevlogSpec)(nil), "cockroach.sql.distsqlrun.RevlogSpec")
	proto.RegisterType((*RevlogResumeSpan)(nil), "cockroach.sql.distsqlrun.RevlogResumeSpan")
	proto.RegisterType((*RevlogTickResume)(nil), "cockroach.sql.distsqlrun.RevlogTickResume")
	...
	proto.RegisterMapType((map[string]string)(nil), "cockroach.sql.distsqlrun.CompactBackupsSpec.UrisByLocalityKvEntry")
	proto.RegisterType((*BulkMergeSpec)(nil), "cockroach.sql.distsqlrun.BulkMergeSpec")
	proto.RegisterType((*BulkMergeSpec_SST)(nil), "cockroach.sql.distsqlrun.BulkMergeSpec.SST")
	proto.RegisterType((*BulkMergeSpec_Output)(nil), "cockroach.sql.distsqlrun.BulkMergeSpec.Output")
	proto.RegisterType((*BulkMapProgress)(nil), "cockroach.sql.distsqlrun.BulkMapProgress")
	proto.RegisterType((*IngestFileSpec)(nil), "cockroach.sql.distsqlrun.IngestFileSpec")
	proto.RegisterType((*RevlogLocalMergeSpec)(nil), "cockroach.sql.distsqlrun.RevlogLocalMergeSpec")
}
...
var fileDescriptor_6d46d06b67eadaca = []byte{
	...
	,
}
...
func (m *BackfillerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i -= len(m.DistributedMergeFilePrefix)
	copy(dAtA[i:], m.DistributedMergeFilePrefix)
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.DistributedMergeFilePrefix)))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x92
	i--
	if m.UseDistributedMergeSink {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *MergeCoordinatorSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergeCoordinatorSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergeCoordinatorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.WorkerSqlInstanceIds) > 0 {
		for iNdEx := len(m.WorkerSqlInstanceIds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WorkerSqlInstanceIds[iNdEx])
			copy(dAtA[i:], m.WorkerSqlInstanceIds[iNdEx])
			i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.WorkerSqlInstanceIds[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.TaskCount))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}

func (m *MergeLoopbackSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MergeLoopbackSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MergeLoopbackSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RevlogSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevlogSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevlogSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TickStartingFlushOrders) > 0 {
		for iNdEx := len(m.TickStartingFlushOrders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TickStartingFlushOrders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.ResumeStarts) > 0 {
		for iNdEx := len(m.ResumeStarts) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ResumeStarts[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.TickWidthNanos))
	i--
	dAtA[i] = 0x28
	i -= len(m.Dest)
	copy(dAtA[i:], m.Dest)
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.Dest)))
	i--
	dAtA[i] = 0x22
	{
		size, err := m.StartHLC.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *RevlogResumeSpan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevlogResumeSpan) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevlogResumeSpan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RevlogTickResume) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevlogTickResume) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevlogTickResume) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.StartingFlushOrder))
	i--
	dAtA[i] = 0x10
	{
...
func (m *StreamIngestionFrontierSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.NumIngestionProcessors))
	i--
	dAtA[i] = 0x50
	{
...
func (m *BulkMergeSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BulkMergeSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BulkMergeSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.MemoryMonitor))
	i--
	dAtA[i] = 0x40
	i--
	if m.EnforceUniqueness {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
	...
	i--
	dAtA[i] = 0x32
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.MaxIterations))
	i--
	dAtA[i] = 0x28
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.Iteration))
	i--
	dAtA[i] = 0x20
	{
		size, err := m.OutputStorage.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *BulkMergeSpec_SST) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BulkMergeSpec_SST) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BulkMergeSpec_SST) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(m.KeyCount))
	i--
	dAtA[i] = 0x20
	if m.EndKey != nil {
		i -= len(m.EndKey)
		copy(dAtA[i:], m.EndKey)
		i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.EndKey)))
		i--
		dAtA[i] = 0x1a
	}
	if m.StartKey != nil {
		...
		i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.StartKey)))
		i--
		dAtA[i] = 0x12
	}
	i -= len(m.URI)
	copy(dAtA[i:], m.URI)
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.URI)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}

func (m *BulkMergeSpec_Output) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BulkMergeSpec_Output) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BulkMergeSpec_Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BulkMapProgress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BulkMapProgress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BulkMapProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SSTManifests) > 0 {
		for iNdEx := len(m.SSTManifests) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SSTManifests[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *IngestFileSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IngestFileSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IngestFileSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RevlogLocalMergeSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevlogLocalMergeSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevlogLocalMergeSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size, err := m.RestoreTimestamp.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.CollectionURI)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *BackfillerSpec) Size() (n int) {
	...
	n += 3
	l = len(m.DistributedMergeFilePrefix)
...
func (m *MergeCoordinatorSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovProcessorsBulkIo(uint64(m.TaskCount))
	if len(m.WorkerSqlInstanceIds) > 0 {
		for _, b := range m.WorkerSqlInstanceIds {
			l = len(b)
			n += 1 + l + sovProcessorsBulkIo(uint64(l))
		}
	}
...
func (m *MergeLoopbackSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RevlogSpec) Size() (n int) {
	...
	l = len(m.Dest)
	n += 1 + l + sovProcessorsBulkIo(uint64(l))
	n += 1 + sovProcessorsBulkIo(uint64(m.TickWidthNanos))
	if len(m.ResumeStarts) > 0 {
		for _, e := range m.ResumeStarts {
			l = e.Size()
			n += 1 + l + sovProcessorsBulkIo(uint64(l))
		}
	}
	if len(m.TickStartingFlushOrders) > 0 {
		for _, e := range m.TickStartingFlushOrders {
			l = e.Size()
			n += 1 + l + sovProcessorsBulkIo(uint64(l))
		}
	}
...
func (m *RevlogResumeSpan) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RevlogTickResume) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = m.TickEnd.Size()
	n += 1 + l + sovProcessorsBulkIo(uint64(l))
	n += 1 + sovProcessorsBulkIo(uint64(m.StartingFlushOrder))
	return n
}
...
func (m *StreamIngestionFrontierSpec) Size() (n int) {
	...
	n += 1 + l + sovProcessorsBulkIo(uint64(l))
	n += 1 + sovProcessorsBulkIo(uint64(m.NumIngestionProcessors))
	return n
}
...
func (m *BulkMergeSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = m.OutputStorage.Size()
	n += 1 + l + sovProcessorsBulkIo(uint64(l))
	n += 1 + sovProcessorsBulkIo(uint64(m.Iteration))
	n += 1 + sovProcessorsBulkIo(uint64(m.MaxIterations))
	l = m.WriteTimestamp.Size()
	n += 1 + l + sovProcessorsBulkIo(uint64(l))
	n += 2
	n += 1 + sovProcessorsBulkIo(uint64(m.MemoryMonitor))
	return n
}

func (m *BulkMergeSpec_SST) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + sovProcessorsBulkIo(uint64(m.KeyCount))
	return n
}

func (m *BulkMergeSpec_Output) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BulkMapProgress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IngestFileSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RevlogLocalMergeSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BackfillerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDistributedMergeSink", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UseDistributedMergeSink = bool(v != 0)
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DistributedMergeFilePrefix", wireType)
			}
			...
			m.DistributedMergeFilePrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ReadImportDataSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			if m.Table == nil {
				m.Table = &ReadImportDataSpec_ImportTable{}
			}
			if err := m.Table.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDistributedMerge", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UseDistributedMerge = bool(v != 0)
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DistributedMergeFilePrefix", wireType)
			}
...
func (m *MergeCoordinatorSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeCoordinatorSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeCoordinatorSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TaskCount |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WorkerSqlInstanceIds", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WorkerSqlInstanceIds = append(m.WorkerSqlInstanceIds, make([]byte, postIndex-iNdEx))
			copy(m.WorkerSqlInstanceIds[len(m.WorkerSqlInstanceIds)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsBulkIo(dAtA[iNdEx:])
...
func (m *MergeLoopbackSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeLoopbackSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeLoopbackSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *RevlogSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevlogSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevlogSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartHLC", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.StartHLC.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TickWidthNanos", wireType)
			}
			m.TickWidthNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TickWidthNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResumeStarts", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ResumeStarts = append(m.ResumeStarts, RevlogResumeSpan{})
			if err := m.ResumeStarts[len(m.ResumeStarts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TickStartingFlushOrders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TickStartingFlushOrders = append(m.TickStartingFlushOrders, RevlogTickResume{})
			if err := m.TickStartingFlushOrders[len(m.TickStartingFlushOrders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RevlogResumeSpan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevlogResumeSpan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevlogResumeSpan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RevlogTickResume) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevlogTickResume: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevlogTickResume: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartingFlushOrder", wireType)
			}
			m.StartingFlushOrder = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsBulkIo
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartingFlushOrder |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StreamIngestionFrontierSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumIngestionProcessors", wireType)
			}
			m.NumIngestionProcessors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsBulkIo
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumIngestionProcessors |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BackupDataSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StrictLocality", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RestoreFileSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseLink", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *BulkMergeSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BulkMergeSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BulkMergeSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.SSTs = append(m.SSTs, BulkMergeSpec_SST{})
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputStorage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.OutputStorage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Iteration |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxIterations |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnforceUniqueness", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnforceUniqueness = bool(v != 0)
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MemoryMonitor", wireType)
			}
			m.MemoryMonitor = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MemoryMonitor |= BulkMergeSpec_MemoryMonitor(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BulkMergeSpec_SST) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *BulkMergeSpec_Output) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *BulkMapProgress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BulkMapProgress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BulkMapProgress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SSTManifests", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SSTManifests = append(m.SSTManifests, jobspb.BulkSSTManifest{})
			if err := m.SSTManifests[len(m.SSTManifests)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *IngestFileSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IngestFileSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IngestFileSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RevlogLocalMergeSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevlogLocalMergeSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevlogLocalMergeSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Ticks = append(m.Ticks, revlogpb.Manifest{})
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RestoreTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RestoreTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
