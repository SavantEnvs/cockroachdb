	...
	// [UseSwapMutation]
	{
		if _f.funcs.HasZeroOrOneRow(input) {
			if len(uniqueChecks) == 0 {
				if len(fKChecks) == 0 {
					if _f.funcs.CanUseSwapMutation(opt.UpdateOp, mutationPrivate) {
						newInput, colMap, ok := _f.funcs.BuildSwapMutationInput(input, mutationPrivate)
						if ok {
							if _f.matchedRule == nil || _f.matchedRule(opt.UseSwapMutation) {
								_expr := _f.ConstructUpdate(
									newInput,
									memo.EmptyUniqueChecksExpr,
									memo.EmptyFKChecksExpr,
									_f.funcs.UseSwapMutation(mutationPrivate, colMap),
								)
								if _f.appliedRule != nil {
									_f.appliedRule(opt.UseSwapMutation, nil, _expr)
								}
								_f.constructorStackDepth--
								return _expr
							}
...
func (_f *Factory) ConstructDelete(
	...
	// [UseSwapMutation]
	{
		if _f.funcs.HasZeroOrOneRow(input) {
			if len(uniqueChecks) == 0 {
				if len(fKChecks) == 0 {
					if _f.funcs.CanUseSwapMutation(opt.DeleteOp, mutationPrivate) {
						newInput, colMap, ok := _f.funcs.BuildSwapMutationInput(input, mutationPrivate)
						if ok {
							if _f.matchedRule == nil || _f.matchedRule(opt.UseSwapMutation) {
								_expr := _f.ConstructDelete(
...
func (_f *Factory) ConstructLock(
	...
	{
		rows := input
		if _f.funcs.HasZeroRows(rows) {
			if _f.matchedRule == nil || _f.matchedRule(opt.RemoveZeroCardLock) {
				_expr := rows
				if _f.appliedRule != nil {
					_f.appliedRule(opt.RemoveZeroCardLock, nil, _expr)
				}
				_f.constructorStackDepth--
				return _expr
			}
...
func (_f *Factory) ConstructSelect(
	...
	{
		if _f.funcs.CanHoistUnboundFilterFromExistsSubquery() {
			for i := range filters {
				item := &filters[i]
				_exists, _ := item.Condition.(*memo.ExistsExpr)
				if _exists != nil {
					_select, _ := _exists.Input.(*memo.SelectExpr)
					if _select != nil {
						innerInput := _select.Input
						innerFilters := _select.Filters
						for i := range innerFilters {
							innerItem := &innerFilters[i]
							unboundCond := innerItem.Condition
							inputCols := _f.funcs.OutputCols(input)
							if _f.funcs.IsBoundBy(innerItem, inputCols) {
								existsPrivate := &_exists.ExistsPrivate
								if _f.matchedRule == nil || _f.matchedRule(opt.HoistUnboundFilterFromExistsSubquery) {
									_expr := _f.ConstructSelect(
										input,
										_f.funcs.AppendFiltersItem(_f.funcs.ReplaceFiltersItem(filters, item, _f.ConstructExists(
											_f.ConstructSelect(
												innerInput,
												_f.funcs.RemoveFiltersItem(innerFilters, innerItem),
											),
											existsPrivate,
										)), unboundCond),
									)
									if _f.appliedRule != nil {
										_f.appliedRule(opt.HoistUnboundFilterFromExistsSubquery, nil, _expr)
									}
									_f.constructorStackDepth--
									return _expr
								}
	...
	// [HoistUnboundJoinFilterFromExistsSubquery]
	{
		if _f.funcs.CanHoistUnboundFilterFromExistsSubquery() {
			for i := range filters {
				...
				if _exists != nil {
					join := _exists.Input
					if join.Op() == opt.InnerJoinOp || join.Op() == opt.InnerJoinApplyOp || join.Op() == opt.SemiJoinOp || join.Op() == opt.SemiJoinApplyOp {
						left := join.Child(0).(memo.RelExpr)
						right := join.Child(1).(memo.RelExpr)
						joinFilters := *join.Child(2).(*memo.FiltersExpr)
						for i := range joinFilters {
							innerItem := &joinFilters[i]
							unboundCond := innerItem.Condition
							inputCols := _f.funcs.OutputCols(input)
							if _f.funcs.IsBoundBy(innerItem, inputCols) {
								joinPrivate := join.Private().(*memo.JoinPrivate)
								existsPrivate := &_exists.ExistsPrivate
								if _f.matchedRule == nil || _f.matchedRule(opt.HoistUnboundJoinFilterFromExistsSubquery) {
									_arg := _f.funcs.RemoveFiltersItem(joinFilters, innerItem)
									_expr := _f.ConstructSelect(
										input,
										_f.funcs.AppendFiltersItem(_f.funcs.ReplaceFiltersItem(filters, item, _f.ConstructExists(
											_f.DynamicConstruct(
									...
									if _f.appliedRule != nil {
										_f.appliedRule(opt.HoistUnboundJoinFilterFromExistsSubquery, nil, _expr)
									}
									_f.constructorStackDepth--
									return _expr
								}
		...
		if input.Op() == opt.LeftJoinOp || input.Op() == opt.LeftJoinApplyOp || input.Op() == opt.SemiJoinOp || input.Op() == opt.SemiJoinApplyOp || input.Op() == opt.AntiJoinOp || input.Op() == opt.AntiJoinApplyOp {
			...
			for i := range filters {
				...
				if _f.funcs.IsBoundBy(item, _f.funcs.OutputCols(left)) {
					...
					equivSet := _f.funcs.GetEquivGroups(on, left, right)
	...
	{
		_distinctOn, _ := input.(*memo.DistinctOnExpr)
		if _distinctOn != nil {
			groupingInput := _distinctOn.Input
			aggregations := _distinctOn.Aggregations
			groupingPrivate := &_distinctOn.GroupingPrivate
			if _f.funcs.IsUnorderedGrouping(groupingPrivate) {
				for i := range filters {
					item := &filters[i]
					inputCols := _f.funcs.OutputCols(groupingInput)
					if _f.funcs.IsBoundBy(item, inputCols) {
						if _f.matchedRule == nil || _f.matchedRule(opt.PushSelectIntoUnorderedDistinctOn) {
							_expr := _f.ConstructSelect(
							...
							if _f.appliedRule != nil {
								_f.appliedRule(opt.PushSelectIntoUnorderedDistinctOn, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
	...
	// [SimplifyIsCondition]
	{
		for i := range filters {
			...
			if _is != nil {
				left := _is.Left
				if !_f.funcs.IsTuple(left) {
					right := _is.Right
					if !_f.funcs.IsTuple(right) {
						if _f.funcs.IdenticalTypes(_f.funcs.TypeOf(left), _f.funcs.TypeOf(right)) {
							if _f.funcs.EitherExprIsNeverNull(left, right, _f.funcs.NotNullCols(input)) {
								if _f.matchedRule == nil || _f.matchedRule(opt.SimplifyIsCondition) {
									_expr := _f.ConstructSelect(
										input,
										_f.funcs.ReplaceFiltersItem(filters, item, _f.ConstructEq(
											left,
											right,
										)),
									)
									if _f.appliedRule != nil {
										_f.appliedRule(opt.SimplifyIsCondition, nil, _expr)
									}
									_f.constructorStackDepth--
									return _expr
								}
	...
	// [EliminateCaseTrailingFalsyBranch]
	{
		for i := range filters {
			item := &filters[i]
			_case, _ := item.Condition.(*memo.CaseExpr)
			if _case != nil {
				_true, _ := _case.Input.(*memo.TrueExpr)
				if _true != nil {
					whens := _case.Whens
					if len(whens) > 0 {
						_item := whens[len(whens)-1]
						_when, _ := _item.(*memo.WhenExpr)
						if _when != nil {
							if _when.Value.Op() == opt.FalseOp || _when.Value.Op() == opt.NullOp {
								if _f.funcs.LenGT(whens, 1) {
									orElse := _case.OrElse
									if orElse.Op() == opt.FalseOp || orElse.Op() == opt.NullOp {
										if _f.matchedRule == nil || _f.matchedRule(opt.EliminateCaseTrailingFalsyBranch) {
											_expr := _f.ConstructSelect(
												input,
												_f.funcs.ReplaceFiltersItem(filters, item, _f.ConstructCase(
													_f.ConstructTrue(),
													_f.funcs.DropLast(whens),
													orElse,
												)),
											)
											if _f.appliedRule != nil {
												_f.appliedRule(opt.EliminateCaseTrailingFalsyBranch, nil, _expr)
											}
											_f.constructorStackDepth--
											return _expr
										}
					...
					if len(whens) == 1 {
						...
						if _when != nil {
							if _when.Value.Op() == opt.FalseOp || _when.Value.Op() == opt.NullOp {
								orElse := _case.OrElse
								if orElse.Op() == opt.FalseOp || orElse.Op() == opt.NullOp {
									if _f.matchedRule == nil || _f.matchedRule(opt.SimplifyCaseSingleFalsyBranch) {
										_expr := _f.ConstructSelect(
											input,
											_f.funcs.ReplaceFiltersItem(filters, item, orElse),
										)
										if _f.appliedRule != nil {
											_f.appliedRule(opt.SimplifyCaseSingleFalsyBranch, nil, _expr)
										}
										_f.constructorStackDepth--
										return _expr
									}
				...
				if _true != nil {
					...
					if len(whens) == 1 {
						...
						if _when != nil {
							...
							_true2, _ := _when.Value.(*memo.TrueExpr)
							if _true2 != nil {
								if _case.OrElse.Op() == opt.FalseOp || _case.OrElse.Op() == opt.NullOp {
									if _f.matchedRule == nil || _f.matchedRule(opt.SimplifyCaseSingleTruthyBranch) {
										_expr := _f.ConstructSelect(
											input,
											_f.funcs.ReplaceFiltersItem(filters, item, cond),
										)
										if _f.appliedRule != nil {
											_f.appliedRule(opt.SimplifyCaseSingleTruthyBranch, nil, _expr)
										}
										_f.constructorStackDepth--
										return _expr
									}
	...
	{
		_barrier, _ := input.(*memo.BarrierExpr)
		if _barrier != nil {
			input := _barrier.Input
			leakproofPermeable := _barrier.LeakproofPermeable
			if _f.funcs.If(leakproofPermeable) {
				leakproofFilters, remainingFilters, ok := _f.funcs.SplitLeakproofFilters(filters)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.PushLeakproofFiltersIntoPermeableBarrier) {
						_expr := _f.ConstructSelect(
							_f.ConstructBarrier(
								_f.ConstructSelect(
									input,
						...
						if _f.appliedRule != nil {
							_f.appliedRule(opt.PushLeakproofFiltersIntoPermeableBarrier, nil, _expr)
						}
						_f.constructorStackDepth--
						return _expr
					}
	...
	// [NormalizeLikeAny]
	{
		for i := range filters {
			item := &filters[i]
			if item.Condition.Op() == opt.LikeOp || item.Condition.Op() == opt.ILikeOp {
				left := item.Condition.Child(0).(opt.ScalarExpr)
				pattern := item.Condition.Child(1).(opt.ScalarExpr)
				_const, _ := pattern.(*memo.ConstExpr)
				if _const != nil {
					if _f.funcs.ConstStringEquals(_const, "%") {
						if _f.matchedRule == nil || _f.matchedRule(opt.NormalizeLikeAny) {
							_expr := _f.ConstructSelect(
								input,
								_f.funcs.ReplaceFiltersItem(filters, item, _f.ConstructIsNot(
									left,
									_f.ConstructNull(
										_f.funcs.AnyType(),
									),
							...
							if _f.appliedRule != nil {
								_f.appliedRule(opt.NormalizeLikeAny, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
	...
	// [EliminateZeroCardSelect]
	{
		if _f.funcs.HasZeroRows(input) {
			if _f.matchedRule == nil || _f.matchedRule(opt.EliminateZeroCardSelect) {
				_expr := input
				if _f.appliedRule != nil {
					_f.appliedRule(opt.EliminateZeroCardSelect, nil, _expr)
				}
				_f.constructorStackDepth--
				return _expr
			}
...
func (_f *Factory) ConstructProject(
	...
	// [FoldIsNullProject]
	{
		for i := range projections {
			item := &projections[i]
			_is, _ := item.Element.(*memo.IsExpr)
			if _is != nil {
				_variable, _ := _is.Left.(*memo.VariableExpr)
				if _variable != nil {
					col := _variable.Col
					...
					if _null != nil {
						if _f.funcs.IsColNotNull(col, input) {
							if _f.matchedRule == nil || _f.matchedRule(opt.FoldIsNullProject) {
								_expr := _f.ConstructProject(
									input,
									_f.funcs.FoldIsNullProjectionsItems(projections, input),
									passthrough,
								)
								if _f.appliedRule != nil {
									_f.appliedRule(opt.FoldIsNullProject, nil, _expr)
								}
								_f.constructorStackDepth--
								return _expr
							}
	...
	// [PushLeakproofProjectionsIntoPermeableBarrier]
	{
		...
		if _barrier != nil {
			...
			leakproofPermeable := _barrier.LeakproofPermeable
			if _f.funcs.If(leakproofPermeable) {
				if _f.funcs.HasAllLeakProofProjections(projections) {
					if _f.matchedRule == nil || _f.matchedRule(opt.PushLeakproofProjectionsIntoPermeableBarrier) {
						_expr := _f.ConstructBarrier(
							_f.ConstructProject(
								input,
								projections,
								passthrough,
						...
						if _f.appliedRule != nil {
							_f.appliedRule(opt.PushLeakproofProjectionsIntoPermeableBarrier, nil, _expr)
						}
						_f.constructorStackDepth--
						return _expr
					}
	...
	{
		if _f.funcs.HasZeroRows(input) {
			if _f.funcs.IsLeakproof(input) {
				if _f.matchedRule == nil || _f.matchedRule(opt.EliminateZeroCardProject) {
					_expr := _f.funcs.ConstructEmptyValues(_f.funcs.UnionCols(passthrough, _f.funcs.ProjectionCols(projections))).(memo.RelExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.EliminateZeroCardProject, nil, _expr)
					}
					_f.constructorStackDepth--
					return _expr
				}
	...
	// [PruneUnionAllCols]
	{
		...
		if _unionAll != nil {
			...
			needed := _f.funcs.IntersectionCols(_f.funcs.UnionCols(_f.funcs.ProjectionOuterCols(projections), passthrough), _f.funcs.OutputCols(_unionAll))
...
func (_f *Factory) ConstructInnerJoin(
		...
		if _limit != nil {
			...
			if _const != nil {
				...
				if _f.funcs.HasOuterCols(_limit) {
					if _f.funcs.IsGreaterThan(limit, _f.funcs.DInt(1)) {
						private := joinPrivate
	...
	// [HoistJoinProjectRight]
	{
		...
		if _project != nil {
			input := _project.Input
			projections := _project.Projections
			if _f.funcs.AllAreRemappingProjections(projections) {
				if _f.funcs.ColsAreSubset(_f.funcs.ProjectionOuterCols(projections), _f.funcs.OutputCols(input)) {
					passThrough := _project.Passthrough
					private := joinPrivate
					if _f.matchedRule == nil || _f.matchedRule(opt.HoistJoinProjectRight) {
						_expr := _f.ConstructProject(
							_f.ConstructInnerJoin(
								left,
								input,
								_f.funcs.UnbindFiltersFromProjections(projections, on),
								private,
							),
							projections,
							_f.funcs.UnionCols(_f.funcs.OutputCols(left), passThrough),
	...
	// [HoistJoinProjectLeft]
	{
		...
		if _project != nil {
			input := _project.Input
			projections := _project.Projections
			if !_f.funcs.HasVolatileProjection(projections) {
				passThrough := _project.Passthrough
				if !_f.funcs.IsCorrelated(right, _f.funcs.ProjectionCols(projections)) {
					private := joinPrivate
					remap, other, ok := _f.funcs.CanHoistNonRemappingProjections(projections)
					if ok {
						if !_f.funcs.ColsIntersect(_f.funcs.FilterOuterCols(on), _f.funcs.ProjectionCols(other)) {
							if !_f.funcs.ColsIntersect(_f.funcs.ProjectionOuterCols(other), _f.funcs.OutputCols(input)) {
								if _f.matchedRule == nil || _f.matchedRule(opt.HoistJoinProjectLeft) {
									_expr := _f.ConstructProject(
										_f.ConstructInnerJoin(
											input,
											right,
											_f.funcs.UnbindFiltersFromProjections(remap, on),
											private,
										),
										projections,
										_f.funcs.UnionCols(passThrough, _f.funcs.OutputCols(right)),
									)
									if _f.appliedRule != nil {
	...
	{
		_barrier, _ := left.(*memo.BarrierExpr)
		if _barrier != nil {
			left := _barrier.Input
			leakproofPermeable := _barrier.LeakproofPermeable
			if _f.funcs.If(leakproofPermeable) {
				if _f.funcs.IsLeakproof(right) {
					if _f.funcs.HasAllLeakProofFilters(on) {
						private := joinPrivate
						if _f.matchedRule == nil || _f.matchedRule(opt.PushLeakproofJoinIntoPermeableBarrierLeft) {
							_expr := _f.ConstructBarrier(
								_f.ConstructInnerJoin(
									left,
									right,
							...
							if _f.appliedRule != nil {
								_f.appliedRule(opt.PushLeakproofJoinIntoPermeableBarrierLeft, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
	...
	{
		if _f.funcs.IsLeakproof(left) {
			_barrier, _ := right.(*memo.BarrierExpr)
			if _barrier != nil {
				right := _barrier.Input
				leakproofPermeable := _barrier.LeakproofPermeable
				if _f.funcs.If(leakproofPermeable) {
					if _f.funcs.HasAllLeakProofFilters(on) {
						private := joinPrivate
						if _f.matchedRule == nil || _f.matchedRule(opt.PushLeakproofJoinIntoPermeableBarrierRight) {
							_expr := _f.ConstructBarrier(
								_f.ConstructInnerJoin(
									left,
									right,
							...
							if _f.appliedRule != nil {
								_f.appliedRule(opt.PushLeakproofJoinIntoPermeableBarrierRight, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
...
func (_f *Factory) ConstructLeftJoin(
	...
	// [SimplifyLeftJoinWithZeroRowsRight]
	{
		if _f.funcs.HasZeroRows(right) {
			if _f.matchedRule == nil || _f.matchedRule(opt.SimplifyLeftJoinWithZeroRowsRight) {
				_expr := _f.ConstructProject(
					left,
					_f.funcs.MakeNullProjections(right),
					_f.funcs.OutputCols(left),
				)
				if _f.appliedRule != nil {
					_f.appliedRule(opt.SimplifyLeftJoinWithZeroRowsRight, nil, _expr)
				}
				_f.constructorStackDepth--
				return _expr
			}
...
func (_f *Factory) ConstructGroupBy(
	...
	{
		window := input
		_window, _ := window.(*memo.WindowExpr)
		if _window != nil {
			input := _window.Input
			windows := _window.Windows
			if _f.funcs.WindowsAreAggregations(windows) {
				windowPrivate := &_window.WindowPrivate
				partitionByCols := _f.funcs.WindowPartition(windowPrivate)
				if _f.funcs.ColsAreDeterminedBy(_f.funcs.WindowFuncOutputCols(windows), partitionByCols, _window) {
					aggs := aggregations
					inputCols := _f.funcs.OutputCols(input)
					if _f.funcs.CanMergeAggsAndWindow(aggs, windows, inputCols) {
						if _f.funcs.IsUnorderedGrouping(groupingPrivate) {
							groupingCols := _f.funcs.GroupingCols(groupingPrivate)
							if _f.funcs.ColsAreEqual(groupingCols, partitionByCols) {
								if _f.matchedRule == nil || _f.matchedRule(opt.FoldGroupByAndWindow) {
									_expr := _f.ConstructGroupBy(
										input,
										_f.funcs.MergeAggsAndWindow(aggs, windows, inputCols),
										_f.funcs.MakeGrouping(_f.funcs.GroupingCols(groupingPrivate), _f.funcs.WindowOrdering(windowPrivate)),
									)
									if _f.appliedRule != nil {
										_f.appliedRule(opt.FoldGroupByAndWindow, nil, _expr)
									}
									_f.constructorStackDepth--
									return _expr
								}
...
func (_f *Factory) ConstructScalarGroupBy(
	...
	// [TryDecorrelateUnion]
	{
		if input.Op() == opt.UnionOp || input.Op() == opt.UnionAllOp {
			left := input.Child(0).(memo.RelExpr)
			right := input.Child(1).(memo.RelExpr)
			unionPrivate := input.Private().(*memo.SetPrivate)
			if _f.funcs.HasOuterCols(input) {
				aggs := aggregations
				if _f.funcs.AreAllAnyNotNullAggs(aggs) {
					private := groupingPrivate
					if _f.matchedRule == nil || _f.matchedRule(opt.TryDecorrelateUnion) {
						_expr := _f.ConstructProject(
							_f.ConstructProject(
								_f.ConstructInnerJoin(
									_f.funcs.MakeAnyNotNullScalarGroupBy(left),
									_f.funcs.MakeAnyNotNullScalarGroupBy(right),
									memo.EmptyFiltersExpr,
									_f.funcs.EmptyJoinPrivate(),
								),
								_f.funcs.MakeCoalesceProjectionsForUnion(unionPrivate),
								_f.funcs.MakeEmptyColSet(),
							),
							_f.funcs.ConvertAnyNotNullAggsToProjections(aggs),
							_f.funcs.IntersectionCols(_f.funcs.GroupingOutputCols(private, aggs), _f.funcs.OutputCols(input)),
						)
						if _f.appliedRule != nil {
							_f.appliedRule(opt.TryDecorrelateUnion, nil, _expr)
						}
						_f.constructorStackDepth--
						return _expr
					}
...
func (_f *Factory) ConstructDistinctOn(
	...
	// [HoistSelectAboveUnorderedDistinctOn]
	{
		...
		if _select != nil {
			...
			filters := _select.Filters
			if _f.funcs.IsUnorderedGrouping(groupingPrivate) {
				if _f.funcs.CanHoistCorrelatedFiltersAbove(filters, _f.funcs.OutputCols(input)) {
					if _f.matchedRule == nil || _f.matchedRule(opt.HoistSelectAboveUnorderedDistinctOn) {
						_expr := _f.ConstructSelect(
							_f.ConstructDistinctOn(
								_f.ConstructSelect(
									input,
									_f.funcs.ExtractBoundConditions(filters, _f.funcs.OutputCols(input)),
								),
								_f.funcs.AddFirstAggsForHoistedFilters(aggregations, filters, _f.funcs.OutputCols(input), _f.funcs.GroupingOutputCols(groupingPrivate, aggregations)),
								groupingPrivate,
							),
							_f.funcs.ExtractUnboundConditions(filters, _f.funcs.OutputCols(input)),
						)
						if _f.appliedRule != nil {
							_f.appliedRule(opt.HoistSelectAboveUnorderedDistinctOn, nil, _expr)
						}
						_f.constructorStackDepth--
						return _expr
					}
		...
		if _f.funcs.HasNoGroupingCols(groupingPrivate) {
			if _f.matchedRule == nil || _f.matchedRule(opt.EliminateDistinctNoColumns) {
				_expr := _f.funcs.ConstructProjectionFromDistinctOn(_f.ConstructLimit(
					input,
					_f.funcs.IntConst(_f.funcs.DInt(1)),
...
func (_f *Factory) ConstructLimit(
			...
			if !_f.funcs.HasOuterCols(left) {
				...
				if _f.funcs.JoinPreservesLeftRows(input) {
					...
					if _const != nil {
						limit := _const.Value
						if _f.funcs.IsPositiveInt(limit) {
							if _f.funcs.CanRepresentMaxRows(limit) {
	...
	// [PushLimitIntoLock]
	{
		_lock, _ := input.(*memo.LockExpr)
		if _lock != nil {
			input := _lock.Input
			private := &_lock.LockPrivate
			if !_f.funcs.LockUsesSkipLocked(private) {
				if _f.matchedRule == nil || _f.matchedRule(opt.PushLimitIntoLock) {
					_expr := _f.ConstructLock(
						_f.ConstructLimit(
							input,
							limit,
							ordering,
					...
					if _f.appliedRule != nil {
						_f.appliedRule(opt.PushLimitIntoLock, nil, _expr)
					}
					_f.constructorStackDepth--
					return _expr
				}
...
func (_f *Factory) ConstructOffset(
	...
	// [PushOffsetIntoLock]
	{
		...
		if _lock != nil {
			...
			private := &_lock.LockPrivate
			if !_f.funcs.LockUsesSkipLocked(private) {
				if _f.matchedRule == nil || _f.matchedRule(opt.PushOffsetIntoLock) {
					_expr := _f.ConstructLock(
						_f.ConstructOffset(
							input,
							offset,
					...
					if _f.appliedRule != nil {
						_f.appliedRule(opt.PushOffsetIntoLock, nil, _expr)
					}
					_f.constructorStackDepth--
					return _expr
				}
...
// ConstructVectorSearch constructs an expression for the VectorSearch operator.
...
func (_f *Factory) ConstructVectorSearch(
	queryVector opt.ScalarExpr,
	vectorSearchPrivate *memo.VectorSearchPrivate,
) memo.RelExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	_f.constructorStackDepth++
	if _f.constructorStackDepth > maxConstructorStackDepth {
...
SKIP_RULES:
	e := _f.mem.MemoizeVectorSearch(queryVector, vectorSearchPrivate)
	expr := _f.onConstructRelational(e)
	_f.constructorStackDepth--
	return expr
}

// ConstructVectorMutationSearch constructs an expression for the VectorMutationSearch operator.
...
func (_f *Factory) ConstructVectorMutationSearch(
	input memo.RelExpr,
	vectorMutationSearchPrivate *memo.VectorMutationSearchPrivate,
) memo.RelExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	_f.constructorStackDepth++
	if _f.constructorStackDepth > maxConstructorStackDepth {
...
SKIP_RULES:
	e := _f.mem.MemoizeVectorMutationSearch(input, vectorMutationSearchPrivate)
	expr := _f.onConstructRelational(e)
	_f.constructorStackDepth--
	return expr
}
...
func (_f *Factory) ConstructBarrier(
	...
	// [EliminateRedundantBarrier]
	{
		...
		if _barrier != nil {
			input := _barrier.Input
			innerLeakproofPermeable := _barrier.LeakproofPermeable
			outerLeakproofPermeable := leakproofPermeable
			if _f.funcs.EqualsBool(innerLeakproofPermeable, outerLeakproofPermeable) {
				if _f.matchedRule == nil || _f.matchedRule(opt.EliminateRedundantBarrier) {
					_expr := _f.ConstructBarrier(
						input,
						outerLeakproofPermeable,
					)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.EliminateRedundantBarrier, nil, _expr)
					}
					_f.constructorStackDepth--
					return _expr
				}
...
SKIP_RULES:
	e := _f.mem.MemoizeBarrier(input, leakproofPermeable)
	expr := _f.onConstructRelational(e)
	_f.constructorStackDepth--
	return expr
}
		...
		if _values != nil {
			if len(_values.Rows) == 1 {
				...
				if _tuple != nil {
					if len(_tuple.Elems) == 1 {
						udf := _tuple.Elems[0]
						_uDFCall, _ := udf.(*memo.UDFCallExpr)
						if _uDFCall != nil {
							if _f.matchedRule == nil || _f.matchedRule(opt.EliminateUDFCallSubquery) {
								_expr := _uDFCall
								if _f.appliedRule != nil {
									_f.appliedRule(opt.EliminateUDFCallSubquery, nil, _expr)
								}
								_f.constructorStackDepth--
								return _expr
							}
...
func (_f *Factory) ConstructAny(
	...
	// [InlineAnyProjectSet]
	{
		_projectSet, _ := input.(*memo.ProjectSetExpr)
		if _projectSet != nil {
			_values, _ := _projectSet.Input.(*memo.ValuesExpr)
			if _values != nil {
				if len(_values.Rows) == 1 {
					_item := _values.Rows[0]
					_tuple, _ := _item.(*memo.TupleExpr)
					if _tuple != nil {
						if len(_tuple.Elems) == 0 {
							if len(_projectSet.Zip) == 1 {
								_item := &_projectSet.Zip[0]
								_function, _ := _item.Fn.(*memo.FunctionExpr)
								if _function != nil {
									if len(_function.Args) == 1 {
										arg := _function.Args[0]
										fnPrivate := &_function.FunctionPrivate
										if _f.funcs.EqualsString(fnPrivate.Name, "unnest") {
											if _f.funcs.CanInlineAnyUnnestSubquery() {
												private := subqueryPrivate
												if _f.matchedRule == nil || _f.matchedRule(opt.InlineAnyProjectSet) {
													_expr := _f.ConstructAnd(
														_f.ConstructAnyScalar(
															scalar,
															arg,
															_f.funcs.SubqueryCmp(private),
														),
													...
													if _f.appliedRule != nil {
														_f.appliedRule(opt.InlineAnyProjectSet, nil, _expr)
													}
													_f.constructorStackDepth--
													return _expr
												}
...
func (_f *Factory) ConstructEq(
			...
			if _f.funcs.EqualsString(private.Name, "timezone") {
				if opt.IsConstValueOp(right) {
					if _f.funcs.IsTimestamp(right) {
						zone, tz, ok := _f.funcs.ScalarPair(args)
						if ok {
	...
	// [ConvertLevenshteinToLevenshteinLessEqualLeft]
	{
		...
		if _function != nil {
			args := _function.Args
			private := &_function.FunctionPrivate
			if _f.funcs.EqualsString(private.Name, "levenshtein") {
				if _f.funcs.IsInt(right) {
					arg1, arg2, ok := _f.funcs.ScalarPair(args)
					if ok {
						if _f.matchedRule == nil || _f.matchedRule(opt.ConvertLevenshteinToLevenshteinLessEqualLeft) {
							_expr := _f.ConstructEq(
								_f.funcs.MakeLevenshteinLessEqualFunction(arg1, arg2, right),
								right,
							)
							if _f.appliedRule != nil {
								_f.appliedRule(opt.ConvertLevenshteinToLevenshteinLessEqualLeft, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
		...
		if _f.funcs.IsInt(left) {
			...
			if _function != nil {
				...
				if _f.funcs.EqualsString(private.Name, "levenshtein") {
					arg1, arg2, ok := _f.funcs.ScalarPair(args)
					if ok {
						if _f.matchedRule == nil || _f.matchedRule(opt.ConvertLevenshteinToLevenshteinLessEqualRight) {
							_expr := _f.ConstructEq(
								left,
								_f.funcs.MakeLevenshteinLessEqualFunction(arg1, arg2, left),
							)
							if _f.appliedRule != nil {
								_f.appliedRule(opt.ConvertLevenshteinToLevenshteinLessEqualRight, nil, _expr)
							}
							_f.constructorStackDepth--
							return _expr
						}
...
func (_f *Factory) ConstructLike(
	...
	// [CollapseRepeatedLikePatternWildcards]
	{
		input := left
		pattern := right
		collapsed, ok := _f.funcs.CollapseRepeatedLikePatternWildcards(pattern)
		if ok {
			if _f.matchedRule == nil || _f.matchedRule(opt.CollapseRepeatedLikePatternWildcards) {
				_expr := _f.ConstructLike(
					input,
					collapsed,
				)
				if _f.appliedRule != nil {
					_f.appliedRule(opt.CollapseRepeatedLikePatternWildcards, nil, _expr)
				}
				_f.constructorStackDepth--
				return _expr
			}
...
// ConstructFirstContains constructs an expression for the FirstContains operator.
func (_f *Factory) ConstructFirstContains(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) opt.ScalarExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	...
	// [FoldNullBinaryLeft]
	{
		_null, _ := left.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.FirstContainsOp, _null, right) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryLeft) {
					_expr := _f.funcs.FoldNullBinary(opt.FirstContainsOp, _null, right).(opt.ScalarExpr)
					if _f.appliedRule != nil {
	...
	// [FoldNullBinaryRight]
	{
		_null, _ := right.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.FirstContainsOp, left, _null) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryRight) {
					_expr := _f.funcs.FoldNullBinary(opt.FirstContainsOp, left, _null).(opt.ScalarExpr)
					if _f.appliedRule != nil {
	...
	// [FoldBinary]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsConstValueOrGroupOfConstValues(right) {
				result, ok := _f.funcs.FoldBinary(opt.FirstContainsOp, left, right)
				if ok {
...
SKIP_RULES:
	e := _f.mem.MemoizeFirstContains(left, right)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}
...
// ConstructFirstContainedBy constructs an expression for the FirstContainedBy operator.
func (_f *Factory) ConstructFirstContainedBy(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) opt.ScalarExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	...
	// [FoldNullBinaryLeft]
	{
		_null, _ := left.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.FirstContainedByOp, _null, right) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryLeft) {
					_expr := _f.funcs.FoldNullBinary(opt.FirstContainedByOp, _null, right).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryLeft, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldNullBinaryRight]
	{
		_null, _ := right.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.FirstContainedByOp, left, _null) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryRight) {
					_expr := _f.funcs.FoldNullBinary(opt.FirstContainedByOp, left, _null).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryRight, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldBinary]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsConstValueOrGroupOfConstValues(right) {
				result, ok := _f.funcs.FoldBinary(opt.FirstContainedByOp, left, right)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.FoldBinary) {
						_expr := result.(opt.ScalarExpr)
						if _f.appliedRule != nil {
...
SKIP_RULES:
	e := _f.mem.MemoizeFirstContainedBy(left, right)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}
...
// ConstructVectorDistance constructs an expression for the VectorDistance operator.
// VectorDistance is the <-> operator when used with vector operands.
// It maps to tree.Distance.
func (_f *Factory) ConstructVectorDistance(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) opt.ScalarExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	...
	// [FoldNullBinaryLeft]
	{
		_null, _ := left.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorDistanceOp, _null, right) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryLeft) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorDistanceOp, _null, right).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryLeft, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldNullBinaryRight]
	{
		_null, _ := right.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorDistanceOp, left, _null) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryRight) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorDistanceOp, left, _null).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryRight, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldBinary]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsConstValueOrGroupOfConstValues(right) {
				result, ok := _f.funcs.FoldBinary(opt.VectorDistanceOp, left, right)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.FoldBinary) {
						_expr := result.(opt.ScalarExpr)
						if _f.appliedRule != nil {
	...
	// [CommuteVar]
	{
		...
		if _variable == nil {
			...
			if _variable2 != nil {
				if _f.matchedRule == nil || _f.matchedRule(opt.CommuteVar) {
					_expr := _f.ConstructVectorDistance(
						_variable2,
						left,
					)
					if _f.appliedRule != nil {
...
SKIP_RULES:
	e := _f.mem.MemoizeVectorDistance(left, right)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}

// ConstructVectorCosDistance constructs an expression for the VectorCosDistance operator.
// VectorCosDistance is the <=> operator when used with vector operands.
// It maps to tree.CosDistance.
func (_f *Factory) ConstructVectorCosDistance(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) opt.ScalarExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	...
	// [FoldNullBinaryLeft]
	{
		_null, _ := left.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorCosDistanceOp, _null, right) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryLeft) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorCosDistanceOp, _null, right).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryLeft, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldNullBinaryRight]
	{
		_null, _ := right.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorCosDistanceOp, left, _null) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryRight) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorCosDistanceOp, left, _null).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryRight, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldBinary]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsConstValueOrGroupOfConstValues(right) {
				result, ok := _f.funcs.FoldBinary(opt.VectorCosDistanceOp, left, right)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.FoldBinary) {
						_expr := result.(opt.ScalarExpr)
						if _f.appliedRule != nil {
	...
	// [CommuteVar]
	{
		...
		if _variable == nil {
			...
			if _variable2 != nil {
				if _f.matchedRule == nil || _f.matchedRule(opt.CommuteVar) {
					_expr := _f.ConstructVectorCosDistance(
						_variable2,
						left,
					)
					if _f.appliedRule != nil {
...
SKIP_RULES:
	e := _f.mem.MemoizeVectorCosDistance(left, right)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}

// ConstructVectorNegInnerProduct constructs an expression for the VectorNegInnerProduct operator.
// VectorNegInnerProduct is the <#> operator when used with vector operands.
// It maps to tree.NegInnerProduct.
func (_f *Factory) ConstructVectorNegInnerProduct(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) opt.ScalarExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	...
	// [FoldNullBinaryLeft]
	{
		_null, _ := left.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorNegInnerProductOp, _null, right) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryLeft) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorNegInnerProductOp, _null, right).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryLeft, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldNullBinaryRight]
	{
		_null, _ := right.(*memo.NullExpr)
		if _null != nil {
			if !_f.funcs.AllowNullArgs(opt.VectorNegInnerProductOp, left, _null) {
				if _f.matchedRule == nil || _f.matchedRule(opt.FoldNullBinaryRight) {
					_expr := _f.funcs.FoldNullBinary(opt.VectorNegInnerProductOp, left, _null).(opt.ScalarExpr)
					if _f.appliedRule != nil {
						_f.appliedRule(opt.FoldNullBinaryRight, nil, _expr)
					}
					_f.constructorStackDepth--
	...
	// [FoldBinary]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsConstValueOrGroupOfConstValues(right) {
				result, ok := _f.funcs.FoldBinary(opt.VectorNegInnerProductOp, left, right)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.FoldBinary) {
						_expr := result.(opt.ScalarExpr)
						if _f.appliedRule != nil {
	...
	// [CommuteVar]
	{
		...
		if _variable == nil {
			...
			if _variable2 != nil {
				if _f.matchedRule == nil || _f.matchedRule(opt.CommuteVar) {
					_expr := _f.ConstructVectorNegInnerProduct(
						_variable2,
						left,
					)
					if _f.appliedRule != nil {
...
SKIP_RULES:
	e := _f.mem.MemoizeVectorNegInnerProduct(left, right)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}
...
func (_f *Factory) ConstructAnyScalar(
	...
	// [FoldComparisonWithAny]
	{
		if _f.funcs.IsConstValueOrGroupOfConstValues(left) {
			if _f.funcs.IsTuple(right) {
				result, ok := _f.funcs.FoldComparisonWithAny(cmp, left, right)
				if ok {
					if _f.matchedRule == nil || _f.matchedRule(opt.FoldComparisonWithAny) {
						_expr := result.(opt.ScalarExpr)
						if _f.appliedRule != nil {
							_f.appliedRule(opt.FoldComparisonWithAny, nil, _expr)
						}
						_f.constructorStackDepth--
						return _expr
					}
...
func (_f *Factory) ConstructFunction(
	...
	{
		private := functionPrivate
		if _f.funcs.EqualsString(private.Name, "like_escape") {
			input, iOk := _f.funcs.ScalarExprAt(args, 0)
			if iOk {
				pattern, pOk := _f.funcs.ScalarExprAt(args, 1)
				if pOk {
					escape, eOk := _f.funcs.ScalarExprAt(args, 2)
					if eOk {
						if _f.funcs.ConstStringEquals(escape, "\\") {
							if _f.matchedRule == nil || _f.matchedRule(opt.ConvertLikeEscapeToLike) {
								_expr := _f.ConstructLike(
									input,
									pattern,
								)
								if _f.appliedRule != nil {
									_f.appliedRule(opt.ConvertLikeEscapeToLike, nil, _expr)
								}
								_f.constructorStackDepth--
								return _expr
							}
...
// ConstructSTAsMVT constructs an expression for the STAsMVT operator.
func (_f *Factory) ConstructSTAsMVT(
	input opt.ScalarExpr,
...
SKIP_RULES:
	e := _f.mem.MemoizeSTAsMVT(input, layerName, extent, geomColumn, featureIDColumn)
	expr := _f.onConstructScalar(e)
	_f.constructorStackDepth--
	return expr
}
...
// ConstructCreateTrigger constructs an expression for the CreateTrigger operator.
// CreateTrigger represents a CREATE TRIGGER statement.
func (_f *Factory) ConstructCreateTrigger(
	createTriggerPrivate *memo.CreateTriggerPrivate,
) memo.RelExpr {
	opt.MaybeInjectOptimizerTestingPanic(_f.ctx, _f.evalCtx)
	_f.constructorStackDepth++
	if _f.constructorStackDepth > maxConstructorStackDepth {
...
SKIP_RULES:
	e := _f.mem.MemoizeCreateTrigger(createTriggerPrivate)
	expr := _f.onConstructRelational(e)
	_f.constructorStackDepth--
	return expr
}
...
func (f *Factory) Replace(e opt.Expr, replace ReplaceFunc) opt.Expr {
	...
	case *memo.VectorSearchExpr:
		queryVector := replace(t.QueryVector).(opt.ScalarExpr)
		if queryVector != t.QueryVector {
			return f.ConstructVectorSearch(queryVector, &t.VectorSearchPrivate)
		}
		return t
	...
	case *memo.VectorMutationSearchExpr:
		input := replace(t.Input).(memo.RelExpr)
		if input != t.Input {
			return f.ConstructVectorMutationSearch(input, &t.VectorMutationSearchPrivate)
		}
		return t
	...
	case *memo.BarrierExpr:
		input := replace(t.Input).(memo.RelExpr)
		if input != t.Input {
			return f.ConstructBarrier(input, t.LeakproofPermeable)
		}
		return t
	...
	case *memo.FirstContainsExpr:
		left := replace(t.Left).(opt.ScalarExpr)
		right := replace(t.Right).(opt.ScalarExpr)
		if left != t.Left || right != t.Right {
			return f.ConstructFirstContains(left, right)
		}
		return t
	...
	case *memo.FirstContainedByExpr:
		left := replace(t.Left).(opt.ScalarExpr)
		right := replace(t.Right).(opt.ScalarExpr)
		if left != t.Left || right != t.Right {
			return f.ConstructFirstContainedBy(left, right)
		}
		return t
	...
	case *memo.VectorDistanceExpr:
		...
		right := replace(t.Right).(opt.ScalarExpr)
		if left != t.Left || right != t.Right {
			return f.ConstructVectorDistance(left, right)
		}
		return t
	...
	case *memo.VectorCosDistanceExpr:
		...
		right := replace(t.Right).(opt.ScalarExpr)
		if left != t.Left || right != t.Right {
			return f.ConstructVectorCosDistance(left, right)
		}
		return t
	...
	case *memo.VectorNegInnerProductExpr:
		...
		right := replace(t.Right).(opt.ScalarExpr)
		if left != t.Left || right != t.Right {
			return f.ConstructVectorNegInnerProduct(left, right)
		}
		return t
	...
	case *memo.STAsMVTExpr:
		input := replace(t.Input).(opt.ScalarExpr)
		layerName := replace(t.LayerName).(opt.ScalarExpr)
		extent := replace(t.Extent).(opt.ScalarExpr)
		geomColumn := replace(t.GeomColumn).(opt.ScalarExpr)
		featureIDColumn := replace(t.FeatureIDColumn).(opt.ScalarExpr)
		if input != t.Input || layerName != t.LayerName || extent != t.Extent || geomColumn != t.GeomColumn || featureIDColumn != t.FeatureIDColumn {
			return f.ConstructSTAsMVT(input, layerName, extent, geomColumn, featureIDColumn)
		}
		return t
...
func (f *Factory) CopyAndReplaceDefault(src opt.Expr, replace ReplaceFunc) (dst opt.Expr) {
	...
	case *memo.VectorSearchExpr:
		return f.ConstructVectorSearch(
			f.invokeReplace(t.QueryVector, replace).(opt.ScalarExpr),
			&t.VectorSearchPrivate,
		)

	case *memo.VectorMutationSearchExpr:
		return f.ConstructVectorMutationSearch(
			f.invokeReplace(t.Input, replace).(memo.RelExpr),
			&t.VectorMutationSearchPrivate,
		)

	case *memo.BarrierExpr:
		return f.ConstructBarrier(
			f.invokeReplace(t.Input, replace).(memo.RelExpr),
			t.LeakproofPermeable,
		)
	...
	case *memo.FirstContainsExpr:
		return f.ConstructFirstContains(
			f.invokeReplace(t.Left, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Right, replace).(opt.ScalarExpr),
		)
	...
	case *memo.FirstContainedByExpr:
		return f.ConstructFirstContainedBy(
			f.invokeReplace(t.Left, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Right, replace).(opt.ScalarExpr),
		)
	...
	case *memo.VectorDistanceExpr:
		return f.ConstructVectorDistance(
			f.invokeReplace(t.Left, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Right, replace).(opt.ScalarExpr),
		)

	case *memo.VectorCosDistanceExpr:
		return f.ConstructVectorCosDistance(
			f.invokeReplace(t.Left, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Right, replace).(opt.ScalarExpr),
		)

	case *memo.VectorNegInnerProductExpr:
		return f.ConstructVectorNegInnerProduct(
			f.invokeReplace(t.Left, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Right, replace).(opt.ScalarExpr),
		)
	...
	case *memo.STAsMVTExpr:
		return f.ConstructSTAsMVT(
			f.invokeReplace(t.Input, replace).(opt.ScalarExpr),
			f.invokeReplace(t.LayerName, replace).(opt.ScalarExpr),
			f.invokeReplace(t.Extent, replace).(opt.ScalarExpr),
			f.invokeReplace(t.GeomColumn, replace).(opt.ScalarExpr),
			f.invokeReplace(t.FeatureIDColumn, replace).(opt.ScalarExpr),
		)
	...
	case *memo.CreateTriggerExpr:
		return f.mem.MemoizeCreateTrigger(&t.CreateTriggerPrivate)
...
func (f *Factory) DynamicConstruct(op opt.Operator, args ...interface{}) opt.Expr {
	...
	case opt.VectorSearchOp:
		return f.ConstructVectorSearch(
			args[0].(opt.ScalarExpr),
			args[1].(*memo.VectorSearchPrivate),
		)
	case opt.VectorMutationSearchOp:
		return f.ConstructVectorMutationSearch(
			args[0].(memo.RelExpr),
			args[1].(*memo.VectorMutationSearchPrivate),
		)
	case opt.BarrierOp:
		return f.ConstructBarrier(
			args[0].(memo.RelExpr),
	...
	case opt.VectorDistanceOp:
		return f.ConstructVectorDistance(
			args[0].(opt.ScalarExpr),
			args[1].(opt.ScalarExpr),
		)
	case opt.VectorCosDistanceOp:
		return f.ConstructVectorCosDistance(
			args[0].(opt.ScalarExpr),
			args[1].(opt.ScalarExpr),
		)
	case opt.VectorNegInnerProductOp:
		return f.ConstructVectorNegInnerProduct(
			args[0].(opt.ScalarExpr),
			args[1].(opt.ScalarExpr),
		)
	...
	case opt.STAsMVTOp:
		return f.ConstructSTAsMVT(
			...
			args[1].(opt.ScalarExpr),
			args[2].(opt.ScalarExpr),
			args[3].(opt.ScalarExpr),
			args[4].(opt.ScalarExpr),
		)
	case opt.XorAggOp:
		return f.ConstructXorAgg(
			args[0].(opt.ScalarExpr),
	...
	case opt.CreateTriggerOp:
		return f.ConstructCreateTrigger(
			args[0].(*memo.CreateTriggerPrivate),
		)
	case opt.ExplainOp:
		return f.ConstructExplain(
			args[0].(memo.RelExpr),
