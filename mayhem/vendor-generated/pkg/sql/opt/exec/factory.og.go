...
type Factory interface {
	...
	ConstructApplyJoin(
		...
		rightSideForExplainFn ApplyJoinRightSideForExplainFn,
	) (Node, error)
	...
	// ConstructCreateTrigger creates a node for a CreateTrigger operation.
	//
	// CreateTrigger implements CREATE TRIGGER.
	ConstructCreateTrigger(
		ct *tree.CreateTrigger,
	) (Node, error)

	// ConstructVectorSearch creates a node for a VectorSearch operation.
	//
	...
	ConstructVectorSearch(
		table cat.Table,
		index cat.Index,
		outCols TableColumnOrdinalSet,
		prefixConstraint *constraint.Constraint,
		queryVector tree.TypedExpr,
		targetNeighborCount uint64,
	) (Node, error)

	// ConstructVectorMutationSearch creates a node for a VectorMutationSearch operation.
	//
	...
	// ConstructDeleteSwap creates a node for a DeleteSwap operation.
	//
...
func (StubFactory) ConstructCreateTrigger(
	ct *tree.CreateTrigger,
) (Node, error) {
	return struct{}{}, nil
}

func (StubFactory) ConstructVectorSearch(
	table cat.Table,
	index cat.Index,
	outCols TableColumnOrdinalSet,
	prefixConstraint *constraint.Constraint,
...
func (StubFactory) ConstructVectorMutationSearch(
	input Node,
	table cat.Table,
	index cat.Index,
	prefixKeyCols []NodeColumnOrdinal,
...
func (StubFactory) ConstructUpdateSwap(
	input Node,
	table cat.Table,
	fetchCols TableColumnOrdinalSet,
	updateCols TableColumnOrdinalSet,
...
func (StubFactory) ConstructDeleteSwap(
	input Node,
	table cat.Table,
	fetchCols TableColumnOrdinalSet,
	returnCols TableColumnOrdinalSet,
