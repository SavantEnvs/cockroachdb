...
type MutationPrivate struct {
	...
	VectorIndexDelPartitionCols opt.OptionalColList
	...
	// indexes on the table.
	VectorIndexPutPartitionCols opt.OptionalColList
	...
	// the table.
	VectorIndexPutQuantizedVecCols opt.OptionalColList
...
type InvertedFilterPrivate struct {
	...
	// PKCols is the set of primary key columns in the underlying table of the
	// input inverted index scan. It is used to build FDs and statistics for the
	// InvertedFilter.
	PKCols opt.ColSet
...
// VectorSearchExpr is used to perform an approximate K-nearest-neighbor search for a
...
var _ RelExpr = &VectorSearchExpr{}

func (e *VectorSearchExpr) Op() opt.Operator {
	return opt.VectorSearchOp
}

func (e *VectorSearchExpr) ChildCount() int {
	return 1
}

func (e *VectorSearchExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.QueryVector
	}
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *VectorSearchExpr) Private() interface{} {
	return &e.VectorSearchPrivate
}

func (e *VectorSearchExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.QueryVector = child.(opt.ScalarExpr)
		return
	}
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *VectorSearchExpr) Relational() *props.Relational {
	return e.grp.relational()
}

func (e *VectorSearchExpr) FirstExpr() RelExpr {
	return e.grp.firstExpr()
}

func (e *VectorSearchExpr) NextExpr() RelExpr {
	return e.next
}

func (e *VectorSearchExpr) RequiredPhysical() *physical.Required {
	return e.grp.bestProps().required
}

func (e *VectorSearchExpr) ProvidedPhysical() *physical.Provided {
	return e.grp.bestProps().provided
}

func (e *VectorSearchExpr) Cost() Cost {
	return e.grp.bestProps().cost
}

func (e *VectorSearchExpr) group() exprGroup {
	return e.grp
}

func (e *VectorSearchExpr) bestProps() *bestProps {
	return e.grp.bestProps()
}

func (e *VectorSearchExpr) setNext(member RelExpr) {
	if e.next != nil {
		panic(errors.AssertionFailedf("expression already has its next defined: %s", errors.Safe(e.Op())))
	}
	e.next = member
...
func (e *VectorSearchExpr) setGroup(member RelExpr) {
	if e.grp != nil {
		panic(errors.AssertionFailedf("expression is already in a group: %s", errors.Safe(e.Op())))
	}
	e.grp = member.group()
...
type vectorSearchGroup struct {
	rel   props.Relational
	first VectorSearchExpr
	best  bestProps
}

var _ exprGroup = &vectorSearchGroup{}

func (g *vectorSearchGroup) relational() *props.Relational {
	return &g.rel
}

func (g *vectorSearchGroup) firstExpr() RelExpr {
	return &g.first
}

func (g *vectorSearchGroup) bestProps() *bestProps {
	return &g.best
}

type VectorSearchPrivate struct {
...
// VectorMutationSearchExpr is used to determine the vector-index partition that
...
type VectorMutationSearchExpr struct {
	Input RelExpr
	VectorMutationSearchPrivate

	grp  exprGroup
	next RelExpr
}

var _ RelExpr = &VectorMutationSearchExpr{}

func (e *VectorMutationSearchExpr) Op() opt.Operator {
	return opt.VectorMutationSearchOp
}

func (e *VectorMutationSearchExpr) ChildCount() int {
	return 1
}

func (e *VectorMutationSearchExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Input
	}
...
func (e *VectorMutationSearchExpr) Private() interface{} {
	return &e.VectorMutationSearchPrivate
}

func (e *VectorMutationSearchExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Input = child.(RelExpr)
		return
...
func (e *VectorMutationSearchExpr) Relational() *props.Relational {
	return e.grp.relational()
}

func (e *VectorMutationSearchExpr) FirstExpr() RelExpr {
	return e.grp.firstExpr()
}

func (e *VectorMutationSearchExpr) NextExpr() RelExpr {
	return e.next
}

func (e *VectorMutationSearchExpr) RequiredPhysical() *physical.Required {
	return e.grp.bestProps().required
}

func (e *VectorMutationSearchExpr) ProvidedPhysical() *physical.Provided {
	return e.grp.bestProps().provided
}

func (e *VectorMutationSearchExpr) Cost() Cost {
	return e.grp.bestProps().cost
}

func (e *VectorMutationSearchExpr) group() exprGroup {
	return e.grp
}

func (e *VectorMutationSearchExpr) bestProps() *bestProps {
	return e.grp.bestProps()
}

func (e *VectorMutationSearchExpr) setNext(member RelExpr) {
	if e.next != nil {
		panic(errors.AssertionFailedf("expression already has its next defined: %s", errors.Safe(e.Op())))
	}
	e.next = member
...
func (e *VectorMutationSearchExpr) setGroup(member RelExpr) {
	if e.grp != nil {
		panic(errors.AssertionFailedf("expression is already in a group: %s", errors.Safe(e.Op())))
	}
	e.grp = member.group()
...
type vectorMutationSearchGroup struct {
	rel   props.Relational
	first VectorMutationSearchExpr
	best  bestProps
}

var _ exprGroup = &vectorMutationSearchGroup{}

func (g *vectorMutationSearchGroup) relational() *props.Relational {
	return &g.rel
}

func (g *vectorMutationSearchGroup) firstExpr() RelExpr {
	return &g.first
}

func (g *vectorMutationSearchGroup) bestProps() *bestProps {
	return &g.best
}

type VectorMutationSearchPrivate struct {
	...
	QuantizedVectorCol opt.ColumnID
...
var _ opt.ScalarExpr = &FirstContainsExpr{}

func (e *FirstContainsExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *FirstContainsExpr) Op() opt.Operator {
	return opt.FirstContainsOp
}

func (e *FirstContainsExpr) ChildCount() int {
	return 2
}

func (e *FirstContainsExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Left
	case 1:
...
func (e *FirstContainsExpr) Private() interface{} {
	return nil
}

func (e *FirstContainsExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Left = child.(opt.ScalarExpr)
		return
...
func (e *FirstContainsExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *FirstContainsExpr) DataType() *types.T {
	return e.Typ
}
...
type FirstContainedByExpr struct {
	Left  opt.ScalarExpr
	Right opt.ScalarExpr
...
var _ opt.ScalarExpr = &FirstContainedByExpr{}

func (e *FirstContainedByExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *FirstContainedByExpr) Op() opt.Operator {
	return opt.FirstContainedByOp
}

func (e *FirstContainedByExpr) ChildCount() int {
	return 2
}

func (e *FirstContainedByExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Left
	case 1:
...
func (e *FirstContainedByExpr) Private() interface{} {
	return nil
}

func (e *FirstContainedByExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Left = child.(opt.ScalarExpr)
		return
...
func (e *FirstContainedByExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *FirstContainedByExpr) DataType() *types.T {
	return e.Typ
}
...
// VectorDistanceExpr is the <-> operator when used with vector operands.
// It maps to tree.Distance.
type VectorDistanceExpr struct {
	Left  opt.ScalarExpr
	Right opt.ScalarExpr
...
var _ opt.ScalarExpr = &VectorDistanceExpr{}

func (e *VectorDistanceExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *VectorDistanceExpr) Op() opt.Operator {
	return opt.VectorDistanceOp
}

func (e *VectorDistanceExpr) ChildCount() int {
	return 2
}

func (e *VectorDistanceExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Left
	case 1:
...
func (e *VectorDistanceExpr) Private() interface{} {
	return nil
}

func (e *VectorDistanceExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Left = child.(opt.ScalarExpr)
		return
...
func (e *VectorDistanceExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *VectorDistanceExpr) DataType() *types.T {
	return e.Typ
}

// VectorCosDistanceExpr is the <=> operator when used with vector operands.
// It maps to tree.CosDistance.
type VectorCosDistanceExpr struct {
	Left  opt.ScalarExpr
	Right opt.ScalarExpr
...
var _ opt.ScalarExpr = &VectorCosDistanceExpr{}

func (e *VectorCosDistanceExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *VectorCosDistanceExpr) Op() opt.Operator {
	return opt.VectorCosDistanceOp
}

func (e *VectorCosDistanceExpr) ChildCount() int {
	return 2
}

func (e *VectorCosDistanceExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Left
	case 1:
...
func (e *VectorCosDistanceExpr) Private() interface{} {
	return nil
}

func (e *VectorCosDistanceExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Left = child.(opt.ScalarExpr)
		return
...
func (e *VectorCosDistanceExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *VectorCosDistanceExpr) DataType() *types.T {
	return e.Typ
}

// VectorNegInnerProductExpr is the <#> operator when used with vector operands.
// It maps to tree.NegInnerProduct.
type VectorNegInnerProductExpr struct {
	Left  opt.ScalarExpr
	Right opt.ScalarExpr
...
var _ opt.ScalarExpr = &VectorNegInnerProductExpr{}

func (e *VectorNegInnerProductExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *VectorNegInnerProductExpr) Op() opt.Operator {
	return opt.VectorNegInnerProductOp
}

func (e *VectorNegInnerProductExpr) ChildCount() int {
	return 2
}

func (e *VectorNegInnerProductExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Left
	case 1:
...
func (e *VectorNegInnerProductExpr) Private() interface{} {
	return nil
}

func (e *VectorNegInnerProductExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Left = child.(opt.ScalarExpr)
		return
...
func (e *VectorNegInnerProductExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *VectorNegInnerProductExpr) DataType() *types.T {
	return e.Typ
}
...
type STAsMVTExpr struct {
	Input opt.ScalarExpr

	// LayerName is the optional constant expression which specifies the layer name.
	// Note that it must always be a constant expression.
	LayerName opt.ScalarExpr

	// Extent is the optional constant expression which specifies the tile extent.
	// Note that it must always be a constant expression.
	Extent opt.ScalarExpr

	// GeomColumn is the optional constant expression which specifies the geometry column name.
	// Note that it must always be a constant expression.
	GeomColumn opt.ScalarExpr

	// FeatureIDColumn is the optional constant expression which specifies the feature ID column name.
	// Note that it must always be a constant expression.
	FeatureIDColumn opt.ScalarExpr

	Typ  *types.T
	rank opt.ScalarRank
}

var _ opt.ScalarExpr = &STAsMVTExpr{}

func (e *STAsMVTExpr) Rank() opt.ScalarRank {
	return e.rank
}

func (e *STAsMVTExpr) Op() opt.Operator {
	return opt.STAsMVTOp
}

func (e *STAsMVTExpr) ChildCount() int {
	return 5
}

func (e *STAsMVTExpr) Child(nth int) opt.Expr {
	switch nth {
	case 0:
		return e.Input
	case 1:
	...
	case 3:
		return e.GeomColumn
	case 4:
		return e.FeatureIDColumn
	}
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *STAsMVTExpr) Private() interface{} {
	return nil
}

func (e *STAsMVTExpr) SetChild(nth int, child opt.Expr) {
	switch nth {
	case 0:
		e.Input = child.(opt.ScalarExpr)
		return
	case 1:
		e.LayerName = child.(opt.ScalarExpr)
		return
	case 2:
		e.Extent = child.(opt.ScalarExpr)
		return
	case 3:
		e.GeomColumn = child.(opt.ScalarExpr)
		return
	case 4:
		e.FeatureIDColumn = child.(opt.ScalarExpr)
		return
	}
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *STAsMVTExpr) String() string {
	f := makeExprFmtCtxForString(ExprFmtHideQualifications, nil, nil)
	f.FormatExpr(e)
	return f.Buffer.String()
}

func (e *STAsMVTExpr) DataType() *types.T {
	return e.Typ
}
...
// CreateTriggerExpr represents a CREATE TRIGGER statement.
type CreateTriggerExpr struct {
	CreateTriggerPrivate

	grp  exprGroup
	next RelExpr
}

var _ RelExpr = &CreateTriggerExpr{}

func (e *CreateTriggerExpr) Op() opt.Operator {
	return opt.CreateTriggerOp
}

func (e *CreateTriggerExpr) ChildCount() int {
	return 0
}

func (e *CreateTriggerExpr) Child(nth int) opt.Expr {
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *CreateTriggerExpr) Private() interface{} {
	return &e.CreateTriggerPrivate
}

func (e *CreateTriggerExpr) SetChild(nth int, child opt.Expr) {
	panic(errors.AssertionFailedf("child index out of range"))
}

func (e *CreateTriggerExpr) Relational() *props.Relational {
	return e.grp.relational()
}

func (e *CreateTriggerExpr) FirstExpr() RelExpr {
	return e.grp.firstExpr()
}

func (e *CreateTriggerExpr) NextExpr() RelExpr {
	return e.next
}

func (e *CreateTriggerExpr) RequiredPhysical() *physical.Required {
	return e.grp.bestProps().required
}

func (e *CreateTriggerExpr) ProvidedPhysical() *physical.Provided {
	return e.grp.bestProps().provided
}

func (e *CreateTriggerExpr) Cost() Cost {
	return e.grp.bestProps().cost
}

func (e *CreateTriggerExpr) group() exprGroup {
	return e.grp
}

func (e *CreateTriggerExpr) bestProps() *bestProps {
	return e.grp.bestProps()
}

func (e *CreateTriggerExpr) setNext(member RelExpr) {
	if e.next != nil {
		panic(errors.AssertionFailedf("expression already has its next defined: %s", errors.Safe(e.Op())))
	}
	e.next = member
...
func (e *CreateTriggerExpr) setGroup(member RelExpr) {
	if e.grp != nil {
		panic(errors.AssertionFailedf("expression is already in a group: %s", errors.Safe(e.Op())))
	}
	e.grp = member.group()
...
type createTriggerGroup struct {
	rel   props.Relational
	first CreateTriggerExpr
	best  bestProps
}

var _ exprGroup = &createTriggerGroup{}

func (g *createTriggerGroup) relational() *props.Relational {
	return &g.rel
}

func (g *createTriggerGroup) firstExpr() RelExpr {
	return &g.first
}

func (g *createTriggerGroup) bestProps() *bestProps {
	return &g.best
}

type CreateTriggerPrivate struct {
	// Syntax is the CREATE TRIGGER AST node.
	Syntax *tree.CreateTrigger
...
type CreateStatisticsPrivate struct {
	...
	// Table identifies the table on which statistics are being created.
	Table opt.TableID

	// Index identifies the index to scan if this is a constrained statistic
	// (with a WHERE clause). It can be passed to the cat.Table.Index() method in
	// order to fetch the cat.Index metadata.
	Index cat.IndexOrdinal

	// Constraint, if set, contains a set of spans that will be used to restrict
	// which rows are scanned for constrained statistics. It is nil if the stat
	// collection has no WHERE clause.
	Constraint *constraint.Constraint
}
...
func (m *Memo) MemoizeNormCycleTestRel(
	...
	grp := &normCycleTestRelGroup{first: NormCycleTestRelExpr{
		Scalar: scalar,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeMemoCycleTestRel(
	...
	grp := &memoCycleTestRelGroup{first: MemoCycleTestRelExpr{
		Input:   input,
		Filters: filters,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeInsert(
	...
	grp := &insertGroup{first: InsertExpr{
		Input:                input,
...
func (m *Memo) MemoizeUpdate(
	...
	grp := &updateGroup{first: UpdateExpr{
		Input:           input,
		UniqueChecks:    uniqueChecks,
		FKChecks:        fKChecks,
		MutationPrivate: *mutationPrivate,
...
func (m *Memo) MemoizeUpsert(
	...
	grp := &upsertGroup{first: UpsertExpr{
		Input:           input,
		UniqueChecks:    uniqueChecks,
		FKChecks:        fKChecks,
		MutationPrivate: *mutationPrivate,
...
func (m *Memo) MemoizeDelete(
	...
	grp := &deleteGroup{first: DeleteExpr{
		Input:           input,
		UniqueChecks:    uniqueChecks,
		FKChecks:        fKChecks,
		MutationPrivate: *mutationPrivate,
...
func (m *Memo) MemoizePlaceholderScan(
	...
	grp := &placeholderScanGroup{first: PlaceholderScanExpr{
		Span:        span,
		ScanPrivate: *scanPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeSequenceSelect(
	...
	grp := &sequenceSelectGroup{first: SequenceSelectExpr{
		SequenceSelectPrivate: *sequenceSelectPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeValues(
	...
	grp := &valuesGroup{first: ValuesExpr{
		Rows:          rows,
		ValuesPrivate: *valuesPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeLiteralValues(
	...
	grp := &literalValuesGroup{first: LiteralValuesExpr{
		Rows: rows,
		Cols: cols,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeSelect(
	...
	grp := &selectGroup{first: SelectExpr{
		Input:   input,
		Filters: filters,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeInvertedFilter(
	...
	grp := &invertedFilterGroup{first: InvertedFilterExpr{
		Input:                 input,
		InvertedFilterPrivate: *invertedFilterPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeInnerJoin(
	...
	grp := &innerJoinGroup{first: InnerJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeLeftJoin(
	...
	grp := &leftJoinGroup{first: LeftJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeRightJoin(
	...
	grp := &rightJoinGroup{first: RightJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeFullJoin(
	...
	grp := &fullJoinGroup{first: FullJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeSemiJoin(
	...
	grp := &semiJoinGroup{first: SemiJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeAntiJoin(
	...
	grp := &antiJoinGroup{first: AntiJoinExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeIndexJoin(
	...
	grp := &indexJoinGroup{first: IndexJoinExpr{
		Input:            input,
		IndexJoinPrivate: *indexJoinPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeLookupJoin(
	...
	grp := &lookupJoinGroup{first: LookupJoinExpr{
		Input:             input,
		On:                on,
		LookupJoinPrivate: *lookupJoinPrivate,
	}}
...
func (m *Memo) MemoizeInvertedJoin(
	...
	grp := &invertedJoinGroup{first: InvertedJoinExpr{
		Input:               input,
		On:                  on,
		InvertedJoinPrivate: *invertedJoinPrivate,
	}}
...
func (m *Memo) MemoizeMergeJoin(
	...
	grp := &mergeJoinGroup{first: MergeJoinExpr{
		Left:             left,
		Right:            right,
		On:               on,
		MergeJoinPrivate: *mergeJoinPrivate,
...
func (m *Memo) MemoizeZigzagJoin(
	...
	grp := &zigzagJoinGroup{first: ZigzagJoinExpr{
		On:                on,
		ZigzagJoinPrivate: *zigzagJoinPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeInnerJoinApply(
	...
	grp := &innerJoinApplyGroup{first: InnerJoinApplyExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeLeftJoinApply(
	...
	grp := &leftJoinApplyGroup{first: LeftJoinApplyExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeSemiJoinApply(
	...
	grp := &semiJoinApplyGroup{first: SemiJoinApplyExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeAntiJoinApply(
	...
	grp := &antiJoinApplyGroup{first: AntiJoinApplyExpr{
		Left:        left,
		Right:       right,
		On:          on,
		JoinPrivate: *joinPrivate,
...
func (m *Memo) MemoizeGroupBy(
	...
	grp := &groupByGroup{first: GroupByExpr{
		Input:           input,
...
func (m *Memo) MemoizeScalarGroupBy(
	...
	grp := &scalarGroupByGroup{first: ScalarGroupByExpr{
		Input:           input,
		Aggregations:    aggregations,
		GroupingPrivate: *groupingPrivate,
	}}
...
func (m *Memo) MemoizeDistinctOn(
	...
	grp := &distinctOnGroup{first: DistinctOnExpr{
		Input:           input,
		Aggregations:    aggregations,
		GroupingPrivate: *groupingPrivate,
	}}
...
func (m *Memo) MemoizeEnsureDistinctOn(
	...
	grp := &ensureDistinctOnGroup{first: EnsureDistinctOnExpr{
		Input:           input,
		Aggregations:    aggregations,
		GroupingPrivate: *groupingPrivate,
	}}
...
func (m *Memo) MemoizeUpsertDistinctOn(
	...
	grp := &upsertDistinctOnGroup{first: UpsertDistinctOnExpr{
		Input:           input,
		Aggregations:    aggregations,
		GroupingPrivate: *groupingPrivate,
	}}
...
func (m *Memo) MemoizeEnsureUpsertDistinctOn(
	...
	grp := &ensureUpsertDistinctOnGroup{first: EnsureUpsertDistinctOnExpr{
		Input:           input,
		Aggregations:    aggregations,
		GroupingPrivate: *groupingPrivate,
	}}
...
func (m *Memo) MemoizeUnion(
	...
	grp := &unionGroup{first: UnionExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeIntersect(
	...
	grp := &intersectGroup{first: IntersectExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeExcept(
	...
	grp := &exceptGroup{first: ExceptExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeUnionAll(
	...
	grp := &unionAllGroup{first: UnionAllExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeIntersectAll(
	...
	grp := &intersectAllGroup{first: IntersectAllExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeExceptAll(
	...
	grp := &exceptAllGroup{first: ExceptAllExpr{
		Left:       left,
		Right:      right,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeLocalityOptimizedSearch(
	...
	grp := &localityOptimizedSearchGroup{first: LocalityOptimizedSearchExpr{
		Local:      local,
		Remote:     remote,
		SetPrivate: *setPrivate,
	}}
...
func (m *Memo) MemoizeLimit(
	...
	grp := &limitGroup{first: LimitExpr{
		Input:    input,
		Limit:    limit,
		Ordering: ordering,
	}}
...
func (m *Memo) MemoizeOffset(
	...
	grp := &offsetGroup{first: OffsetExpr{
		Input:    input,
		Offset:   offset,
		Ordering: ordering,
	}}
...
func (m *Memo) MemoizeMax1Row(
	...
	grp := &max1RowGroup{first: Max1RowExpr{
		Input:     input,
		ErrorText: errorText,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeOrdinality(
	...
	grp := &ordinalityGroup{first: OrdinalityExpr{
		Input:             input,
		OrdinalityPrivate: *ordinalityPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeProjectSet(
	...
	grp := &projectSetGroup{first: ProjectSetExpr{
		Input: input,
		Zip:   zip,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeWindow(
	...
	grp := &windowGroup{first: WindowExpr{
		Input:         input,
		Windows:       windows,
		WindowPrivate: *windowPrivate,
	}}
...
func (m *Memo) MemoizeWithScan(
	...
	grp := &withScanGroup{first: WithScanExpr{
		WithScanPrivate: *withScanPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeRecursiveCTE(
	...
	grp := &recursiveCTEGroup{first: RecursiveCTEExpr{
		Binding:             binding,
		Initial:             initial,
		Recursive:           recursive,
		RecursiveCTEPrivate: *recursiveCTEPrivate,
...
func (m *Memo) MemoizeVectorSearch(
	queryVector opt.ScalarExpr,
	vectorSearchPrivate *VectorSearchPrivate,
) RelExpr {
	const size = int64(unsafe.Sizeof(vectorSearchGroup{}))
	grp := &vectorSearchGroup{first: VectorSearchExpr{
		QueryVector:         queryVector,
		VectorSearchPrivate: *vectorSearchPrivate,
	}}
	e := &grp.first
	e.grp = grp
	interned := m.interner.InternVectorSearch(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
		m.logPropsBuilder.buildVectorSearchProps(e, &grp.rel)
		grp.rel.Populated = true
		m.memEstimate += size
		m.CheckExpr(e)
	}
...
func (m *Memo) MemoizeVectorMutationSearch(
	input RelExpr,
	vectorMutationSearchPrivate *VectorMutationSearchPrivate,
) RelExpr {
	const size = int64(unsafe.Sizeof(vectorMutationSearchGroup{}))
	grp := &vectorMutationSearchGroup{first: VectorMutationSearchExpr{
		Input:                       input,
		VectorMutationSearchPrivate: *vectorMutationSearchPrivate,
	}}
	e := &grp.first
	e.grp = grp
	interned := m.interner.InternVectorMutationSearch(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
		m.logPropsBuilder.buildVectorMutationSearchProps(e, &grp.rel)
		grp.rel.Populated = true
		m.memEstimate += size
		m.CheckExpr(e)
	}
...
func (m *Memo) MemoizeBarrier(
	...
	grp := &barrierGroup{first: BarrierExpr{
		Input:              input,
		LeakproofPermeable: leakproofPermeable,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeFakeRel(
	...
	grp := &fakeRelGroup{first: FakeRelExpr{
		FakeRelPrivate: *fakeRelPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeFirstContains(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) *FirstContainsExpr {
	const size = int64(unsafe.Sizeof(FirstContainsExpr{}))
	e := &FirstContainsExpr{
		Left:  left,
		Right: right,
		rank:  m.NextRank(),
	...
	e.Typ = InferType(m, e)
	interned := m.interner.InternFirstContains(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeFirstContainedBy(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) *FirstContainedByExpr {
	const size = int64(unsafe.Sizeof(FirstContainedByExpr{}))
	e := &FirstContainedByExpr{
		Left:  left,
		Right: right,
		rank:  m.NextRank(),
	}
	e.Typ = InferType(m, e)
	interned := m.interner.InternFirstContainedBy(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeVectorDistance(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) *VectorDistanceExpr {
	const size = int64(unsafe.Sizeof(VectorDistanceExpr{}))
	e := &VectorDistanceExpr{
		Left:  left,
		Right: right,
		rank:  m.NextRank(),
	}
	e.Typ = InferType(m, e)
	interned := m.interner.InternVectorDistance(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeVectorCosDistance(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) *VectorCosDistanceExpr {
	const size = int64(unsafe.Sizeof(VectorCosDistanceExpr{}))
	e := &VectorCosDistanceExpr{
		Left:  left,
		Right: right,
		rank:  m.NextRank(),
	}
	e.Typ = InferType(m, e)
	interned := m.interner.InternVectorCosDistance(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeVectorNegInnerProduct(
	left opt.ScalarExpr,
	right opt.ScalarExpr,
) *VectorNegInnerProductExpr {
	const size = int64(unsafe.Sizeof(VectorNegInnerProductExpr{}))
	e := &VectorNegInnerProductExpr{
		Left:  left,
		Right: right,
		rank:  m.NextRank(),
	}
	e.Typ = InferType(m, e)
	interned := m.interner.InternVectorNegInnerProduct(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeSTAsMVT(
	...
	const size = int64(unsafe.Sizeof(STAsMVTExpr{}))
	e := &STAsMVTExpr{
		Input:           input,
		LayerName:       layerName,
		Extent:          extent,
	...
	e.Typ = InferType(m, e)
	interned := m.interner.InternSTAsMVT(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
...
func (m *Memo) MemoizeCreateTable(
	...
	grp := &createTableGroup{first: CreateTableExpr{
		Input:              input,
		CreateTablePrivate: *createTablePrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeCreateView(
	...
	grp := &createViewGroup{first: CreateViewExpr{
		CreateViewPrivate: *createViewPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeCreateFunction(
	...
	grp := &createFunctionGroup{first: CreateFunctionExpr{
		CreateFunctionPrivate: *createFunctionPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeCreateTrigger(
	createTriggerPrivate *CreateTriggerPrivate,
) RelExpr {
	const size = int64(unsafe.Sizeof(createTriggerGroup{}))
	grp := &createTriggerGroup{first: CreateTriggerExpr{
		CreateTriggerPrivate: *createTriggerPrivate,
	}}
	e := &grp.first
	e.grp = grp
	interned := m.interner.InternCreateTrigger(e)
	if interned == e {
		if m.newGroupFn != nil {
			m.newGroupFn(e)
		}
		m.logPropsBuilder.buildCreateTriggerProps(e, &grp.rel)
		grp.rel.Populated = true
		m.memEstimate += size
		m.CheckExpr(e)
	}
...
func (m *Memo) MemoizeExplain(
	...
	grp := &explainGroup{first: ExplainExpr{
		Input:          input,
		ExplainPrivate: *explainPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeShowTraceForSession(
	...
	grp := &showTraceForSessionGroup{first: ShowTraceForSessionExpr{
		ShowTracePrivate: *showTracePrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeOpaqueRel(
	...
	grp := &opaqueRelGroup{first: OpaqueRelExpr{
		OpaqueRelPrivate: *opaqueRelPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeOpaqueMutation(
	...
	grp := &opaqueMutationGroup{first: OpaqueMutationExpr{
		OpaqueRelPrivate: *opaqueRelPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeOpaqueDDL(
	...
	grp := &opaqueDDLGroup{first: OpaqueDDLExpr{
		OpaqueRelPrivate: *opaqueRelPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeAlterTableSplit(
	...
	grp := &alterTableSplitGroup{first: AlterTableSplitExpr{
		Input:                  input,
...
func (m *Memo) MemoizeAlterTableUnsplit(
	...
	grp := &alterTableUnsplitGroup{first: AlterTableUnsplitExpr{
		Input:                  input,
		AlterTableSplitPrivate: *alterTableSplitPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeAlterTableUnsplitAll(
	...
	grp := &alterTableUnsplitAllGroup{first: AlterTableUnsplitAllExpr{
		AlterTableSplitPrivate: *alterTableSplitPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeAlterTableRelocate(
	...
	grp := &alterTableRelocateGroup{first: AlterTableRelocateExpr{
		Input:                     input,
		AlterTableRelocatePrivate: *alterTableRelocatePrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeControlJobs(
	...
	grp := &controlJobsGroup{first: ControlJobsExpr{
		Input:              input,
		Reason:             reason,
		ControlJobsPrivate: *controlJobsPrivate,
	}}
...
func (m *Memo) MemoizeControlSchedules(
	...
	grp := &controlSchedulesGroup{first: ControlSchedulesExpr{
		Input:                   input,
		ControlSchedulesPrivate: *controlSchedulesPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeCancelQueries(
	...
	grp := &cancelQueriesGroup{first: CancelQueriesExpr{
		Input:         input,
		CancelPrivate: *cancelPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeCancelSessions(
	...
	grp := &cancelSessionsGroup{first: CancelSessionsExpr{
		Input:         input,
		CancelPrivate: *cancelPrivate,
	}}
	e := &grp.first
...
func (m *Memo) MemoizeExport(
	...
	grp := &exportGroup{first: ExportExpr{
		Input:         input,
		FileName:      fileName,
		Options:       options,
		ExportPrivate: *exportPrivate,
...
func (m *Memo) MemoizeShowCompletions(
	...
	grp := &showCompletionsGroup{first: ShowCompletionsExpr{
		ShowCompletionsPrivate: *showCompletionsPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeCreateStatistics(
	...
	grp := &createStatisticsGroup{first: CreateStatisticsExpr{
		CreateStatisticsPrivate: *createStatisticsPrivate,
	}}
	e := &grp.first
	e.grp = grp
...
func (m *Memo) MemoizeAlterRangeRelocate(
	...
	grp := &alterRangeRelocateGroup{first: AlterRangeRelocateExpr{
		Input:                     input,
		ToStoreID:                 toStoreID,
...
func (m *Memo) AddVectorSearchToGroup(e *VectorSearchExpr, grp RelExpr) *VectorSearchExpr {
	const size = int64(unsafe.Sizeof(VectorSearchExpr{}))
	interned := m.interner.InternVectorSearch(e)
	if interned == e {
		e.setGroup(grp)
		m.memEstimate += size
...
func (m *Memo) AddVectorMutationSearchToGroup(e *VectorMutationSearchExpr, grp RelExpr) *VectorMutationSearchExpr {
	const size = int64(unsafe.Sizeof(VectorMutationSearchExpr{}))
	interned := m.interner.InternVectorMutationSearch(e)
	if interned == e {
		e.setGroup(grp)
		m.memEstimate += size
...
func (m *Memo) AddCreateTriggerToGroup(e *CreateTriggerExpr, grp RelExpr) *CreateTriggerExpr {
	const size = int64(unsafe.Sizeof(CreateTriggerExpr{}))
	interned := m.interner.InternCreateTrigger(e)
	if interned == e {
		e.setGroup(grp)
		m.memEstimate += size
...
func (in *interner) InternExpr(e opt.Expr) opt.Expr {
	...
	case *VectorMutationSearchExpr:
		return in.InternVectorMutationSearch(t)
	case *BarrierExpr:
	...
	case *FirstContainsExpr:
		return in.InternFirstContains(t)
	case *ContainedByExpr:
		return in.InternContainedBy(t)
	case *FirstContainedByExpr:
		return in.InternFirstContainedBy(t)
	case *JsonExistsExpr:
...
func (in *interner) InternInsert(val *InsertExpr) *InsertExpr {
	...
	in.hasher.HashOptionalColList(val.VectorIndexDelPartitionCols)
	in.hasher.HashOptionalColList(val.VectorIndexPutPartitionCols)
	in.hasher.HashOptionalColList(val.VectorIndexPutQuantizedVecCols)
	...
	in.hasher.HashColSet(val.TriggerCols)
	in.hasher.HashWithID(val.WithID)
	in.hasher.HashFKCascades(val.FKCascades)
	in.hasher.HashIndexOrdinals(val.UniqueWithTombstoneIndexes)
	in.hasher.HashAfterTriggers(val.AfterTriggers)
	in.hasher.HashBool(val.VectorInsert)
	in.hasher.HashBool(val.Swap)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*InsertExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				...
				in.hasher.IsOptionalColListEqual(val.VectorIndexDelPartitionCols, existing.VectorIndexDelPartitionCols) &&
				in.hasher.IsOptionalColListEqual(val.VectorIndexPutPartitionCols, existing.VectorIndexPutPartitionCols) &&
				in.hasher.IsOptionalColListEqual(val.VectorIndexPutQuantizedVecCols, existing.VectorIndexPutQuantizedVecCols) &&
				...
				in.hasher.IsColSetEqual(val.TriggerCols, existing.TriggerCols) &&
				in.hasher.IsWithIDEqual(val.WithID, existing.WithID) &&
				in.hasher.IsFKCascadesEqual(val.FKCascades, existing.FKCascades) &&
				in.hasher.IsIndexOrdinalsEqual(val.UniqueWithTombstoneIndexes, existing.UniqueWithTombstoneIndexes) &&
				in.hasher.IsAfterTriggersEqual(val.AfterTriggers, existing.AfterTriggers) &&
				in.hasher.IsBoolEqual(val.VectorInsert, existing.VectorInsert) &&
				in.hasher.IsBoolEqual(val.Swap, existing.Swap) {
				return existing
			}
		}
	}
...
func (in *interner) InternInvertedFilter(val *InvertedFilterExpr) *InvertedFilterExpr {
	...
	in.hasher.HashColSet(val.PKCols)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*InvertedFilterExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				...
				in.hasher.IsColSetEqual(val.PKCols, existing.PKCols) &&
...
func (in *interner) InternInnerJoin(val *InnerJoinExpr) *InnerJoinExpr {
	...
	in.hasher.HashColSet(val.ParameterizedCols)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*InnerJoinExpr); ok {
			if in.hasher.IsRelExprEqual(val.Left, existing.Left) &&
				...
				in.hasher.IsColSetEqual(val.ParameterizedCols, existing.ParameterizedCols) {
				return existing
			}
		}
	}
...
func (in *interner) InternLookupJoin(val *LookupJoinExpr) *LookupJoinExpr {
	...
	in.hasher.HashColSet(val.EqualityLookupCols)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*LookupJoinExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				...
				in.hasher.IsColSetEqual(val.EqualityLookupCols, existing.EqualityLookupCols) &&
...
func (in *interner) InternWithScan(val *WithScanExpr) *WithScanExpr {
	...
	in.hasher.HashUniqueID(val.ID)
	in.hasher.HashCTEMaterializeClause(val.Mtr)
	in.hasher.HashBool(val.CheckInput)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*WithScanExpr); ok {
			if in.hasher.IsWithIDEqual(val.With, existing.With) &&
				...
				in.hasher.IsUniqueIDEqual(val.ID, existing.ID) &&
				in.hasher.IsCTEMaterializeClauseEqual(val.Mtr, existing.Mtr) &&
				in.hasher.IsBoolEqual(val.CheckInput, existing.CheckInput) {
				return existing
			}
		}
	}
...
func (in *interner) InternVectorSearch(val *VectorSearchExpr) *VectorSearchExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.VectorSearchOp)
	in.hasher.HashScalarExpr(val.QueryVector)
	in.hasher.HashTableID(val.Table)
	in.hasher.HashIndexOrdinal(val.Index)
	in.hasher.HashPointer(unsafe.Pointer(val.PrefixConstraint))
	in.hasher.HashColSet(val.Cols)
	in.hasher.HashInt64(val.TargetNeighborCount)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*VectorSearchExpr); ok {
			if in.hasher.IsScalarExprEqual(val.QueryVector, existing.QueryVector) &&
				in.hasher.IsTableIDEqual(val.Table, existing.Table) &&
				in.hasher.IsIndexOrdinalEqual(val.Index, existing.Index) &&
				in.hasher.IsPointerEqual(unsafe.Pointer(val.PrefixConstraint), unsafe.Pointer(existing.PrefixConstraint)) &&
				in.hasher.IsColSetEqual(val.Cols, existing.Cols) &&
				in.hasher.IsInt64Equal(val.TargetNeighborCount, existing.TargetNeighborCount) {
				return existing
			}
		}
	}
...
func (in *interner) InternVectorMutationSearch(val *VectorMutationSearchExpr) *VectorMutationSearchExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.VectorMutationSearchOp)
	in.hasher.HashRelExpr(val.Input)
	in.hasher.HashTableID(val.Table)
	in.hasher.HashIndexOrdinal(val.Index)
	in.hasher.HashColList(val.PrefixKeyCols)
	in.hasher.HashColumnID(val.QueryVectorCol)
	in.hasher.HashColList(val.SuffixKeyCols)
	in.hasher.HashColumnID(val.PartitionCol)
	in.hasher.HashColumnID(val.QuantizedVectorCol)
	in.hasher.HashBool(val.IsIndexPut)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*VectorMutationSearchExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				in.hasher.IsTableIDEqual(val.Table, existing.Table) &&
				in.hasher.IsIndexOrdinalEqual(val.Index, existing.Index) &&
				in.hasher.IsColListEqual(val.PrefixKeyCols, existing.PrefixKeyCols) &&
				in.hasher.IsColumnIDEqual(val.QueryVectorCol, existing.QueryVectorCol) &&
				in.hasher.IsColListEqual(val.SuffixKeyCols, existing.SuffixKeyCols) &&
				in.hasher.IsColumnIDEqual(val.PartitionCol, existing.PartitionCol) &&
				in.hasher.IsColumnIDEqual(val.QuantizedVectorCol, existing.QuantizedVectorCol) &&
				in.hasher.IsBoolEqual(val.IsIndexPut, existing.IsIndexPut) {
				return existing
			}
		}
	}
...
func (in *interner) InternBarrier(val *BarrierExpr) *BarrierExpr {
	...
	in.hasher.HashRelExpr(val.Input)
	in.hasher.HashBool(val.LeakproofPermeable)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*BarrierExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				in.hasher.IsBoolEqual(val.LeakproofPermeable, existing.LeakproofPermeable) {
				return existing
			}
		}
	}
...
func (in *interner) InternFirstContains(val *FirstContainsExpr) *FirstContainsExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.FirstContainsOp)
	in.hasher.HashScalarExpr(val.Left)
	in.hasher.HashScalarExpr(val.Right)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*FirstContainsExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Left, existing.Left) &&
				in.hasher.IsScalarExprEqual(val.Right, existing.Right) {
				return existing
			}
...
func (in *interner) InternFirstContainedBy(val *FirstContainedByExpr) *FirstContainedByExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.FirstContainedByOp)
	in.hasher.HashScalarExpr(val.Left)
	in.hasher.HashScalarExpr(val.Right)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*FirstContainedByExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Left, existing.Left) &&
				in.hasher.IsScalarExprEqual(val.Right, existing.Right) {
				return existing
			}
...
func (in *interner) InternVectorDistance(val *VectorDistanceExpr) *VectorDistanceExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.VectorDistanceOp)
	in.hasher.HashScalarExpr(val.Left)
	in.hasher.HashScalarExpr(val.Right)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*VectorDistanceExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Left, existing.Left) &&
				in.hasher.IsScalarExprEqual(val.Right, existing.Right) {
				return existing
			}
...
func (in *interner) InternVectorCosDistance(val *VectorCosDistanceExpr) *VectorCosDistanceExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.VectorCosDistanceOp)
	in.hasher.HashScalarExpr(val.Left)
	in.hasher.HashScalarExpr(val.Right)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*VectorCosDistanceExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Left, existing.Left) &&
				in.hasher.IsScalarExprEqual(val.Right, existing.Right) {
				return existing
			}
...
func (in *interner) InternVectorNegInnerProduct(val *VectorNegInnerProductExpr) *VectorNegInnerProductExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.VectorNegInnerProductOp)
	in.hasher.HashScalarExpr(val.Left)
	in.hasher.HashScalarExpr(val.Right)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*VectorNegInnerProductExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Left, existing.Left) &&
				in.hasher.IsScalarExprEqual(val.Right, existing.Right) {
				return existing
			}
...
func (in *interner) InternSTAsMVT(val *STAsMVTExpr) *STAsMVTExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.STAsMVTOp)
	in.hasher.HashScalarExpr(val.Input)
	in.hasher.HashScalarExpr(val.LayerName)
	in.hasher.HashScalarExpr(val.Extent)
	in.hasher.HashScalarExpr(val.GeomColumn)
	in.hasher.HashScalarExpr(val.FeatureIDColumn)

	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*STAsMVTExpr); ok {
			if in.hasher.IsScalarExprEqual(val.Input, existing.Input) &&
				in.hasher.IsScalarExprEqual(val.LayerName, existing.LayerName) &&
				in.hasher.IsScalarExprEqual(val.Extent, existing.Extent) &&
				in.hasher.IsScalarExprEqual(val.GeomColumn, existing.GeomColumn) &&
				in.hasher.IsScalarExprEqual(val.FeatureIDColumn, existing.FeatureIDColumn) {
				return existing
			}
		}
	}
...
func (in *interner) InternCreateTrigger(val *CreateTriggerExpr) *CreateTriggerExpr {
	in.hasher.Init()
	in.hasher.HashOperator(opt.CreateTriggerOp)
	in.hasher.HashPointer(unsafe.Pointer(val.Syntax))
	in.hasher.HashSchemaDeps(val.Deps)
	in.hasher.HashSchemaTypeDeps(val.TypeDeps)
	in.hasher.HashSchemaFunctionDeps(val.FuncDeps)
	...
	in.cache.Start(in.hasher.hash)
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*CreateTriggerExpr); ok {
			if in.hasher.IsPointerEqual(unsafe.Pointer(val.Syntax), unsafe.Pointer(existing.Syntax)) &&
				in.hasher.IsSchemaDepsEqual(val.Deps, existing.Deps) &&
				in.hasher.IsSchemaTypeDepsEqual(val.TypeDeps, existing.TypeDeps) &&
				in.hasher.IsSchemaFunctionDepsEqual(val.FuncDeps, existing.FuncDeps) {
...
func (in *interner) InternExplain(val *ExplainExpr) *ExplainExpr {
	...
	in.hasher.HashString(val.Fingerprint)
	...
	for in.cache.Next() {
		if existing, ok := in.cache.Item().(*ExplainExpr); ok {
			if in.hasher.IsRelExprEqual(val.Input, existing.Input) &&
				...
				in.hasher.IsStringEqual(val.Fingerprint, existing.Fingerprint) {
				return existing
			}
		}
	}
...
func (b *logicalPropsBuilder) buildProps(e RelExpr, rel *props.Relational) {
	...
	case *VectorSearchExpr:
		b.buildVectorSearchProps(t, rel)
	case *VectorMutationSearchExpr:
		b.buildVectorMutationSearchProps(t, rel)
	case *BarrierExpr:
	...
	case *CreateTriggerExpr:
		b.buildCreateTriggerProps(t, rel)
	case *ExplainExpr:
