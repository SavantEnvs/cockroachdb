...
type DRPCInspectzClient interface {
	...
	StoreLivenessSupportFrom(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportFromResponse, error)
	StoreLivenessSupportFor(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportForResponse, error)
}
...
func (c *drpcInspectzClient) StoreLivenessSupportFrom(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportFromResponse, error) {
...
func (c *drpcInspectzClient) StoreLivenessSupportFor(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportForResponse, error) {
...
func (s *DRPCInspectzUnimplementedServer) StoreLivenessSupportFrom(context.Context, *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportFromResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCInspectzUnimplementedServer) StoreLivenessSupportFor(context.Context, *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportForResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
type DRPCInspectz_StoreLivenessSupportFromStream interface {
	drpc.Stream
	SendAndClose(*storelivenesspb.InspectSupportFromResponse) error
}
...
func (x *drpcInspectz_StoreLivenessSupportFromStream) SendAndClose(m *storelivenesspb.InspectSupportFromResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_inspectz_inspectzpb_inspectz_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCInspectz_StoreLivenessSupportForStream interface {
	drpc.Stream
	SendAndClose(*storelivenesspb.InspectSupportForResponse) error
}
...
func (x *drpcInspectz_StoreLivenessSupportForStream) SendAndClose(m *storelivenesspb.InspectSupportForResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_inspectz_inspectzpb_inspectz_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
func (a *grpcInspectzClientAdapter) StoreLivenessSupportFrom(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportFromResponse, error) {
	return (*inspectzClient)(a).StoreLivenessSupportFrom(ctx, in)
}

func (a *grpcInspectzClientAdapter) StoreLivenessSupportFor(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportForResponse, error) {
...
func (a *drpcInspectzClientAdapter) StoreLivenessSupportFrom(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportFromResponse, error) {
	return (*drpcInspectzClient)(a).StoreLivenessSupportFrom(ctx, in)
}

func (a *drpcInspectzClientAdapter) StoreLivenessSupportFor(ctx context.Context, in *storelivenesspb.InspectStoreLivenessRequest) (*storelivenesspb.InspectSupportForResponse, error) {
