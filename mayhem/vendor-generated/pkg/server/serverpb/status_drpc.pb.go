...
type DRPCStatusClient interface {
	...
	MMAState(ctx context.Context, in *MMAStateRequest) (*MMAStateResponse, error)
	...
	ListActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error)
	ListLocalActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error)
	AppNameMappings(ctx context.Context, in *AppNameMappingsRequest) (*AppNameMappingsResponse, error)
	...
	CreateTransactionDiagnosticsReport(ctx context.Context, in *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error)
	CancelTransactionDiagnosticsReport(ctx context.Context, in *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error)
	TransactionDiagnosticsRequests(ctx context.Context, in *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error)
...
func (c *drpcStatusClient) MMAState(ctx context.Context, in *MMAStateRequest) (*MMAStateResponse, error) {
	out := new(MMAStateResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/MMAState", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) ListActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	out := new(ListActiveSessionHistoryResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/ListActiveSessionHistory", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) ListLocalActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	out := new(ListActiveSessionHistoryResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/ListLocalActiveSessionHistory", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) AppNameMappings(ctx context.Context, in *AppNameMappingsRequest) (*AppNameMappingsResponse, error) {
	out := new(AppNameMappingsResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/AppNameMappings", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) CreateTransactionDiagnosticsReport(ctx context.Context, in *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error) {
	out := new(CreateTransactionDiagnosticsReportResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/CreateTransactionDiagnosticsReport", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) CancelTransactionDiagnosticsReport(ctx context.Context, in *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error) {
	out := new(CancelTransactionDiagnosticsReportResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/CancelTransactionDiagnosticsReport", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcStatusClient) TransactionDiagnosticsRequests(ctx context.Context, in *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error) {
	out := new(TransactionDiagnosticsReportsResponse)
	err := c.cc.Invoke(ctx, "/cockroach.server.serverpb.Status/TransactionDiagnosticsRequests", drpcEncoding_File_server_serverpb_status_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCStatusServer interface {
	...
	MMAState(context.Context, *MMAStateRequest) (*MMAStateResponse, error)
	...
	CreateTransactionDiagnosticsReport(context.Context, *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error)
	CancelTransactionDiagnosticsReport(context.Context, *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error)
	TransactionDiagnosticsRequests(context.Context, *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error)
...
func (s *DRPCStatusUnimplementedServer) MMAState(context.Context, *MMAStateRequest) (*MMAStateResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (s *DRPCStatusUnimplementedServer) ListActiveSessionHistory(context.Context, *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCStatusUnimplementedServer) ListLocalActiveSessionHistory(context.Context, *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCStatusUnimplementedServer) AppNameMappings(context.Context, *AppNameMappingsRequest) (*AppNameMappingsResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (s *DRPCStatusUnimplementedServer) CreateTransactionDiagnosticsReport(context.Context, *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCStatusUnimplementedServer) CancelTransactionDiagnosticsReport(context.Context, *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCStatusUnimplementedServer) TransactionDiagnosticsRequests(context.Context, *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCStatusDescription) NumMethods() int { return 72 }
...
func (DRPCStatusDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 16:
		return "/cockroach.server.serverpb.Status/MMAState", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					MMAState(
						ctx,
			...
			}, DRPCStatusServer.MMAState, true
	case 17:
	...
	case 19:
		return "/cockroach.server.serverpb.Status/ListActiveSessionHistory", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					ListActiveSessionHistory(
						ctx,
						in1.(*ListActiveSessionHistoryRequest),
					)
			}, DRPCStatusServer.ListActiveSessionHistory, true
	case 20:
		return "/cockroach.server.serverpb.Status/ListLocalActiveSessionHistory", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
			...
			}, DRPCStatusServer.ListLocalActiveSessionHistory, true
	case 21:
		return "/cockroach.server.serverpb.Status/AppNameMappings", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					AppNameMappings(
						ctx,
						in1.(*AppNameMappingsRequest),
					)
			}, DRPCStatusServer.AppNameMappings, true
	case 22:
	...
	case 52:
		return "/cockroach.server.serverpb.Status/CreateTransactionDiagnosticsReport", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					CreateTransactionDiagnosticsReport(
						ctx,
						in1.(*CreateTransactionDiagnosticsReportRequest),
					)
			}, DRPCStatusServer.CreateTransactionDiagnosticsReport, true
	case 53:
		return "/cockroach.server.serverpb.Status/CancelTransactionDiagnosticsReport", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					CancelTransactionDiagnosticsReport(
						ctx,
						in1.(*CancelTransactionDiagnosticsReportRequest),
					)
			}, DRPCStatusServer.CancelTransactionDiagnosticsReport, true
	case 54:
		return "/cockroach.server.serverpb.Status/TransactionDiagnosticsRequests", drpcEncoding_File_server_serverpb_status_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCStatusServer).
					TransactionDiagnosticsRequests(
						ctx,
						in1.(*TransactionDiagnosticsReportsRequest),
					)
			}, DRPCStatusServer.TransactionDiagnosticsRequests, true
	case 55:
...
type DRPCStatus_MMAStateStream interface {
	drpc.Stream
	SendAndClose(*MMAStateResponse) error
}

type RPCStatus_MMAStateStream interface {
	Context() context.Context
	SendAndClose(*MMAStateResponse) error
}

type drpcStatus_MMAStateStream struct {
	drpc.Stream
}

func (x *drpcStatus_MMAStateStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_MMAStateStream) SendAndClose(m *MMAStateResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_ListActiveSessionHistoryStream interface {
	drpc.Stream
	SendAndClose(*ListActiveSessionHistoryResponse) error
}

type RPCStatus_ListActiveSessionHistoryStream interface {
	Context() context.Context
	SendAndClose(*ListActiveSessionHistoryResponse) error
}

type drpcStatus_ListActiveSessionHistoryStream struct {
	drpc.Stream
}

func (x *drpcStatus_ListActiveSessionHistoryStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_ListActiveSessionHistoryStream) SendAndClose(m *ListActiveSessionHistoryResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_ListLocalActiveSessionHistoryStream interface {
	drpc.Stream
	SendAndClose(*ListActiveSessionHistoryResponse) error
}

type RPCStatus_ListLocalActiveSessionHistoryStream interface {
	Context() context.Context
	SendAndClose(*ListActiveSessionHistoryResponse) error
}

type drpcStatus_ListLocalActiveSessionHistoryStream struct {
	drpc.Stream
}

func (x *drpcStatus_ListLocalActiveSessionHistoryStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_ListLocalActiveSessionHistoryStream) SendAndClose(m *ListActiveSessionHistoryResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_AppNameMappingsStream interface {
	drpc.Stream
	SendAndClose(*AppNameMappingsResponse) error
}

type RPCStatus_AppNameMappingsStream interface {
	Context() context.Context
	SendAndClose(*AppNameMappingsResponse) error
}

type drpcStatus_AppNameMappingsStream struct {
	drpc.Stream
}

func (x *drpcStatus_AppNameMappingsStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_AppNameMappingsStream) SendAndClose(m *AppNameMappingsResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_CreateTransactionDiagnosticsReportStream interface {
	drpc.Stream
	SendAndClose(*CreateTransactionDiagnosticsReportResponse) error
}

type RPCStatus_CreateTransactionDiagnosticsReportStream interface {
	Context() context.Context
	SendAndClose(*CreateTransactionDiagnosticsReportResponse) error
}

type drpcStatus_CreateTransactionDiagnosticsReportStream struct {
	drpc.Stream
}

func (x *drpcStatus_CreateTransactionDiagnosticsReportStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_CreateTransactionDiagnosticsReportStream) SendAndClose(m *CreateTransactionDiagnosticsReportResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_CancelTransactionDiagnosticsReportStream interface {
	drpc.Stream
	SendAndClose(*CancelTransactionDiagnosticsReportResponse) error
}

type RPCStatus_CancelTransactionDiagnosticsReportStream interface {
	Context() context.Context
	SendAndClose(*CancelTransactionDiagnosticsReportResponse) error
}

type drpcStatus_CancelTransactionDiagnosticsReportStream struct {
	drpc.Stream
}

func (x *drpcStatus_CancelTransactionDiagnosticsReportStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_CancelTransactionDiagnosticsReportStream) SendAndClose(m *CancelTransactionDiagnosticsReportResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCStatus_TransactionDiagnosticsRequestsStream interface {
	drpc.Stream
	SendAndClose(*TransactionDiagnosticsReportsResponse) error
}

type RPCStatus_TransactionDiagnosticsRequestsStream interface {
	Context() context.Context
	SendAndClose(*TransactionDiagnosticsReportsResponse) error
}

type drpcStatus_TransactionDiagnosticsRequestsStream struct {
	drpc.Stream
}

func (x *drpcStatus_TransactionDiagnosticsRequestsStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcStatus_TransactionDiagnosticsRequestsStream) SendAndClose(m *TransactionDiagnosticsReportsResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_server_serverpb_status_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
func (a *grpcStatusClientAdapter) MMAState(ctx context.Context, in *MMAStateRequest) (*MMAStateResponse, error) {
	return (*statusClient)(a).MMAState(ctx, in)
}
...
func (a *grpcStatusClientAdapter) ListActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return (*statusClient)(a).ListActiveSessionHistory(ctx, in)
}

func (a *grpcStatusClientAdapter) ListLocalActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return (*statusClient)(a).ListLocalActiveSessionHistory(ctx, in)
}

func (a *grpcStatusClientAdapter) AppNameMappings(ctx context.Context, in *AppNameMappingsRequest) (*AppNameMappingsResponse, error) {
	return (*statusClient)(a).AppNameMappings(ctx, in)
}
...
func (a *grpcStatusClientAdapter) CreateTransactionDiagnosticsReport(ctx context.Context, in *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error) {
	return (*statusClient)(a).CreateTransactionDiagnosticsReport(ctx, in)
}

func (a *grpcStatusClientAdapter) CancelTransactionDiagnosticsReport(ctx context.Context, in *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error) {
	return (*statusClient)(a).CancelTransactionDiagnosticsReport(ctx, in)
}

func (a *grpcStatusClientAdapter) TransactionDiagnosticsRequests(ctx context.Context, in *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error) {
	return (*statusClient)(a).TransactionDiagnosticsRequests(ctx, in)
}
...
func (a *drpcStatusClientAdapter) MMAState(ctx context.Context, in *MMAStateRequest) (*MMAStateResponse, error) {
	return (*drpcStatusClient)(a).MMAState(ctx, in)
}
...
func (a *drpcStatusClientAdapter) ListActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return (*drpcStatusClient)(a).ListActiveSessionHistory(ctx, in)
}

func (a *drpcStatusClientAdapter) ListLocalActiveSessionHistory(ctx context.Context, in *ListActiveSessionHistoryRequest) (*ListActiveSessionHistoryResponse, error) {
	return (*drpcStatusClient)(a).ListLocalActiveSessionHistory(ctx, in)
}

func (a *drpcStatusClientAdapter) AppNameMappings(ctx context.Context, in *AppNameMappingsRequest) (*AppNameMappingsResponse, error) {
	return (*drpcStatusClient)(a).AppNameMappings(ctx, in)
}
...
func (a *drpcStatusClientAdapter) CreateTransactionDiagnosticsReport(ctx context.Context, in *CreateTransactionDiagnosticsReportRequest) (*CreateTransactionDiagnosticsReportResponse, error) {
	return (*drpcStatusClient)(a).CreateTransactionDiagnosticsReport(ctx, in)
}

func (a *drpcStatusClientAdapter) CancelTransactionDiagnosticsReport(ctx context.Context, in *CancelTransactionDiagnosticsReportRequest) (*CancelTransactionDiagnosticsReportResponse, error) {
	return (*drpcStatusClient)(a).CancelTransactionDiagnosticsReport(ctx, in)
}

func (a *drpcStatusClientAdapter) TransactionDiagnosticsRequests(ctx context.Context, in *TransactionDiagnosticsReportsRequest) (*TransactionDiagnosticsReportsResponse, error) {
	return (*drpcStatusClient)(a).TransactionDiagnosticsRequests(ctx, in)
}
...
func DRPCStatusGatewayRoutes(client RPCStatusClient) []drpc.HTTPRoute {
	return []drpc.HTTPRoute{
		{Method: "GET", Path: "/_status/certificates/{node_id}", Handler: client.Certificates},
		{Method: "GET", Path: "/_status/details/{node_id}", Handler: client.Details},
		{Method: "GET", Path: "/_status/nodes", Handler: client.Nodes},
		{Method: "GET", Path: "/_status/nodes/{node_id}", Handler: client.Node},
		{Method: "GET", Path: "/_status/nodes_ui", Handler: client.NodesUI},
		{Method: "GET", Path: "/_status/nodes_ui/{node_id}", Handler: client.NodeUI},
		{Method: "GET", Path: "/_status/raft", Handler: client.RaftDebug},
		{Method: "GET", Path: "/_status/ranges/{node_id}", Handler: client.Ranges},
		{Method: "GET", Path: "/_status/tenant_service_status", Handler: client.TenantServiceStatus},
		{Method: "GET", Path: "/_status/tenant_ranges", Handler: client.TenantRanges},
		{Method: "GET", Path: "/_status/gossip/{node_id}", Handler: client.Gossip},
		{Method: "GET", Path: "/_status/enginestats/{node_id}", Handler: client.EngineStats},
		{Method: "GET", Path: "/_status/allocator/node/{node_id}", Handler: client.Allocator},
		{Method: "GET", Path: "/_status/allocator/range/{range_id}", Handler: client.AllocatorRange},
		{Method: "GET", Path: "/_status/mma_state/{node_id}", Handler: client.MMAState},
		{Method: "GET", Path: "/_status/sessions", Handler: client.ListSessions},
		{Method: "GET", Path: "/_status/local_sessions", Handler: client.ListLocalSessions},
		{Method: "POST", Path: "/_status/cancel_query/{node_id}", Handler: client.CancelQuery},
		{Method: "GET", Path: "/_status/contention_events", Handler: client.ListContentionEvents},
		{Method: "GET", Path: "/_status/local_contention_events", Handler: client.ListLocalContentionEvents},
		{Method: "GET", Path: "/_status/distsql_flows", Handler: client.ListDistSQLFlows},
		{Method: "GET", Path: "/_status/local_distsql_flows", Handler: client.ListLocalDistSQLFlows},
		{Method: "POST", Path: "/_status/cancel_session/{node_id}", Handler: client.CancelSession},
		{Method: "POST", Path: "/_status/span", Handler: client.SpanStats},
		{Method: "POST", Path: "/_status/critical_nodes", Handler: client.CriticalNodes},
		{Method: "GET", Path: "/_status/stacks/{node_id}", Handler: client.Stacks},
		{Method: "GET", Path: "/_status/profile/{node_id}", Handler: client.Profile},
		{Method: "GET", Path: "/_status/metrics/{node_id}", Handler: client.Metrics},
		{Method: "GET", Path: "/_status/files/{node_id}", Handler: client.GetFiles},
		{Method: "GET", Path: "/_status/logfiles/{node_id}", Handler: client.LogFilesList},
		{Method: "GET", Path: "/_status/logfiles/{node_id}/{file}", Handler: client.LogFile},
		{Method: "GET", Path: "/_status/logs/{node_id}", Handler: client.Logs},
		{Method: "GET", Path: "/_status/problemranges", Handler: client.ProblemRanges},
		{Method: "GET", Path: "/_status/downloadspans", Handler: client.DownloadSpan},
		{Method: "POST", Path: "/_status/v2/hotranges", Handler: client.HotRangesV2},
		{Method: "POST", Path: "/_status/keyvissamples", Handler: client.KeyVisSamples},
		{Method: "GET", Path: "/_status/range/{range_id}", Handler: client.Range},
		{Method: "GET", Path: "/_status/diagnostics/{node_id}", Handler: client.Diagnostics},
		{Method: "GET", Path: "/_status/stores/{node_id}", Handler: client.Stores},
		{Method: "GET", Path: "/_status/statements", Handler: client.Statements},
		{Method: "GET", Path: "/_status/combinedstmts", Handler: client.CombinedStatementStats},
		{Method: "GET", Path: "/_status/stmtdetails/{fingerprint_id}", Handler: client.StatementDetails},
		{Method: "POST", Path: "/_status/stmtdiagreports", Handler: client.CreateStatementDiagnosticsReport},
		{Method: "POST", Path: "/_status/stmtdiagreports/cancel", Handler: client.CancelStatementDiagnosticsReport},
		{Method: "GET", Path: "/_status/stmtdiagreports", Handler: client.StatementDiagnosticsRequests},
		{Method: "GET", Path: "/_status/stmtdiag/{statement_diagnostics_id}", Handler: client.StatementDiagnostics},
		{Method: "POST", Path: "/_status/txndiagreports", Handler: client.CreateTransactionDiagnosticsReport},
		{Method: "POST", Path: "/_status/txndiagreports/cancel", Handler: client.CancelTransactionDiagnosticsReport},
		{Method: "GET", Path: "/_status/txndiagreports", Handler: client.TransactionDiagnosticsRequests},
		{Method: "GET", Path: "/_status/job_registry/{node_id}", Handler: client.JobRegistryStatus},
		{Method: "GET", Path: "/_status/job/{job_id}", Handler: client.JobStatus},
		{Method: "POST", Path: "/_status/resetsqlstats", Handler: client.ResetSQLStats},
		{Method: "GET", Path: "/_status/indexusagestatistics", Handler: client.IndexUsageStatistics},
		{Method: "POST", Path: "/_status/resetindexusagestats", Handler: client.ResetIndexUsageStats},
		{Method: "GET", Path: "/_status/databases/{database}/tables/{table}/indexstats", Handler: client.TableIndexStats},
		{Method: "GET", Path: "/_status/sqlroles", Handler: client.UserSQLRoles},
		{Method: "GET", Path: "/_status/transactioncontentionevents", Handler: client.TransactionContentionEvents},
		{Method: "GET", Path: "/_status/connectivity", Handler: client.NetworkConnectivity},
		{Method: "GET", Path: "/_status/request_job_profiler_execution_details/{job_id}", Handler: client.RequestJobProfilerExecutionDetails},
		{Method: "GET", Path: "/_status/job_profiler_execution_details/{job_id}", Handler: client.GetJobProfilerExecutionDetails},
		{Method: "GET", Path: "/_status/list_job_profiler_execution_details/{job_id}", Handler: client.ListJobProfilerExecutionDetails},
		{Method: "GET", Path: "/_status/throttling", Handler: client.GetThrottlingMetadata},
	}
}
