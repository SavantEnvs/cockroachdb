...
func DRPCLogInGatewayRoutes(client RPCLogInClient) []drpc.HTTPRoute {
	return []drpc.HTTPRoute{
		{Method: "POST", Path: "/login", Handler: client.UserLogin},
	}
}
...
func DRPCLogOutGatewayRoutes(client RPCLogOutClient) []drpc.HTTPRoute {
	return []drpc.HTTPRoute{
		{Method: "GET", Path: "/logout", Handler: client.UserLogout},
	}
}
