...
func DRPCAdminGatewayRoutes(client RPCAdminClient) []drpc.HTTPRoute {
	return []drpc.HTTPRoute{
		{Method: "GET", Path: "/_admin/v1/users", Handler: client.Users},
		{Method: "GET", Path: "/_admin/v1/databases", Handler: client.Databases},
		{Method: "GET", Path: "/_admin/v1/databases/{database}", Handler: client.DatabaseDetails},
		{Method: "GET", Path: "/_admin/v1/databases/{database}/tables/{table}", Handler: client.TableDetails},
		{Method: "GET", Path: "/_admin/v1/databases/{database}/tables/{table}/stats", Handler: client.TableStats},
		{Method: "GET", Path: "/_admin/v1/nontablestats", Handler: client.NonTableStats},
		{Method: "GET", Path: "/_admin/v1/events", Handler: client.Events},
		{Method: "POST", Path: "/_admin/v1/uidata", Handler: client.SetUIData},
		{Method: "GET", Path: "/_admin/v1/uidata", Handler: client.GetUIData},
		{Method: "GET", Path: "/_admin/v1/cluster", Handler: client.Cluster},
		{Method: "GET", Path: "/_admin/v1/settings", Handler: client.Settings},
		{Method: "GET", Path: "/_admin/v1/health", Handler: client.Health},
		{Method: "GET", Path: "/health", Handler: client.Health},
		{Method: "GET", Path: "/_admin/v1/liveness", Handler: client.Liveness},
		{Method: "GET", Path: "/_admin/v1/jobs", Handler: client.Jobs},
		{Method: "GET", Path: "/_admin/v1/jobs/{job_id}", Handler: client.Job},
		{Method: "GET", Path: "/_admin/v1/locations", Handler: client.Locations},
		{Method: "GET", Path: "/_admin/v1/queryplan", Handler: client.QueryPlan},
		{Method: "GET", Path: "/_admin/v1/rangelog", Handler: client.RangeLog},
		{Method: "GET", Path: "/_admin/v1/rangelog/{range_id}", Handler: client.RangeLog},
		{Method: "GET", Path: "/_admin/v1/data_distribution", Handler: client.DataDistribution},
		{Method: "GET", Path: "/_admin/v1/metricmetadata", Handler: client.AllMetricMetadata},
		{Method: "GET", Path: "/_admin/v1/chartcatalog", Handler: client.ChartCatalog},
		{Method: "POST", Path: "/_admin/v1/enqueue_range", Handler: client.EnqueueRange},
		{Method: "GET", Path: "/_admin/v1/trace_snapshots", Handler: client.ListTracingSnapshots},
		{Method: "POST", Path: "/_admin/v1/trace_snapshots", Handler: client.TakeTracingSnapshot},
		{Method: "GET", Path: "/_admin/v1/trace_snapshots/{snapshot_id}", Handler: client.GetTracingSnapshot},
		{Method: "POST", Path: "/_admin/v1/traces", Handler: client.GetTrace},
		{Method: "POST", Path: "/_admin/v1/settracerecordingtype", Handler: client.SetTraceRecordingType},
		{Method: "GET", Path: "/_admin/v1/tenants", Handler: client.ListTenants},
	}
}
