...
type drpcEncoding_File_sqlproxy_tenant_directory_proto struct{}

func (drpcEncoding_File_sqlproxy_tenant_directory_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_sqlproxy_tenant_directory_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_sqlproxy_tenant_directory_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
...
func (drpcEncoding_File_sqlproxy_tenant_directory_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcDirectoryClient) ListPods(ctx context.Context, in *ListPodsRequest) (*ListPodsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cockroach.sqlproxy.tenant.Directory/ListPods", drpcEncoding_File_sqlproxy_tenant_directory_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcDirectoryClient) WatchPods(ctx context.Context, in *WatchPodsRequest) (DRPCDirectory_WatchPodsClient, error) {
	stream, err := c.cc.NewStream(ctx, "/cockroach.sqlproxy.tenant.Directory/WatchPods", drpcEncoding_File_sqlproxy_tenant_directory_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcDirectory_WatchPodsClient{stream}
	if err := x.MsgSend(in, drpcEncoding_File_sqlproxy_tenant_directory_proto{}); err != nil {
		return nil, err
	}
...
func (x *drpcDirectory_WatchPodsClient) Recv() (*WatchPodsResponse, error) {
	...
	if err := x.MsgRecv(m, drpcEncoding_File_sqlproxy_tenant_directory_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcDirectory_WatchPodsClient) RecvMsg(m *WatchPodsResponse) error {
	return x.MsgRecv(m, drpcEncoding_File_sqlproxy_tenant_directory_proto{})
}
...
func (c *drpcDirectoryClient) EnsurePod(ctx context.Context, in *EnsurePodRequest) (*EnsurePodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cockroach.sqlproxy.tenant.Directory/EnsurePod", drpcEncoding_File_sqlproxy_tenant_directory_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcDirectoryClient) GetTenant(ctx context.Context, in *GetTenantRequest) (*GetTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cockroach.sqlproxy.tenant.Directory/GetTenant", drpcEncoding_File_sqlproxy_tenant_directory_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcDirectoryClient) WatchTenants(ctx context.Context, in *WatchTenantsRequest) (DRPCDirectory_WatchTenantsClient, error) {
	stream, err := c.cc.NewStream(ctx, "/cockroach.sqlproxy.tenant.Directory/WatchTenants", drpcEncoding_File_sqlproxy_tenant_directory_proto{})
	if err != nil {
		return nil, err
	}
...
func (DRPCDirectoryDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/cockroach.sqlproxy.tenant.Directory/ListPods", drpcEncoding_File_sqlproxy_tenant_directory_proto{},
	...
	case 1:
		return "/cockroach.sqlproxy.tenant.Directory/WatchPods", drpcEncoding_File_sqlproxy_tenant_directory_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 2:
		return "/cockroach.sqlproxy.tenant.Directory/EnsurePod", drpcEncoding_File_sqlproxy_tenant_directory_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCDirectoryServer).
					EnsurePod(
						ctx,
	...
	case 3:
		return "/cockroach.sqlproxy.tenant.Directory/GetTenant", drpcEncoding_File_sqlproxy_tenant_directory_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCDirectoryServer).
					GetTenant(
						ctx,
	...
	case 4:
		return "/cockroach.sqlproxy.tenant.Directory/WatchTenants", drpcEncoding_File_sqlproxy_tenant_directory_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCDirectoryServer).
					WatchTenants(
...
func (x *drpcDirectory_ListPodsStream) SendAndClose(m *ListPodsResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_sqlproxy_tenant_directory_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
...
func (x *drpcDirectory_WatchPodsStream) Send(m *WatchPodsResponse) error {
	return x.MsgSend(m, drpcEncoding_File_sqlproxy_tenant_directory_proto{})
}
