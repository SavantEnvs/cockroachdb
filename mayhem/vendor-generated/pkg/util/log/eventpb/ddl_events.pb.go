...
type CreateDatabase struct {
	...
	DatabaseName string `protobuf:"bytes,3,opt,name=database_name,json=databaseName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type DropDatabase struct {
	...
	DroppedSchemaObjects []string `protobuf:"bytes,4,rep,name=dropped_schema_objects,json=droppedSchemaObjects,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterDatabaseAddRegion struct {
	...
	RegionName string `protobuf:"bytes,4,opt,name=region_name,json=regionName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterDatabasePrimaryRegion struct {
	...
	PrimaryRegionName string `protobuf:"bytes,4,opt,name=primary_region_name,json=primaryRegionName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterDatabaseSurvivalGoal struct {
	...
	SurvivalGoal string `protobuf:"bytes,4,opt,name=survival_goal,json=survivalGoal,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterDatabasePlacement struct {
	...
	Placement string `protobuf:"bytes,4,opt,name=placement,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type RenameDatabase struct {
	...
	NewDatabaseName string `protobuf:"bytes,4,opt,name=new_database_name,json=newDatabaseName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type CreateSchema struct {
	...
	SchemaName string `protobuf:"bytes,3,opt,name=schema_name,json=schemaName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The name of the owner for the new schema.
	Owner string `protobuf:"bytes,4,opt,name=owner,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type RenameSchema struct {
	...
	NewSchemaName string `protobuf:"bytes,4,opt,name=new_schema_name,json=newSchemaName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type SetSchema struct {
	...
	DescriptorName string `protobuf:"bytes,3,opt,name=descriptor_name,json=descriptorName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The new name of the affected descriptor.
	NewDescriptorName string `protobuf:"bytes,4,opt,name=new_descriptor_name,json=newDescriptorName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The descriptor type being changed (table, view, sequence, type, domain).
	DescriptorType string `protobuf:"bytes,5,opt,name=descriptor_type,json=descriptorType,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type DropTable struct {
	...
	CascadeDroppedViews []string `protobuf:"bytes,4,rep,name=cascade_dropped_views,json=cascadeDroppedViews,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type RenameTable struct {
	...
	NewTableName string `protobuf:"bytes,4,opt,name=new_table_name,json=newTableName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterTable struct {
	...
	// The names of the views dropped as a result of a cascade operation.
	CascadeDroppedViews []string `protobuf:"bytes,5,rep,name=cascade_dropped_views,json=cascadeDroppedViews,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type CommentOnColumn struct {
	...
	TableName string `protobuf:"bytes,3,opt,name=table_name,json=tableName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The affected column.
	ColumnName string `protobuf:"bytes,4,opt,name=column_name,json=columnName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The new comment.
...
type CommentOnType struct {
	...
	TypeName string `protobuf:"bytes,3,opt,name=type_name,json=typeName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The new comment.
	Comment string `protobuf:"bytes,4,opt,name=comment,proto3" json:",omitempty"`
	// Set to true if the comment was removed entirely.
	NullComment bool `protobuf:"varint,6,opt,name=null_comment,json=nullComment,proto3" json:",omitempty"`
...
func (m *CommentOnType) Reset()         { *m = CommentOnType{} }
func (m *CommentOnType) String() string { return proto.CompactTextString(m) }
func (*CommentOnType) ProtoMessage()    {}
func (*CommentOnType) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{21}
}
func (m *CommentOnType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommentOnType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *CommentOnType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommentOnType.Merge(m, src)
}
func (m *CommentOnType) XXX_Size() int {
	return m.Size()
}
func (m *CommentOnType) XXX_DiscardUnknown() {
	xxx_messageInfo_CommentOnType.DiscardUnknown(m)
}

var xxx_messageInfo_CommentOnType proto.InternalMessageInfo
...
type CommentOnConstraint struct {
	...
	ConstraintName string `protobuf:"bytes,4,opt,name=constraint_name,json=constraintName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The new comment.
	Comment string `protobuf:"bytes,5,opt,name=comment,proto3" json:",omitempty"`
	// Set to true if the comment was removed entirely.
	NullComment bool `protobuf:"varint,6,opt,name=null_comment,json=nullComment,proto3" json:",omitempty"`
...
type DropIndex struct {
	...
	MutationID uint32 `protobuf:"varint,5,opt,name=mutation_id,json=mutationId,proto3" json:",omitempty"`
	// The names of the views dropped as a result of a cascade operation.
	CascadeDroppedViews []string `protobuf:"bytes,6,rep,name=cascade_dropped_views,json=cascadeDroppedViews,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type CreateView struct {
	...
	ViewName string `protobuf:"bytes,3,opt,name=view_name,json=viewName,proto3" json:",omitempty" redact:"nonsensitive"`
...
type CreateSequence struct {
	...
	SequenceName string `protobuf:"bytes,3,opt,name=sequence_name,json=sequenceName,proto3" json:",omitempty" redact:"nonsensitive"`
...
type ReverseSchemaChange struct {
	...
	Error github_com_cockroachdb_redact.RedactableString `protobuf:"bytes,4,opt,name=error,proto3,customtype=github.com/cockroachdb/redact.RedactableString" json:",omitempty" redact:"mixed"`
	...
	LatencyNanos int64 `protobuf:"varint,6,opt,name=latency_nanos,json=latencyNanos,proto3" json:",omitempty"`
}
...
type FinishSchemaChange struct {
	...
	LatencyNanos int64 `protobuf:"varint,3,opt,name=latency_nanos,json=latencyNanos,proto3" json:",omitempty"`
}
...
type CreateType struct {
	...
	TypeName string `protobuf:"bytes,4,opt,name=type_name,json=typeName,proto3" json:",omitempty" redact:"nonsensitive"`
	// The name of the owner for the new type.
	Owner string `protobuf:"bytes,5,opt,name=owner,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type AlterTypeAddValue struct {
	...
	Value string `protobuf:"bytes,4,opt,name=value,proto3" json:",omitempty" redact:"nonsensitive"`
}

func (m *AlterTypeAddValue) Reset()         { *m = AlterTypeAddValue{} }
func (m *AlterTypeAddValue) String() string { return proto.CompactTextString(m) }
func (*AlterTypeAddValue) ProtoMessage()    {}
func (*AlterTypeAddValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{40}
}
func (m *AlterTypeAddValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlterTypeAddValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AlterTypeAddValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterTypeAddValue.Merge(m, src)
}
func (m *AlterTypeAddValue) XXX_Size() int {
	return m.Size()
}
func (m *AlterTypeAddValue) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterTypeAddValue.DiscardUnknown(m)
}

var xxx_messageInfo_AlterTypeAddValue proto.InternalMessageInfo
...
type AlterTypeRenameValue struct {
	...
	OldValue string `protobuf:"bytes,4,opt,name=old_value,json=oldValue,proto3" json:",omitempty" redact:"nonsensitive"`
	// The new value.
	NewValue string `protobuf:"bytes,5,opt,name=new_value,json=newValue,proto3" json:",omitempty" redact:"nonsensitive"`
}

func (m *AlterTypeRenameValue) Reset()         { *m = AlterTypeRenameValue{} }
func (m *AlterTypeRenameValue) String() string { return proto.CompactTextString(m) }
func (*AlterTypeRenameValue) ProtoMessage()    {}
func (*AlterTypeRenameValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{41}
}
func (m *AlterTypeRenameValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlterTypeRenameValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AlterTypeRenameValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterTypeRenameValue.Merge(m, src)
}
func (m *AlterTypeRenameValue) XXX_Size() int {
	return m.Size()
}
func (m *AlterTypeRenameValue) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterTypeRenameValue.DiscardUnknown(m)
}

var xxx_messageInfo_AlterTypeRenameValue proto.InternalMessageInfo
...
func (m *AlterTypeDropValue) Reset()         { *m = AlterTypeDropValue{} }
func (m *AlterTypeDropValue) String() string { return proto.CompactTextString(m) }
func (*AlterTypeDropValue) ProtoMessage()    {}
func (*AlterTypeDropValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{42}
}
func (m *AlterTypeDropValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlterTypeDropValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AlterTypeDropValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterTypeDropValue.Merge(m, src)
}
func (m *AlterTypeDropValue) XXX_Size() int {
	return m.Size()
}
func (m *AlterTypeDropValue) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterTypeDropValue.DiscardUnknown(m)
}

var xxx_messageInfo_AlterTypeDropValue proto.InternalMessageInfo
...
type RenameType struct {
	...
	NewTypeName string `protobuf:"bytes,4,opt,name=new_type_name,json=newTypeName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
type UnsafeDeleteDescriptor struct {
	...
	Name                     string `protobuf:"bytes,5,opt,name=name,proto3" json:",omitempty" redact:"nonsensitive"`
...
type CreateFunction struct {
	...
	FunctionName string `protobuf:"bytes,3,opt,name=function_name,json=functionName,proto3" json:",omitempty" redact:"nonsensitive"`
...
func (*CreateFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{51}
}
...
func (*DropFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{52}
}
...
type RenameFunction struct {
	...
	NewFunctionName string `protobuf:"bytes,4,opt,name=new_function_name,json=newFunctionName,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
func (*RenameFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{53}
}
...
func (*AlterFunctionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{54}
}
...
type CreateTrigger struct {
	...
	TriggerName string `protobuf:"bytes,4,opt,name=trigger_name,json=triggerName,proto3" json:",omitempty" redact:"nonsensitive"`
}

func (m *CreateTrigger) Reset()         { *m = CreateTrigger{} }
func (m *CreateTrigger) String() string { return proto.CompactTextString(m) }
func (*CreateTrigger) ProtoMessage()    {}
func (*CreateTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{55}
}
func (m *CreateTrigger) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreateTrigger) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *CreateTrigger) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateTrigger.Merge(m, src)
}
func (m *CreateTrigger) XXX_Size() int {
	return m.Size()
}
func (m *CreateTrigger) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateTrigger.DiscardUnknown(m)
}

var xxx_messageInfo_CreateTrigger proto.InternalMessageInfo
...
func (m *DropTrigger) Reset()         { *m = DropTrigger{} }
func (m *DropTrigger) String() string { return proto.CompactTextString(m) }
func (*DropTrigger) ProtoMessage()    {}
func (*DropTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{56}
}
func (m *DropTrigger) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DropTrigger) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *DropTrigger) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DropTrigger.Merge(m, src)
}
func (m *DropTrigger) XXX_Size() int {
	return m.Size()
}
func (m *DropTrigger) XXX_DiscardUnknown() {
	xxx_messageInfo_DropTrigger.DiscardUnknown(m)
}

var xxx_messageInfo_DropTrigger proto.InternalMessageInfo
...
type CreatePolicy struct {
	...
	PolicyName string `protobuf:"bytes,4,opt,name=policy_name,json=policyName,proto3" json:",omitempty" redact:"nonsensitive"`
}

func (m *CreatePolicy) Reset()         { *m = CreatePolicy{} }
func (m *CreatePolicy) String() string { return proto.CompactTextString(m) }
func (*CreatePolicy) ProtoMessage()    {}
func (*CreatePolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{57}
}
func (m *CreatePolicy) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreatePolicy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *CreatePolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreatePolicy.Merge(m, src)
}
func (m *CreatePolicy) XXX_Size() int {
	return m.Size()
}
func (m *CreatePolicy) XXX_DiscardUnknown() {
	xxx_messageInfo_CreatePolicy.DiscardUnknown(m)
}

var xxx_messageInfo_CreatePolicy proto.InternalMessageInfo
...
func (m *DropPolicy) Reset()         { *m = DropPolicy{} }
func (m *DropPolicy) String() string { return proto.CompactTextString(m) }
func (*DropPolicy) ProtoMessage()    {}
func (*DropPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{58}
}
func (m *DropPolicy) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DropPolicy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *DropPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DropPolicy.Merge(m, src)
}
func (m *DropPolicy) XXX_Size() int {
	return m.Size()
}
func (m *DropPolicy) XXX_DiscardUnknown() {
	xxx_messageInfo_DropPolicy.DiscardUnknown(m)
}

var xxx_messageInfo_DropPolicy proto.InternalMessageInfo
...
func (m *RefreshMaterializedView) Reset()         { *m = RefreshMaterializedView{} }
func (m *RefreshMaterializedView) String() string { return proto.CompactTextString(m) }
func (*RefreshMaterializedView) ProtoMessage()    {}
func (*RefreshMaterializedView) Descriptor() ([]byte, []int) {
	return fileDescriptor_660e996c596b3c8f, []int{59}
}
func (m *RefreshMaterializedView) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RefreshMaterializedView) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RefreshMaterializedView) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshMaterializedView.Merge(m, src)
}
func (m *RefreshMaterializedView) XXX_Size() int {
	return m.Size()
}
func (m *RefreshMaterializedView) XXX_DiscardUnknown() {
	xxx_messageInfo_RefreshMaterializedView.DiscardUnknown(m)
}

var xxx_messageInfo_RefreshMaterializedView proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CommentOnType)(nil), "cockroach.util.log.eventpb.CommentOnType")
	...
	proto.RegisterType((*AlterTypeAddValue)(nil), "cockroach.util.log.eventpb.AlterTypeAddValue")
	proto.RegisterType((*AlterTypeRenameValue)(nil), "cockroach.util.log.eventpb.AlterTypeRenameValue")
	proto.RegisterType((*AlterTypeDropValue)(nil), "cockroach.util.log.eventpb.AlterTypeDropValue")
	...
	proto.RegisterType((*CreateTrigger)(nil), "cockroach.util.log.eventpb.CreateTrigger")
	proto.RegisterType((*DropTrigger)(nil), "cockroach.util.log.eventpb.DropTrigger")
	proto.RegisterType((*CreatePolicy)(nil), "cockroach.util.log.eventpb.CreatePolicy")
	proto.RegisterType((*DropPolicy)(nil), "cockroach.util.log.eventpb.DropPolicy")
	proto.RegisterType((*RefreshMaterializedView)(nil), "cockroach.util.log.eventpb.RefreshMaterializedView")
}
...
var fileDescriptor_660e996c596b3c8f = []byte{
	...
	,
}
...
func (m *CommentOnType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommentOnType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommentOnType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ReverseSchemaChange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LatencyNanos != 0 {
		i = encodeVarintDdlEvents(dAtA, i, uint64(m.LatencyNanos))
		i--
		dAtA[i] = 0x30
	}
	if len(m.SQLSTATE) > 0 {
...
func (m *AlterTypeAddValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlterTypeAddValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlterTypeAddValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintDdlEvents(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TypeName) > 0 {
...
func (m *AlterTypeRenameValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlterTypeRenameValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlterTypeRenameValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.NewValue) > 0 {
		...
		i = encodeVarintDdlEvents(dAtA, i, uint64(len(m.NewValue)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.OldValue) > 0 {
		...
		i = encodeVarintDdlEvents(dAtA, i, uint64(len(m.OldValue)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TypeName) > 0 {
...
func (m *AlterTypeDropValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlterTypeDropValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlterTypeDropValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreateTrigger) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreateTrigger) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateTrigger) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TriggerName) > 0 {
		...
		i = encodeVarintDdlEvents(dAtA, i, uint64(len(m.TriggerName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TableName) > 0 {
...
func (m *DropTrigger) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DropTrigger) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DropTrigger) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreatePolicy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreatePolicy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreatePolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.PolicyName) > 0 {
		...
		i = encodeVarintDdlEvents(dAtA, i, uint64(len(m.PolicyName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TableName) > 0 {
...
func (m *DropPolicy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DropPolicy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DropPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RefreshMaterializedView) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RefreshMaterializedView) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RefreshMaterializedView) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommentOnType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReverseSchemaChange) Size() (n int) {
	...
	if m.LatencyNanos != 0 {
		n += 1 + sovDdlEvents(uint64(m.LatencyNanos))
	}
	return n
}
...
func (m *AlterTypeAddValue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AlterTypeRenameValue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AlterTypeDropValue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateTrigger) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreatePolicy) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RefreshMaterializedView) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CommentOnType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommentOnType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommentOnType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ReverseSchemaChange) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Error = github_com_cockroachdb_redact.RedactableString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatencyNanos", wireType)
			}
			m.LatencyNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LatencyNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AlterTypeAddValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlterTypeAddValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlterTypeAddValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AlterTypeRenameValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlterTypeRenameValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlterTypeRenameValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AlterTypeDropValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlterTypeDropValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlterTypeDropValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CreateTrigger) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreateTrigger: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreateTrigger: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DropTrigger) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DropTrigger: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DropTrigger: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CreatePolicy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreatePolicy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreatePolicy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DropPolicy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DropPolicy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DropPolicy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RefreshMaterializedView) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RefreshMaterializedView: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RefreshMaterializedView: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
