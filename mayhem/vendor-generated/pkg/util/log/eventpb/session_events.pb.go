...
const (
	...
	AuthFailReason_AUTHORIZATION_ERROR AuthFailReason = 9
	...
	AuthFailReason_PROVISIONING_ERROR AuthFailReason = 10
)
...
var AuthFailReason_name = map[int32]string{
	...
	9:  "AUTHORIZATION_ERROR",
	10: "PROVISIONING_ERROR",
}
...
type CommonConnectionDetails struct {
	...
	RemoteAddress github_com_cockroachdb_redact.RedactableString `protobuf:"bytes,3,opt,name=remote_address,json=remoteAddress,proto3,customtype=github.com/cockroachdb/redact.RedactableString" json:",omitempty" redact:"mixed"`
...
type CommonSessionDetails struct {
	...
	User github_com_cockroachdb_redact.RedactableString `protobuf:"bytes,2,opt,name=user,proto3,customtype=github.com/cockroachdb/redact.RedactableString" json:",omitempty" redact:"mixed"`
	...
	// field.
	SystemIdentity github_com_cockroachdb_redact.RedactableString `protobuf:"bytes,3,opt,name=system_identity,json=systemIdentity,proto3,customtype=github.com/cockroachdb/redact.RedactableString" json:",omitempty" redact:"mixed"`
}
...
type ClientAuthenticationFailed struct {
	...
	Method github_com_cockroachdb_redact.SafeString `protobuf:"bytes,6,opt,name=method,proto3,customtype=github.com/cockroachdb/redact.SafeString" json:",omitempty" redact:"nonsensitive"`
}
...
type ClientAuthenticationOk struct {
	...
	CommonSessionDetails     `protobuf:"bytes,3,opt,name=session,proto3,embedded=session" json:""`
	// The authentication method used.
	Method github_com_cockroachdb_redact.SafeString `protobuf:"bytes,4,opt,name=method,proto3,customtype=github.com/cockroachdb/redact.SafeString" json:",omitempty" redact:"nonsensitive"`
}
...
var fileDescriptor_aef88ca0e95f42d6 = []byte{
	...
	,
}
...
func (m *CommonConnectionDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RemoteAddress = github_com_cockroachdb_redact.RedactableString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *CommonSessionDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.User = github_com_cockroachdb_redact.RedactableString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.SystemIdentity = github_com_cockroachdb_redact.RedactableString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSessionEvents(dAtA[iNdEx:])
...
func (m *ClientAuthenticationFailed) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Method = github_com_cockroachdb_redact.SafeString(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSessionEvents(dAtA[iNdEx:])
