...
func (f *wrap) Engines() []kvstorage.Engines {
...
// ForceTableGC is part of the interface StorageLayerInterface.
func (f *wrap) ForceTableGC(ctx context.Context, database, table string, timestamp hlc.Timestamp) error {
	return f.fwStorageLayerInterface("ForceTableGC").ForceTableGC(ctx, database, table, timestamp)
}
