...
// TxnRegistry is part of the interface ApplicationLayerInterface.
func (f *wrap) TxnRegistry() interface{} {
	return f.fwApplicationLayerInterface("TxnRegistry").TxnRegistry()
}
