...
func (RangeFeedRetryError_Reason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_83411c0a161f9e6d, []int{31, 0}
}
...
func (RefreshFailedError_Reason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_83411c0a161f9e6d, []int{36, 0}
}
...
type TransactionRetryError struct {
	...
	// The key that the transaction conflicted on. This is distinct from the
	// conflicting_txn.key field, which is the anchor key of the conflicting
	// transaction (used for transaction record placement), not the key where the
	// actual conflict occurred. This field is bubbled up from a RefreshFailedError.
	ConflictKey github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,5,opt,name=conflict_key,json=conflictKey,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.Key" json:"conflict_key,omitempty"`
}
...
type TransactionRetryWithProtoRefreshError struct {
	...
	// transaction (used for transaction record placement), not the key where the
	// actual conflict occurred. This field is bubbled up from a RefreshFailedError.
	ConflictKey github_com_cockroachdb_cockroach_pkg_roachpb.Key `protobuf:"bytes,7,opt,name=conflict_key,json=conflictKey,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.Key" json:"conflict_key,omitempty"`
}
...
var fileDescriptor_83411c0a161f9e6d = []byte{
	...
	,
}
...
func (m *TransactionRetryError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ConflictKey != nil {
		...
		i = encodeVarintErrors(dAtA, i, uint64(len(m.ConflictKey)))
		i--
		dAtA[i] = 0x2a
	}
