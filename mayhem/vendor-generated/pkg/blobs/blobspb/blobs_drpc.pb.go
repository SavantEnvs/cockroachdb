...
type DRPCBlobClient interface {
	...
	GetStreamFlowControlled(ctx context.Context) (DRPCBlob_GetStreamFlowControlledClient, error)
}
...
func (c *drpcBlobClient) GetStreamFlowControlled(ctx context.Context) (DRPCBlob_GetStreamFlowControlledClient, error) {
	stream, err := c.cc.NewStream(ctx, "/cockroach.blobs.Blob/GetStreamFlowControlled", drpcEncoding_File_blobs_blobspb_blobs_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcBlob_GetStreamFlowControlledClient{stream}
	return x, nil
}

type DRPCBlob_GetStreamFlowControlledClient interface {
	drpc.Stream
	Send(*FlowControlledClientMessage) error
	Recv() (*FlowControlledServerMessage, error)
}

type RPCBlob_GetStreamFlowControlledClient interface {
	Context() context.Context
	CloseSend() error
	Send(*FlowControlledClientMessage) error
	Recv() (*FlowControlledServerMessage, error)
...
type drpcBlob_GetStreamFlowControlledClient struct {
	drpc.Stream
}

func (x *drpcBlob_GetStreamFlowControlledClient) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcBlob_GetStreamFlowControlledClient) Send(m *FlowControlledClientMessage) error {
	return x.MsgSend(m, drpcEncoding_File_blobs_blobspb_blobs_proto{})
}

func (x *drpcBlob_GetStreamFlowControlledClient) Recv() (*FlowControlledServerMessage, error) {
...
func (x *drpcBlob_GetStreamFlowControlledClient) RecvMsg(m *FlowControlledServerMessage) error {
	return x.MsgRecv(m, drpcEncoding_File_blobs_blobspb_blobs_proto{})
}
...
type DRPCBlobServer interface {
	...
	GetStreamFlowControlled(DRPCBlob_GetStreamFlowControlledStream) error
}
...
func (s *DRPCBlobUnimplementedServer) GetStreamFlowControlled(DRPCBlob_GetStreamFlowControlledStream) error {
	return drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

type DRPCBlobDescription struct{}

func (DRPCBlobDescription) NumMethods() int { return 6 }
...
func (DRPCBlobDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 5:
		return "/cockroach.blobs.Blob/GetStreamFlowControlled", drpcEncoding_File_blobs_blobspb_blobs_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCBlobServer).
					GetStreamFlowControlled(
						&drpcBlob_GetStreamFlowControlledStream{in1.(drpc.Stream)},
					)
			}, DRPCBlobServer.GetStreamFlowControlled, true
	default:
...
type DRPCBlob_GetStreamFlowControlledStream interface {
	drpc.Stream
...
type RPCBlob_GetStreamFlowControlledStream interface {
	Context() context.Context
	Send(*FlowControlledServerMessage) error
	Recv() (*FlowControlledClientMessage, error)
	RecvMsg(interface{}) error
...
type drpcBlob_GetStreamFlowControlledStream struct {
	drpc.Stream
}

func (x *drpcBlob_GetStreamFlowControlledStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcBlob_GetStreamFlowControlledStream) Send(m *FlowControlledServerMessage) error {
	return x.MsgSend(m, drpcEncoding_File_blobs_blobspb_blobs_proto{})
}

func (x *drpcBlob_GetStreamFlowControlledStream) Recv() (*FlowControlledClientMessage, error) {
...
func (x *drpcBlob_GetStreamFlowControlledStream) RecvMsg(m interface{}) error {
	return x.MsgRecv(m, drpcEncoding_File_blobs_blobspb_blobs_proto{})
}
...
type RPCBlobClient interface {
	...
	GetStreamFlowControlled(ctx context.Context) (RPCBlob_GetStreamFlowControlledClient, error)
}
...
func (a *grpcBlobClientAdapter) GetStreamFlowControlled(ctx context.Context) (RPCBlob_GetStreamFlowControlledClient, error) {
	return (*blobClient)(a).GetStreamFlowControlled(ctx)
}
...
func (a *drpcBlobClientAdapter) GetStreamFlowControlled(ctx context.Context) (RPCBlob_GetStreamFlowControlledClient, error) {
	return (*drpcBlobClient)(a).GetStreamFlowControlled(ctx)
}
