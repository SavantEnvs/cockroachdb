...
type FlowControlledGetRequest struct {
	...
	FlowControlWindow int32 `protobuf:"varint,3,opt,name=flow_control_window,json=flowControlWindow,proto3" json:"flow_control_window,omitempty"`
}

func (m *FlowControlledGetRequest) Reset()         { *m = FlowControlledGetRequest{} }
func (m *FlowControlledGetRequest) String() string { return proto.CompactTextString(m) }
func (*FlowControlledGetRequest) ProtoMessage()    {}
func (*FlowControlledGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fa8b478c5729691d, []int{12}
}
func (m *FlowControlledGetRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FlowControlledGetRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *FlowControlledGetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowControlledGetRequest.Merge(m, src)
}
func (m *FlowControlledGetRequest) XXX_Size() int {
	return m.Size()
}
func (m *FlowControlledGetRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FlowControlledGetRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FlowControlledGetRequest proto.InternalMessageInfo
...
// are acknowledgments.
type FlowControlledClientMessage struct {
	// Types that are valid to be assigned to Msg:
	//
	//	*FlowControlledClientMessage_Request
	//	*FlowControlledClientMessage_Ack
	Msg isFlowControlledClientMessage_Msg `protobuf_oneof:"msg"`
}

func (m *FlowControlledClientMessage) Reset()         { *m = FlowControlledClientMessage{} }
func (m *FlowControlledClientMessage) String() string { return proto.CompactTextString(m) }
func (*FlowControlledClientMessage) ProtoMessage()    {}
func (*FlowControlledClientMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_fa8b478c5729691d, []int{13}
}
func (m *FlowControlledClientMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FlowControlledClientMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *FlowControlledClientMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowControlledClientMessage.Merge(m, src)
}
func (m *FlowControlledClientMessage) XXX_Size() int {
	return m.Size()
}
func (m *FlowControlledClientMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_FlowControlledClientMessage.DiscardUnknown(m)
}

var xxx_messageInfo_FlowControlledClientMessage proto.InternalMessageInfo

type isFlowControlledClientMessage_Msg interface {
	isFlowControlledClientMessage_Msg()
	MarshalTo([]byte) (int, error)
	Size() int
}

type FlowControlledClientMessage_Request struct {
	Request *FlowControlledGetRequest `protobuf:"bytes,1,opt,name=request,proto3,oneof" json:"request,omitempty"`
}
type FlowControlledClientMessage_Ack struct {
	Ack int32 `protobuf:"varint,2,opt,name=ack,proto3,oneof" json:"ack,omitempty"`
}

func (*FlowControlledClientMessage_Request) isFlowControlledClientMessage_Msg() {}
func (*FlowControlledClientMessage_Ack) isFlowControlledClientMessage_Msg()     {}

func (m *FlowControlledClientMessage) GetMsg() isFlowControlledClientMessage_Msg {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (m *FlowControlledClientMessage) GetRequest() *FlowControlledGetRequest {
	if x, ok := m.GetMsg().(*FlowControlledClientMessage_Request); ok {
		return x.Request
	}
	return nil
}

func (m *FlowControlledClientMessage) GetAck() int32 {
	if x, ok := m.GetMsg().(*FlowControlledClientMessage_Ack); ok {
		return x.Ack
	}
	return 0
}
...
func (*FlowControlledClientMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*FlowControlledClientMessage_Request)(nil),
		(*FlowControlledClientMessage_Ack)(nil),
	}
}
...
type FlowControlledServerMessage struct {
	// Types that are valid to be assigned to Msg:
	//
	//	*FlowControlledServerMessage_Chunk
	//	*FlowControlledServerMessage_Eof
	Msg isFlowControlledServerMessage_Msg `protobuf_oneof:"msg"`
}

func (m *FlowControlledServerMessage) Reset()         { *m = FlowControlledServerMessage{} }
func (m *FlowControlledServerMessage) String() string { return proto.CompactTextString(m) }
func (*FlowControlledServerMessage) ProtoMessage()    {}
func (*FlowControlledServerMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_fa8b478c5729691d, []int{14}
}
func (m *FlowControlledServerMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FlowControlledServerMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *FlowControlledServerMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowControlledServerMessage.Merge(m, src)
}
func (m *FlowControlledServerMessage) XXX_Size() int {
	return m.Size()
}
func (m *FlowControlledServerMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_FlowControlledServerMessage.DiscardUnknown(m)
}

var xxx_messageInfo_FlowControlledServerMessage proto.InternalMessageInfo

type isFlowControlledServerMessage_Msg interface {
	isFlowControlledServerMessage_Msg()
	MarshalTo([]byte) (int, error)
	Size() int
}

type FlowControlledServerMessage_Chunk struct {
	Chunk *StreamChunk `protobuf:"bytes,1,opt,name=chunk,proto3,oneof" json:"chunk,omitempty"`
}
type FlowControlledServerMessage_Eof struct {
	Eof bool `protobuf:"varint,2,opt,name=eof,proto3,oneof" json:"eof,omitempty"`
}

func (*FlowControlledServerMessage_Chunk) isFlowControlledServerMessage_Msg() {}
func (*FlowControlledServerMessage_Eof) isFlowControlledServerMessage_Msg()   {}

func (m *FlowControlledServerMessage) GetMsg() isFlowControlledServerMessage_Msg {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (m *FlowControlledServerMessage) GetChunk() *StreamChunk {
	if x, ok := m.GetMsg().(*FlowControlledServerMessage_Chunk); ok {
		return x.Chunk
	}
	return nil
}

func (m *FlowControlledServerMessage) GetEof() bool {
	if x, ok := m.GetMsg().(*FlowControlledServerMessage_Eof); ok {
		return x.Eof
	}
	return false
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*FlowControlledServerMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*FlowControlledServerMessage_Chunk)(nil),
		(*FlowControlledServerMessage_Eof)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*FlowControlledGetRequest)(nil), "cockroach.blobs.FlowControlledGetRequest")
	proto.RegisterType((*FlowControlledClientMessage)(nil), "cockroach.blobs.FlowControlledClientMessage")
	proto.RegisterType((*FlowControlledServerMessage)(nil), "cockroach.blobs.FlowControlledServerMessage")
}
...
var fileDescriptor_fa8b478c5729691d = []byte{
	...
	,
}
...
type BlobClient interface {
	...
	GetStreamFlowControlled(ctx context.Context, opts ...grpc.CallOption) (Blob_GetStreamFlowControlledClient, error)
}
...
func (c *blobClient) GetStreamFlowControlled(ctx context.Context, opts ...grpc.CallOption) (Blob_GetStreamFlowControlledClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Blob_serviceDesc.Streams[2], "/cockroach.blobs.Blob/GetStreamFlowControlled", opts...)
	if err != nil {
		return nil, err
	}
	x := &blobGetStreamFlowControlledClient{stream}
	return x, nil
}

type Blob_GetStreamFlowControlledClient interface {
	Send(*FlowControlledClientMessage) error
	Recv() (*FlowControlledServerMessage, error)
	grpc.ClientStream
}

type blobGetStreamFlowControlledClient struct {
	grpc.ClientStream
}

func (x *blobGetStreamFlowControlledClient) Send(m *FlowControlledClientMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *blobGetStreamFlowControlledClient) Recv() (*FlowControlledServerMessage, error) {
	m := new(FlowControlledServerMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type BlobServer interface {
	...
	// GetStreamFlowControlled provides flow-controlled file streaming where
	// the client sends acknowledgments to control the pace of data transfer.
	GetStreamFlowControlled(Blob_GetStreamFlowControlledServer) error
}
...
func (*UnimplementedBlobServer) GetStreamFlowControlled(srv Blob_GetStreamFlowControlledServer) error {
	return status.Errorf(codes.Unimplemented, "method GetStreamFlowControlled not implemented")
}
...
func _Blob_GetStreamFlowControlled_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BlobServer).GetStreamFlowControlled(&blobGetStreamFlowControlledServer{stream})
}

type Blob_GetStreamFlowControlledServer interface {
	Send(*FlowControlledServerMessage) error
	Recv() (*FlowControlledClientMessage, error)
	grpc.ServerStream
}

type blobGetStreamFlowControlledServer struct {
	grpc.ServerStream
}

func (x *blobGetStreamFlowControlledServer) Send(m *FlowControlledServerMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *blobGetStreamFlowControlledServer) Recv() (*FlowControlledClientMessage, error) {
	m := new(FlowControlledClientMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _Blob_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetStreamFlowControlled",
			Handler:       _Blob_GetStreamFlowControlled_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
func (m *FlowControlledGetRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FlowControlledGetRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledGetRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.FlowControlWindow != 0 {
		i = encodeVarintBlobs(dAtA, i, uint64(m.FlowControlWindow))
		i--
		dAtA[i] = 0x18
	}
	if m.Offset != 0 {
...
func (m *FlowControlledClientMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FlowControlledClientMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledClientMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FlowControlledClientMessage_Request) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledClientMessage_Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Request != nil {
		{
			...
			i -= size
			i = encodeVarintBlobs(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *FlowControlledClientMessage_Ack) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledClientMessage_Ack) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintBlobs(dAtA, i, uint64(m.Ack))
	i--
	dAtA[i] = 0x10
	return len(dAtA) - i, nil
}
func (m *FlowControlledServerMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FlowControlledServerMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledServerMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FlowControlledServerMessage_Chunk) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledServerMessage_Chunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Chunk != nil {
		{
...
func (m *FlowControlledServerMessage_Eof) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FlowControlledServerMessage_Eof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Eof {
		dAtA[i] = 1
...
func (m *FlowControlledGetRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.FlowControlWindow != 0 {
		n += 1 + sovBlobs(uint64(m.FlowControlWindow))
	}
	return n
}

func (m *FlowControlledClientMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FlowControlledClientMessage_Request) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FlowControlledClientMessage_Ack) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovBlobs(uint64(m.Ack))
	return n
}
func (m *FlowControlledServerMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FlowControlledServerMessage_Chunk) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FlowControlledServerMessage_Eof) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FlowControlledGetRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowControlledGetRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowControlledGetRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlowControlWindow", wireType)
			}
			m.FlowControlWindow = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBlobs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FlowControlWindow |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *FlowControlledClientMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowControlledClientMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowControlledClientMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			alloc := new(struct {
				value FlowControlledClientMessage_Request
				field FlowControlledGetRequest
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.Request = &alloc.field
			m.Msg = &alloc.value
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
			...
			m.Msg = &FlowControlledClientMessage_Ack{v}
		default:
			iNdEx = preIndex
			skippy, err := skipBlobs(dAtA[iNdEx:])
			if err != nil {
...
func (m *FlowControlledServerMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowControlledServerMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowControlledServerMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			alloc := new(struct {
				value FlowControlledServerMessage_Chunk
				field StreamChunk
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.Chunk = &alloc.field
			m.Msg = &alloc.value
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
			...
			b := bool(v != 0)
			m.Msg = &FlowControlledServerMessage_Eof{b}
		default:
			iNdEx = preIndex
			skippy, err := skipBlobs(dAtA[iNdEx:])
			if err != nil {
